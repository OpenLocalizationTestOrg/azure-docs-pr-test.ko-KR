...
* 모바일 앱에 인증 추가: [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows 유니버설] [ windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms] [ xamarin-forms-get-started-users], [Cordova][cordova-get-started-users]  
