...
* [인증 tooa 웹 응용 프로그램 추가](../articles/app-service-web/app-service-web-get-started-2.md#authenticate-your-users)
* 모바일 앱 인증 tooyour 추가: [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows 유니버설] [ windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms] [ xamarin-forms-get-started-users], [Cordova][cordova-get-started-users]  
  자세한 내용은 방법 tooadd 앱 서비스 인증 tooyour 모바일 앱입니다.
* API Apps의 인증: [사용자 주체](../articles/app-service-api/app-service-api-dotnet-user-principal-auth.md), [서비스 주체](../articles/app-service-api/app-service-api-dotnet-service-principal-auth.md)  
  자세한 내용은 방법 toosecure 앱 서비스 인증을 사용 하 여 API 앱입니다.
