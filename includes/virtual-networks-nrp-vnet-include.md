...
| 속성 | 설명 | 샘플 값 |
| --- | --- | --- |
| **addressSpace** |CIDR 표기법에 hello VNet 구성 하는 주소 접두사의 컬렉션 |192.168.0.0/16 |
| **서브넷** |서브넷 hello VNet 구성 하는 컬렉션입니다. |아래 [서브넷](#Subnets) 참조 |
...
| 속성 | 설명 | 샘플 값 |
| --- | --- | --- |
| **addressPrefix** |CIDR 표기법에서 hello 서브넷 구성 하는 단일 주소 접두사 |192.168.1.0/24 |
| **networkSecurityGroup** |NSG 적용 toohello 서브넷 |아래 [NSG](#Network-Security-Group) |
| **routeTable** |경로 테이블 toohello 서브넷 적용 |아래 [UDR](#Route-table) |
| **ipConfigurations** |Nic 연결 된 toohello 서브넷에서 사용 되는 IP 구성 개체의 컬렉션 |아래 [UDR](#Route-table) |
...
* 읽기 hello [REST API 참조 설명서](https://msdn.microsoft.com/library/azure/mt163650.aspx) Vnet에 대 한 합니다.
* 읽기 hello [REST API 참조 설명서](https://msdn.microsoft.com/library/azure/mt163618.aspx) 서브넷에 대 한 합니다.
