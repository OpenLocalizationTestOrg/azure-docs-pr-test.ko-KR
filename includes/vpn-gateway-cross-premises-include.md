...
| **일반적인 사용 사례** |프로토타입 제작, 클라우드 서비스 및 가상 컴퓨터에 대한 개발/테스트/실습 시나리오 |클라우드 서비스 및 가상 컴퓨터에 대한 개발/테스트/실습 시나리오 및 소규모 프로덕션 워크로드 |Azure tooall 액세스할 엔터프라이즈 수준의 서비스 (유효성이 검사 된 목록) 및 중요 한 작업, 백업, 빅 데이터, DR 사이트와 Azure |
