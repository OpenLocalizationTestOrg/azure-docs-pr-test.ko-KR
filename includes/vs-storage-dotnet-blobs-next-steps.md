...
Azure Blob 저장소의 hello 기본 사항 학습 한, 했으므로 더 복잡 한 저장소 작업에 대 한 이러한 링크 toolearn을 따릅니다.

* Hello에서 hello Blob 서비스 참조 설명서를 볼 [.NET 용 Azure 저장소 클라이언트 라이브러리](http://go.microsoft.com/fwlink/?LinkID=390731) 사용 가능한 Api에 대 한 자세한 내용은 대 한 참조입니다.
