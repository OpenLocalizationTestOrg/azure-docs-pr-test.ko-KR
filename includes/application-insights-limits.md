일부의 제한이 hello 메트릭 및 응용 프로그램 당 이벤트 수에 (즉, 계측 키 당). 제한은 hello에 따라 다릅니다 [계획 가격 책정](https://azure.microsoft.com/pricing/details/application-insights/) 선택한 합니다.
...
| 제한 | 32k 이벤트/초 | hello 제한 분 당 측정 됩니다.
