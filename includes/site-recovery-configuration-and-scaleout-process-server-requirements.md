...
| Windows Server 역할 | 역할을 수행 하는 hello를 사용 하지 마십시오. <br> - Active Directory Domain Services <br>- 인터넷 정보 서비스 <br> - Hyper-V |
| **네트워크** | |
| 네트워크 인터페이스 카드 유형 | VMXNET3 |
| IP 주소 유형 | 정적 |
| 인터넷 액세스 | hello 서버에 직접 또는 프록시 서버를 통해 다음 Url 수 tooaccess hello 있어야 합니다. <br> - \*.accesscontrol.windows.net<br> - \*.backup.windowsazure.com <br>- \*.store.core.windows.net<br> - \*.blob.core.windows.net<br> - \*.hypervrecoverymanager.windowsazure.com <br> - https://cdn.mysql.com/archives/mysql-5.5/mysql-5.5.37-win32.msi(확장 프로세스 서버에는 필요하지 않음) <br> - time.nist.gov <br> - time.windows.com |
