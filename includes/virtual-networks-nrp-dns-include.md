...
| 속성 | 설명 | 샘플 값 |
| --- | --- | --- |
| **DNSzones** |특정 도메인의 도메인 영역 정보 toohost DNS 레코드 |/subscriptions/{guid}/.../providers/Microsoft.Network/dnszones/contoso.com" |
...
읽기 hello [DNS 영역에 대 한 REST API 설명서 ](https://msdn.microsoft.com/library/azure/mt130626.aspx) 자세한 정보에 대 한 합니다.

읽기 hello [DNS 레코드 집합에 대 한 REST API 설명서](https://msdn.microsoft.com/library/azure/mt130627.aspx) 자세한 정보에 대 한 합니다.
