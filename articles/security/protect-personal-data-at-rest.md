...
회사에서 Microsoft Azure를 사용하여 클라우드에 회사 데이터를 저장합니다. 이 수 직원 또는 고객 정보가 다음과 같은 포함
...
회사는 데이터를 필요로 하는 해당 부서에 액세스할 수 있도록 하는 동안 직원 및 고객 데이터의 개인 정보를 보호 해야 합니다. 액세스할 수 있어야 합니다.
...
데이터 (예: 부서 급여 및 예약) 해야 하는 해당 부서에 액세스할 수 있도록 하는 동안 회사 직원의 고 고객의 개인 데이터의 개인 정보를 보호 해야 합니다. 이러한 개인 데이터는 회사에서 제어하는 데이터 센터 외부에 저장되며 회사의 물리적 통제하에 있지 않습니다.
