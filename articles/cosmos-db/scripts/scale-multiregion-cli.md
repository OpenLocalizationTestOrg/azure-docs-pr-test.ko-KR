...
---
# <a name="replicate-an-azure-cosmos-db-database-account-in-multiple-regions-and-configure-failover-priorities-using-hello-azure-cli"></a>Cosmos DB Azure 데이터베이스 계정을 여러 지역에서 복제 하 고 hello Azure CLI를 사용 하 여 장애 조치 우선 순위를 구성

이 예제는 모든 종류의 Azure Cosmos DB 데이터베이스 계정 여러 지역에서 복제 하 고 hello Azure CLI를 사용 하 여 장애 조치 우선 순위를 구성 합니다.
