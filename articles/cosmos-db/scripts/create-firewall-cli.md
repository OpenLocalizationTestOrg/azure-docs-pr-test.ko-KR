...
---
# <a name="azure-cosmos-db-create-a-firewall-using-hello-azure-cli"></a>Azure Cosmos DB: hello Azure CLI를 사용 하는 방화벽 만들기
...
| [az cosmosdb update](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Azure CosmosDB 계정 tooinclude 방화벽 설정을 업데이트합니다. |
