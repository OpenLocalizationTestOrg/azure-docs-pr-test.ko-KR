...
---
# <a name="get-account-keys-for-azure-cosmos-db-using-hello-azure-cli"></a>Hello Azure CLI를 사용 하 여 Azure Cosmos DB에 대 한 계정 키 가져오기
...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Hello SQL 데이터베이스를 호스트 하는 논리 서버를 만듭니다. |
