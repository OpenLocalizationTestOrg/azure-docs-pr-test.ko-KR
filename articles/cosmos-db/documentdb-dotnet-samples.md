...
---
# <a name="azure-cosmos-db-net-examples-for-hello-documentdb-api"></a>DocumentDB API hello에 대 한 azure Cosmos DB:.NET 예제
...
CRUD 작업 및 Azure Cosmos DB 리소스에서 기타 일반적인 작업을 수행 하는 샘플 솔루션을 최신 hello에 포함 된 [azure-documentdb-dotnet](https://github.com/Azure/azure-documentdb-dotnet/tree/master/samples/code-samples) GitHub 리포지토리 합니다. 이 문서는 다음을 제공합니다.

* Hello 예를 들어 C# 프로젝트 파일의 각 링크 toohello 작업입니다. 
* 링크 toohello 관련 API 참조 콘텐츠입니다.

**필수 구성 요소**

1. 이 예제에서는 Azure 계정 toouse 필요합니다.
...
2. 또한 hello 해야 [Microsoft.Azure.DocumentDB NuGet 패키지](http://www.nuget.org/packages/Microsoft.Azure.DocumentDB/)합니다. 

> [!NOTE]
> 각 샘플은 자체 포함되며 자체를 설정하고 자체를 정리합니다. 이와 같이 hello 샘플에는 여러 호출 tooCreateDocumentCollectionAsync() 발급합니다. 구독에 영향을 주는 이렇게 될 때마다 생성 되 고 hello 컬렉션의 hello 성능 계층 당 사용량의 1 시간에 대 한 요금이 청구 됩니다. 
> 
> 

## <a name="database-examples"></a>데이터베이스 예제
hello [RunDatabaseDemo](https://github.com/Azure/azure-documentdb-dotnet/blob/530c8d9cf7c99df7300246da05206c57ce654233/samples/code-samples/DatabaseManagement/Program.cs#L72-L121) 메서드 hello DatabaseManagement 프로젝트의 hello 샘플의 방식과 tooperform hello 다음 작업을 보여 줍니다.
...
hello [RunCollectionDemo](https://github.com/Azure/azure-documentdb-dotnet/blob/530c8d9cf7c99df7300246da05206c57ce654233/samples/code-samples/CollectionManagement/Program.cs#L96-L185) hello 샘플 CollectionManagement 프로젝트 메서드 toodo hello 다음 작업 방법을 보여 줍니다.
...
| [데이터베이스의 모든 hello 컬렉션 읽기](https://github.com/Azure/azure-documentdb-dotnet/blob/89670bc8aefd9bdd932db7f9b6d2fcb9b6acf35e/samples/code-samples/CollectionManagement/Program.cs#L162) |[DocumentClient.ReadDocumentCollectionFeedAsync](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.client.documentclient.readdocumentcollectionfeedasync.aspx) |
...
hello [RunDocumentsDemo](https://github.com/Azure/azure-documentdb-dotnet/blob/f374cc601f4cf08d11c88f0c3fa7dcefaf7ecfe8/samples/code-samples/DocumentManagement/Program.cs#L97-L102) hello 샘플 DocumentManagement 프로젝트 메서드 toodo hello 다음 작업 방법을 보여 줍니다.
...
hello [RunIndexDemo](https://github.com/Azure/azure-documentdb-dotnet/blob/ea8c977b9c2f37ddc2894911ec239907ab60e40a/samples/code-samples/IndexManagement/Program.cs#L89-L117) hello 샘플 IndexManagement 프로젝트 메서드 tooperform hello 다음 작업 방법을 보여 줍니다.

| 작업 | API 참조 |
| --- | --- |
| [Hello 인덱스에서 문서를 제외 합니다.](https://github.com/Azure/azure-documentdb-dotnet/blob/2e9a48b6a446b47dd6182606c8608d439b88b683/samples/code-samples/IndexManagement/Program.cs#L125-L163) |[IndexingDirective.Exclude](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.indexingdirective.aspx) |
...
hello geospatial 샘플 파일 [azure-documentdb-dotnet/samples/code-samples/Geospatial/Program.cs](https://github.com/Azure/azure-documentdb-dotnet/blob/master/samples/code-samples/Geospatial/Program.cs), 다음 toodo hello 작업 하는 방법을 보여 줍니다.  
...
hello 쿼리 문서 파일을 [azure-documentdb-dotnet/samples/code-samples/Queries/Program.cs](https://github.com/Azure/azure-documentdb-dotnet/blob/master/samples/code-samples/Queries/Program.cs), 각 toodo hello 뒤의 작업 하는 방법을 보여 줍니다. LINQ 공급자, 쿼리 및 람다 hello hello SQL 쿼리 문법을 사용 하 여 합니다.
...
hello 변경 피드 샘플에서는 [azure-documentdb-dotnet/samples/code-samples/ChangeFeed/Program.cs](https://github.com/Azure/azure-documentdb-dotnet/blob/master/samples/code-samples/ServerSideScripts/Program.cs) toodo hello 다음 작업 방법을 보여 줍니다. 
...
hello 변경 피드 프로세서 샘플: [피드 마이그레이션 도구 변경](https://github.com/Azure/azure-documentdb-dotnet/tree/master/samples/ChangeFeedMigrationTool) toouse 변경 프로세서 라이브러리 tooreplicate tooanother Cosmos DB 컬렉션 데이터를 공급 하는 방법을 보여 줍니다.   

## <a name="server-side-programming-examples"></a>서버 쪽 프로그래밍 예제
hello 서버 쪽 프로그래밍 파일 [azure-documentdb-dotnet/samples/code-samples/ServerSideScripts/Program.cs](https://github.com/Azure/azure-documentdb-dotnet/blob/master/samples/code-samples/ServerSideScripts/Program.cs), 다음 toodo hello 작업 하는 방법을 보여 줍니다.
...
hello 사용자 관리 파일 [azure-documentdb-dotnet/samples/code-samples/UserManagement/Program.cs](https://github.com/Azure/azure-documentdb-dotnet/blob/master/samples/code-samples/UserManagement/Program.cs), 다음 toodo hello 작업 하는 방법을 보여 줍니다.
