...
프로젝트의 수준을 올려보겠습니다. Hello world 사용자 끌어 내십시오 공유할 도움을 받을 우리 hello 놀라운 작업 중인 프로젝트에서 Azure Cosmos DB와 함께 hello 차세대 hello DocumentDB 스택 표시 합니다. toosubmit 프로젝트에서 전자 메일을 보내: [ askcosmosdb@microsoft.com ](mailto:askcosmosdb@microsoft.com)합니다.
...
클라이언트 관리 뷰어/탐색기 hello Azure Cosmos DB DocumentDB API 서비스에 대 한 합니다.
...
TypeScript로 작성 된 hello Node.js 클라이언트에 대 한 래퍼로 (에 일반 JavaScript에서). `async/await` 및 간소화된 API를 지원합니다.
...
API 앱으로 쉽게 배포할 수 있는 DocumentDB API hello에 대 한 Azure Cosmos DB REST API Swagger 파일입니다.
...
플러그 인 documentdb fluent tooAzure Cosmos DB DocumentDB API 출력할 Fluentd 플러그 인입니다.
...
알 수 있습니다 hello 최신 Azure Cosmos DB 뉴스 및 기능에 따라 [블로그에서](https://azure.microsoft.com/blog/tag/documentdb/)합니다.

**커뮤니티 게시물:**

* [**여정 tooSocial**](https://medium.com/@Ealsur/a-journey-to-social-c47636bf25c9#.an669sx41) - *Matías Quaranta 하 여* 
...
* [**TooAzure fluent documentdb 플러그 인을 사용 하 여 DocumentDB에서에서 로그 수집**](http://unofficialism.info/posts/collecting-logs-into-azure-documentdb-using-fluent-plugin-documentdb/) - *Yoichi 카와사키 하 여*
* [**DocumentDB revisited 파트 1/2 – hello 이론**](https://peterintheazuresky.wordpress.com/2016/02/19/documentdb-revisited-part-12-the-theory/) - *Peter Mannerhult 하 여*
* [**어떤 toolove와 Azure의 DocumentDB에 대 한 혐오**](http://blog.falafel.com/4-what-to-love-and-hate-about-azures-documentdb/) - *George Saadeh 하 여*
...
* [**Azure DocumentDB 개발 앞으로 더 hello 클라이언트 클래스 (1 / 2)의 개발 (일본어)**](http://beachside.hatenablog.com/entry/2015/10/01/202734) - *Atsushi Yokohama 하 여*
* [**Azure DocumentDB (일본어)를 사용 하는 경우 tooknow 필요**](http://beachside.hatenablog.com/entry/2015/10/01/202734) - *Atsushi Yokohama 하 여*
...
*블로그 게시물, 코드 샘플 있습니까 또는 사례 연구 원하는 tooshare? [알려주세요](mailto:askcosmosdb@microsoft.com)!*
...
|[NDC Olso 2017: Azure DocumentDB-최상의 NoSQL 데이터베이스 있습니다 hello 아마도 사용 하지 않는 (아직)](http://ndcoslo.com/talk/azure-cosmos-db-the-best-nosql-database-youre-probably-not-using-yet/)|[Josh Lane](https://twitter.com/jplane)|노르웨어 오슬로|2017년 6월 14|[#ndcoslo](https://twitter.com/search?q=%23ndcoslo)|
...
| Wintellect 웹 세미나: 소개 tooAzure DocumentDB| [Josh Lane](https://twitter.com/jplane)|온라인|2017년 1월 12일 오후 1시 EST|[Azure DocumentDB: 클라우드 기반 지역 크기 조정된 NoSQL Superweapon... 눈앞에서 숨기기](https://www.youtube.com/watch?v=uVcWgIYtBoc)|
...
| [SQL Saturday #434 - 홀랜드 2015](http://www.sqlsaturday.com/434/Sessions/Details.aspx?sid=36413) |Leonard Lobel |위트레흐트, 네덜란드 |2015년 9월 26일 |[소개 tooAzure DocumentDB](https://channel9.msdn.com/Blogs/Azure/SQL-Saturday-Holland-2015-Introduction-to-Azure-DocumentDB) |
...
| [벨로루시 Azure 사용자 그룹 모임 접속](https://www.facebook.com/events/786540124800276/) |Alex Zyl |민스크, 벨로루시 |2015년 9월 9일 |[소개 tooDocumentDB 개념 개요, 일관성 수준, 분할 전략](https://www.youtube.com/watch?v=Uc_qwWzJKH8) |
...
| [빌드 2015](http://www.buildwindows.com/) |Ryan Crawcour |샌프란시스코, CA |2015년 4월 29일 - 5월 1일 |[Azure의 NoSQL 서비스와의 다음 큰 혁명 hello 빌드: DocumentDB](https://channel9.msdn.com/Events/Build/2015/2-729) |
...
| [TechX Azure](https://www.youtube.com/channel/UCDRlI2E4z5qmHsBXTrFOE2Q) |Magnus Mårtensson |스톡홀름, 스웨덴 |2015년 1월 28-29일 |[클라우드 hello에 대 한 Azure hello 새 NoSQL 옵션에는 DocumentDB](https://www.youtube.com/watch?v=Hw7hDYoChNI) |
...
| Channel 9: Microsoft + 오픈 소스 |Jose Miguel Parrella |2016년 4월 14일 |[Azure DocumentDB Bitnami, VM 크기 집합이와 평균 tooDEAN에서](https://channel9.msdn.com/Blogs/Open/From-MEAN-to-DEAN-in-Azure-with-Bitnami-VM-Scale-Sets-and-DocumentDB) |
...
| hello Azure 팟캐스트 |Cale Teeter |2016년 1월 14일 |[에피소드 110: DocumentDB 및 검색 사용](http://azpodcast.azurewebsites.net/post/Episode-110-Using-DocumentDB-Search) |
| 채널 9: 최신 응용 프로그램 |Tara Shankar Jana |2016년 12월 13일 |[앱에서 최신 접근 방식을 toodata 수행](https://channel9.msdn.com/Series/Modern-Applications/Take-a-modern-approach-to-data-in-your-apps) |
...
| hello Azure 팟캐스트 |Cale Teeter |2015년 9월 17일 |[에피소드 94: azpodcast.com 재설계](http://azpodcast.azurewebsites.net/post/Episode-94-azpodcastcom-re-architecture) |
...
| NoSql Central |King Wilder |2015년 5월 25일 |[추적기-방법에 대 한 비디오 개요 골프 toobuild AngularJS WebApi 2와 DocumentDB를 기반으로 웹 응용 프로그램입니다.](http://www.nosqlcentral.net/Story/Details/videos/kahanu/1-documentdb-golf-tracker-overview) |
...
| 데이터 아키텍처 가상 장 PASS |Ike Ellis |2015년 2월 25일 |[소개 tooDocumentDB](https://www.youtube.com/watch?v=7BQYdFUkz6s) |

### <a name="online-classes"></a>온라인 클래스
| 학습 파트너 | 설명 |
| --- | --- |
| [![Microsoft Virtual Academy](./media/community/mva.png)](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) |[**Microsoft Virtual Academy** ](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) Azure DocumentDB를 작성할 수는 hello 사용자 로부터 학습을 제공 합니다. |
| [![Pluralsight](./media/community/pluralsight.png)](http://www.pluralsight.com/courses/azure-documentdb-introduction) |[**Pluralsight**](http://www.pluralsight.com/courses/azure-documentdb-introduction) 는 Azure 교육을 제공하는 핵심 Microsoft 파트너입니다. MSDN 구독자 인 경우 이점 tooaccess Microsoft Azure 교육을 사용 합니다. |
...
Twitter 팔 로우 [ @DocumentDB ](https://twitter.com/DocumentDB) hello에 hello 최신 대화와 toodate 가동 상태 유지 및 [#DocumentDB](https://twitter.com/hashtag/DocumentDB) hashtag 합니다.
...
기술 지원이 필요합니까? 질문이 있으십니까? NoSQL이 적합한지 궁금하십니까? Us를 전송 하 여 1:1 채팅 hello DocumentDB 엔지니어링 팀에 직접 예약할 수 있습니다는 [전자 메일](mailto:askcosmosdb@microsoft.com) tweeting 하세요. 또는 [ @DocumentDB ](https://twitter.com/DocumentDB)합니다.

## <a name="open-source-projects"></a>공개 소스 프로젝트
이러한 프로젝트는 hello Azure DocumentDB 팀 공동 작업으로 오픈 소스 커뮤니티에서 적극적으로 개발 됩니다.
...
Azure Cosmos DB 마법사 소는 대표적인 약정 toohelping 살펴보았습니다 커뮤니티 리더가 hello 가장 Azure Cosmos DB 사용 경험을 벗어났습니다 hello 차세대 Azure DocumentDB는입니다. Hello Azure Cosmos DB 팀과 그리고 hello 커뮤니티와의 뛰어난 열 정의 실제 지식 및 기술 전문성 공유.
...
Toobecome Azure Cosmos DB 마법사는 선택 하십시오. 없는 벤치 마크는 마법사를 지정할 때 hello 조건 평가 같습니다. nominee의 기여 tooonline 포럼 StackOverflow MSDN; 등의 hello 영향을 wiki 및 온라인 콘텐츠; 회 및 사용자 그룹입니다. 웹 사이트, 블로그, 소셜 미디어; 팟캐스트 기사 및 책 합니다. [메일을 보내](mailto:askcosmosdb@microsoft.com)자신이나 다른 사용자를 후보로 지명할 수 있습니다.
