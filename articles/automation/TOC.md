...
### [JSON 개체 tooan Azure 자동화 runbook을 전달 합니다.](automation-pass-json-string.md)
...
### [Azure 자동화 DSC 로그 분석 데이터 tooOMS 보고 전달](automation-dsc-diagnostics.md)
## 자산 관리
...
## 모니터
### [앞으로 Azure 자동화 작업 데이터 tooLog 분석](automation-manage-send-joblogs-log-analytics.md)
