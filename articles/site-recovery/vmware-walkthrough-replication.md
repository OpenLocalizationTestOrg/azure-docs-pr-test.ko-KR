...
---
# <a name="step-9-set-up-a-replication-policy-for-vmware-vm-replication-tooazure"></a>9 단계: 복제 tooAzure VMware VM에 대 한 복제 정책 설정


이 문서에서는 설명 어떻게 VMware Vm tooAzure hello를 사용 하 여 복제 하는 경우 복제 정책을 tooset [Azure Site Recovery](site-recovery-overview.md) hello Azure 포털의에서 서비스입니다.
