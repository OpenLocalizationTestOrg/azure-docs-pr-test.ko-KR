...
---
# <a name="step-5-prepare-azure-resources-for-hyper-v-replication-with-vmm-tooazure"></a>5 단계: Hyper-v (VMM)와 복제 tooAzure Azure 리소스 준비

확인 한 후 [네트워크 요구 사항](vmm-to-azure-walkthrough-network.md),이 문서 tooprepare Azure의에서 hello 지침을 사용 하 여 리소스 사용 하 여 클라우드 tooAzure System Center Virtual Machine Manager (VMM)의 온-프레미스 Hyper-v Vm, 복제할 수 있도록 hello [Azure Site Recovery](site-recovery-overview.md) 서비스입니다.
...
너무 이동[6 단계: 준비 VMM](vmm-to-azure-walkthrough-vmm-hyper-v.md)
