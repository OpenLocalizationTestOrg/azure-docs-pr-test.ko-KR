...
3. **원본 및 대상**:
    ...
    ![Azure 하이퍼-V/v m M 복제](./media/site-recovery-components/arch-onprem-onprem-azure-vmm.png) ![azure 하이퍼-V 사이트 간 복제](./media/site-recovery-components/arch-onprem-azure-hypervsite.png)
