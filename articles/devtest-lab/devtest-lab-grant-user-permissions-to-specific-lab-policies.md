...
예를 들어, 사용자가 읽기/쓰기 권한을 부여 하기 위해는 **VM 크기** 정책을 사용 하는 사용자 지정 역할 만듭니다는 **Microsoft.DevTestLab/labs/policySets/policies/*** 작업 후의 범위에이 사용자 지정 역할에 적절 한 사용자를 할당 **Microsoft.DevTestLab/labs/policySets/policies/AllowedVmSizesInLab**합니다.
