...
> Engagement Reach SDK 리소스 (그릴 및 응용 프로그램에서 레이아웃 파일 tooinclude).
> 
> 
...
> 
> Hello 소스 hello 서비스에 포함 되지 않습니다 (`com.microsoft.azure.engagement.service.EngagementService` 와 해당 관련된 소스 파일).
> 
> 

`documentation.html`

> 바로 가기 toohello 설명서 사이트 해당 toohello hello SDK의 버전을 다운로드 합니다.
> 
> 

다른 파일은 hello 소프트웨어 라이선스의 복사본입니다.
