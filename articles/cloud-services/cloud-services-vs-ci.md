...
Azure 클라우드 서비스에 대 한 진단 확장을 설정 하는 방법에 대 한 자세한 내용은 참조 하십시오 [PowerShell을 사용 하 여 Azure 클라우드 서비스에서 진단 사용][Enable diagnostics in Azure Cloud Services using PowerShell]
