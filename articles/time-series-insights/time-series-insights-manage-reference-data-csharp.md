...
---
# <a name="manage-reference-data-for-an-azure-time-series-insights-environment-by-using-c"></a><span data-ttu-id="92cca-103">C#을 사용하여 Azure Time Series Insights 환경에 대한 참조 데이터 관리</span><span class="sxs-lookup"><span data-stu-id="92cca-103">Manage reference data for an Azure Time Series Insights environment by using C#</span></span>

<span data-ttu-id="92cca-104">이 C# 샘플 toomanage Azure 시간 계열 Insights 환경에 대 한 데이터를 참조 하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="92cca-104">This C# sample demonstrates how toomanage reference data for an Azure Time Series Insights environment.</span></span>
<span data-ttu-id="92cca-105">실행 중인 hello 샘플 하기 전에 hello 다음 단계는 완료를 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="92cca-105">Before running hello sample, ensure hello following steps are completed.</span></span>
1. <span data-ttu-id="92cca-106">[이 문서](time-series-insights-add-reference-data-set.md)를 사용하여 참조 데이터 집합을 만들었습니다.</span><span class="sxs-lookup"><span data-stu-id="92cca-106">A reference data set has been created using [this article](time-series-insights-add-reference-data-set.md).</span></span>
2. <span data-ttu-id="92cca-107">hello Azure Active Directory API를 통해 획득 hello 응용 프로그램을 실행할 때 사용 되는 액세스 토큰을 hello입니다.</span><span class="sxs-lookup"><span data-stu-id="92cca-107">hello access token used when running hello application is acquired through hello Azure Active Directory API.</span></span> <span data-ttu-id="92cca-108">Hello이이 토큰을 전달 해야 `Authorization` 모든 쿼리 API 요청의 헤더입니다.</span><span class="sxs-lookup"><span data-stu-id="92cca-108">This token should be passed in hello `Authorization` header of every Query API request.</span></span> <span data-ttu-id="92cca-109">비 대화형 응용 프로그램, 설정에 대 한 참조 hello [인증 및 권한 부여](time-series-insights-authentication-and-authorization.md) 문서.</span><span class="sxs-lookup"><span data-stu-id="92cca-109">For setting up non-interactive applications, see hello [Authentication and authorization](time-series-insights-authentication-and-authorization.md) article.</span></span>
3. <span data-ttu-id="92cca-110">Hello 샘플 hello 맨 앞에 정의 된 모든 hello 상수 올바르게 설정 됩니다.</span><span class="sxs-lookup"><span data-stu-id="92cca-110">All hello constants defined at hello beginning of hello sample are correctly set.</span></span>

## <a name="c-sample"></a><span data-ttu-id="92cca-111">C# 샘플</span><span class="sxs-lookup"><span data-stu-id="92cca-111">C# sample</span></span>
...
## <a name="next-steps"></a><span data-ttu-id="92cca-112">다음 단계</span><span class="sxs-lookup"><span data-stu-id="92cca-112">Next steps</span></span>

<span data-ttu-id="92cca-113">Hello 전체 API 참조에 대 한 참조 [참조 데이터 API](/rest/api/time-series-insights/time-series-insights-reference-reference-data-api) 문서.</span><span class="sxs-lookup"><span data-stu-id="92cca-113">For hello complete API reference, see [Reference Data API](/rest/api/time-series-insights/time-series-insights-reference-reference-data-api) document.</span></span>
