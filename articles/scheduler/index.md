---
title: "aaaAzure 스케줄러 설명서-자습서, API 참조 | Microsoft Docs"
description: "자세한 방법을 toouse 스케줄러 tooschedule 하 고 되풀이 응용 프로그램 작업와 일상적인 유지 관리와 같은 작업을 호출 합니다. 자습서, API 참조 등입니다."
services: scheduler
author: carolz
manager: carolz
layout: LandingPage
...
자세한 방법을 toouse 스케줄러 tooschedule 하 고 자동으로 hello 클라우드에서 되풀이 작업을 호출 합니다. 자습서, API 참조, 및 기타 문서 설명 되풀이 응용 프로그램 작업와 일상적인 유지 관리와 같은 작업 tooschedule 및 모니터링 합니다.
