...
### [2.0 too.NET 마이그레이션](key-vault-dotnet2api-release-notes.md)
### 개요
...
### [CLI 키 자격 증명 모음 toouse 소프트-삭제 방법](key-vault-soft-delete-cli.md)
### [PowerShell과 함께 키 자격 증명 모음 toouse 소프트-삭제 방법](key-vault-soft-delete-powershell.md)
### [그룹 toogrant 액세스 사용](key-vault-group-permissions-for-apps.md)
