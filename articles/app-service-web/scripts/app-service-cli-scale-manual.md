...
이 시나리오에서는 리소스 그룹 toocreate 배웁니다 앱 서비스 계획 및 웹 앱입니다. 단일 인스턴스 toomultiple 인스턴스에서 hello 앱 서비스 계획을 확장 한 다음 됩니다.
...
| [az appservice plan update](https://docs.microsoft.com/cli/azure/appservice/plan#update) | Hello 앱 서비스 계획의 속성을 업데이트 합니다. |
