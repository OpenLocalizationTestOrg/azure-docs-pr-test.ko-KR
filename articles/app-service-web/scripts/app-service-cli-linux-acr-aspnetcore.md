...
이 시나리오에서는 toocreate 리소스 그룹 Linux 응용 프로그램 서비스 계획 및 웹 앱 및 Docker 컨테이너에서 hello Azure 컨테이너 레지스트리를 사용 하 여 ASP.NET Core 응용 프로그램 배포 방법을 배웁니다.
...
| [az webapp config container set](https://docs.microsoft.com/cli/azure/webapp/config/container#set) | Hello Azure 웹 앱에 대 한 hello Docker 컨테이너를 설정합니다. |
