...
필요한 경우 설치 명령 hello를 사용 하 여 Azure PowerShell hello 있는 hello [Azure PowerShell 가이드](/powershell/azure/overview)합니다. 또한 hello 웹 응용 프로그램 코드를 포함 하는 링크 tooGitHub 리포지토리의 해야 합니다.
