...
---
# <a name="use-powershell-tooconfigure-an-active-geo-replication-failover-group-for-a-single-azure-sql-database"></a>단일 Azure SQL 데이터베이스에 대 한 PowerShell tooconfigure는 활성 지리적 복제 그룹을 장애 조치를 사용 하 여

이 PowerShell 스크립트 예제는 단일 Azure SQL 데이터베이스에 대 한 활성 지리적 복제 장애 조치 그룹을 구성 하 고 tooa hello Azure SQL 데이터베이스의 보조 복제본으로 장애 조치 합니다.
