...
사용 하 여 hello는 [X.509 인증서 장치 기반] [ lnk-protocols] 하 고 해당 연결 된 개인 및 공개 키 쌍 hello 물리적 계층에서 추가 인증을 허용 합니다. hello 개인 키 hello 장치에 안전 하 게 저장 되며 hello 장치 외부 검색할 수 없습니다. hello X.509 인증서에는 장치 ID와 같은 hello 장치에 대 한 정보 및 기타 조직 구성 세부 정보가 포함 되어 있습니다. Hello 인증서의 서명은 hello 개인 키를 사용 하 여 생성 됩니다.
...
* [Azure Cosmos DB][lnk-docdb]: hello 장치에 대 한 메타 데이터를 관리 하는 반 구조화 된 데이터에 대 한 확장성, 완벽 하 게 인덱싱할 데이터베이스 서비스를 프로 비전 할 같은 특성, 구성 및 보안 속성입니다. Cosmos DB는 높은 성능 및 처리량 처리, 데이터의 스키마와 관계 없는 인덱싱 및 풍부한 SQL 쿼리 인터페이스를 제공합니다.
