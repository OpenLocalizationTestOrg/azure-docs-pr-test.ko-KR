# 개요
## [소개 tooAzure 데이터 팩터리](data-factory-introduction.md)
## 개념
...
# 시작
## [자습서: 파이프라인 toocopy 데이터 만들기](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md)
...
## [자습서: 파이프라인 tootransform 데이터 만들기](data-factory-build-your-first-pipeline.md)
...
#### [연습: 온-프레미스 SQL Server tooAzure Blob 저장소에서에서 데이터를 이동합니다.](data-factory-move-data-between-onprem-and-cloud.md)
