...
#### [Hello 하이브 보기를 사용 하 여](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Visual Studio 용 HDInsight 도구 hello를 사용 하 여](hdinsight-hadoop-use-hive-visual-studio.md)
#### [원격 데스크톱 사용](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Hello 쿼리 콘솔을 사용 하 여](hdinsight-hadoop-use-hive-query-console.md)
...
### [Hello MapReduce 예제 실행](hdinsight-hadoop-run-samples-linux.md)
...
#### [Hello.NET SDK를 사용 하 여](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [쓰기 tooData Lake 저장소](hdinsight-storm-write-data-lake-store.md)
...
### [HDInsight 도구 toocreate Spark 앱 사용](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [SSH 통해 원격으로 HDInsight 도구 toodebug Spark 앱 사용](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Excel tooHadoop 연결](hdinsight-connect-excel-hive-odbc-driver.md)
### [Hello 하이브 JDBC 드라이버를 사용 하 여 연결](hdinsight-connect-hive-jdbc-driver.md)
...
### [HDInsight tooyour 온-프레미스 네트워크에 연결](connect-on-premises-network.md)
...
#### [REST tooinstall 앱 사용](https://msdn.microsoft.com/library/mt706515.aspx)
#### [HDInsight 앱 tooAzure 마켓플레이스에 게시](hdinsight-apps-publish-applications.md)
## 보안
### [HDInsight와 함께 SSH 사용](hdinsight-hadoop-linux-use-ssh-unix.md)
### [SSH 터널링 사용](hdinsight-linux-ambari-ssh-tunnel.md)
### [Toodata 액세스 제한](hdinsight-storage-sharedaccesssignature-permissions.md)
## 관리
...
#### [CURL을 사용 하 고 hello Azure REST API](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Hello.NET SDK를 사용 하 여](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Hello Azure CLI를 사용 하 여](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Hello Azure 포털을 사용 하 여](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Hello Azure CLI를 사용 하 여](hdinsight-administer-use-command-line.md)
### [Hello Ambari web UI를 사용 하 여 클러스터를 관리 합니다.](hdinsight-hadoop-manage-ambari.md)
...
### [마이그레이션 tooResource 관리자 개발 도구](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [가용성 및 안정성](hdinsight-high-availability-linux.md)
### [HDInsight 클러스터 toonewer 버전 업그레이드](hdinsight-upgrade-cluster.md)
...
#### [Ambari 뷰 toodebug Tez 작업 사용](hdinsight-debug-ambari-tez-view.md)
...
# 관련 항목
## Windows 클러스터
### [Windows 클러스터 tooLinux 클러스터 마이그레이션](hdinsight-migrate-from-windows-to-linux.md)
### [.NET 솔루션 tooLinux 클러스터 마이그레이션](hdinsight-hadoop-migrate-dotnet-to-linux.md)
### [Hadoop MapReduce 샘플 실행](hdinsight-run-samples.md)
### [클러스터의 Solr 사용](hdinsight-hadoop-solr-install-linux.md)
### [Giraph tooprocess 대규모 그래프를 사용 하 여](hdinsight-hadoop-giraph-install.md)
### [워크플로에 대해 Oozie 사용](hdinsight-use-oozie.md)
### [Storm 토폴로지 배포 및 관리](hdinsight-storm-deploy-monitor-topology.md)
### [Maven toobuild Java 응용 프로그램을 사용 하 여](hdinsight-hbase-build-java-maven.md)
### [Hello Tez I toodebug Tez 작업을 사용 하 여](hdinsight-debug-tez-ui.md)
...
### [Hello Ambari API를 사용 하 여 클러스터 모니터링](hdinsight-monitor-use-ambari-api.md)

# 리소스
## [Azure 로드맵](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Hello 포럼 도움말을 보려면](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
