...
## 개요
### [Hello 솔루션 이란?](storsimple-ova-overview.md)
...
### 배포
#### [Toodeploy 준비](storsimple-virtual-array-deploy1-portal-prep.md)
...
## 개요
### [Hello 솔루션 이란?](storsimple-overview.md)
...
##### [Tooyour 장치를 원격으로 연결](storsimple-8000-remote-connect.md)
...
###### [장애 조치 toophysical 장치](storsimple-8000-device-failover-physical-device.md)
###### [장애 조치 toocloud 어플라이언스](storsimple-8000-device-failover-cloud-appliance.md)
###### [장애 조치 toosame 장치](storsimple-8000-device-failover-same-device.md)
...
#### [파일 서버 DR tooAzure 자동화](storsimple-disaster-recovery-using-azure-site-recovery.md)
...
#### [다른 저장 장치에서](http://download.microsoft.com/download/9/4/A/94AB8165-CCC4-430B-801B-9FD40C8DA340/Migrating Data tooStorSimple Volumes_09-02-15.pdf)
...
##### [Tooyour 장치를 원격으로 연결](storsimple-remote-connect.md)
...
## 개요
### [Hello 솔루션 이란?](storsimple-data-manager-overview.md)

## 시작
### [StorSimple 데이터 관리자 사용](storsimple-data-manager-ui.md)

## 방법
### [.NET toostart 작업 사용](storsimple-data-manager-dotnet-jobs.md)
### [자동화 toostart 작업 사용](storsimple-data-manager-job-using-automation.md)
### [기본 Blob 경로 변경](storsimple-data-manager-change-default-blob-path.md)

# 파트너용 StorSimple

## 개요
### [Hello 솔루션 이란?](storsimple-partner-csp-overview.md)
