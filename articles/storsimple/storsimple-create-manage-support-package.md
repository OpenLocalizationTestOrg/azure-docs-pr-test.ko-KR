...
이 자습서는 toocreate 단계별 지침을 포함 하 고 hello 지원 패키지를 관리 합니다.

## <a name="create-and-upload-a-support-package-in-hello-azure-classic-portal"></a>Hello Azure 클래식 포털에서에서 지원 패키지 만들기 및 업로드
만들고 hello 통해 지원 패키지 toohello Microsoft 지원 사이트에 업로드할 수 **유지 관리** hello 서비스 hello Azure 클래식 포털에서에서의 페이지입니다.

> [!NOTE]
> hello 업로드 지원 암호가 필요합니다. 지원 엔지니어가 전자 메일로이 tooyou를 제공 해야 합니다.
> 
> 

암호화 및 압축 된 지원 패키지 (.cab 파일)은 생성 되 고 업로드 toohello 지원 사이트입니다. 그런 다음 hello 지원 엔지니어 hello 문제 해결에 대 한 hello 지원 사이트에서이 패키지를 검색할 수 있습니다.

Hello hello 클래식 포털 toocreate 지원 패키지의에서 단계를 수행 합니다.

#### <a name="toocreate-a-support-package-in-hello-azure-classic-portal"></a>toocreate hello Azure 클래식 포털에서에서 지원 패키지
1. **장치** > **유지 관리**를 선택합니다.
2. Hello에 **지원 패키지** 섹션에서 **지원 패키지 만들기 및 업로드**합니다.
3. Hello에 **지원 패키지 만들기 및 업로드** 대화 상자에서 다음 hello지 않습니다.
   
    ![지원 패키지 만들기](./media/storsimple-create-manage-support-package/IC740923.png)
   
   * Hello에 **지원 암호** 텍스트 상자에 hello 암호 키를 입력 합니다. Microsoft 지원 엔지니어 전자 메일로이 암호 tooyou를 보내야 합니다.
   * Hello 확인란 tooprovide 동의 tooautomatically 업로드 hello 지원 패키지 toohello Microsoft 지원 사이트를 선택 합니다.
   * Hello 확인 아이콘을 클릭 합니다. ![확인 아이콘](./media/storsimple-create-manage-support-package/IC740895.png)를 선택합니다.
...
2. Hello Windows PowerShell 세션에서 장치의 SSAdmin 콘솔 toohello 연결:
   ...
   * Hello 명령 프롬프트에서 다음을 입력 합니다.
     
       `$MS = New-PSSession -ComputerName <IP address for DATA 0> -Credential SSAdmin -ConfigurationName "SSAdminConsole"`
   * Hello 대화 상자가 열리면 장치 관리자 암호를 입력 합니다. hello 기본 암호가입니다.
...
3. 열린 hello 세션 hello 적절 한 명령을 입력 합니다.
   ...
   * 암호로 보호 되지 않은 공유에 대 한 불필요 hello `-Credential` 매개 변수입니다. Hello 다음을 입력 합니다.
       ...
       hello 지정 된 네트워크 공유 폴더에 있는 두 컨트롤러에 대 한 hello 지원 패키지가 생성 됩니다. 문제 해결에 대 한 지원 tooMicrosoft 보낼 수 있는 암호화, 압축 된 파일입니다. 자세한 내용은 [Microsoft 지원에 문의](storsimple-contact-microsoft-support.md)를 참조하세요.
...
> [!IMPORTANT]
> StorSimple용 Windows PowerShell을 통해 생성된 지원 패키지를 편집할 수 있습니다. Hello StorSimple Manager 서비스와 Azure 클래식 포털에서에서 만든 패키지를 편집할 수 없습니다.
> 
> 
