...
---
# <a name="deploy-your-on-premises-storsimple-device-in-hello-government-portal"></a>Hello 정부 포털에서에서 온-프레미스 StorSimple 장치 배포
[!INCLUDE [storsimple-version-selector-deploy-gov](../../includes/storsimple-version-selector-deploy-gov.md)]

## <a name="overview"></a>개요
TooMicrosoft Azure StorSimple 장치 배포를 시작 합니다. 이러한 배포 자습서 toohello StorSimple 8000 시리즈 업데이트 1 소프트웨어를 실행 hello Azure Government 포털에에서 적용 됩니다. 이 일련의 자습서에 설명 방법을 tooconfigure StorSimple 장치를 포함 한 구성 검사 목록, 구성 사전 요구 사항 및 자세한 구성 단계입니다.
...
| &nbsp; |서비스 등록 키 |이 키는 hello Azure 포털에서에서 생성 됩니다. | |
