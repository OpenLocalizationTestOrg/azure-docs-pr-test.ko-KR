...
---
# <a name="deploy-your-on-premises-storsimple-device-in-hello-government-portal"></a>Hello 정부 포털에서 온-프레미스 StorSimple 장치 배포

## <a name="overview"></a>개요
TooMicrosoft Azure StorSimple 장치 배포를 시작 합니다. 이러한 배포 자습서 toohello StorSimple 8000 시리즈 업데이트 3 소프트웨어를 실행 하거나 나중에 hello Azure Government 포털에 적용 됩니다. 이 자습서 시리즈에서는 StorSimple 장치를 구성하는 방법에 대해 설명하며 구성 검사 목록, 구성 필수 조건 목록 및 자세한 구성 단계를 포함합니다.
...
이러한 단계가 tooconfigure StorSimple 장치 성능과 tooyour StorSimple 장치 관리자 서비스를 연결 합니다. 또한 toohello 필요한 단계를 가지는 선택적 단계와 절차가 hello 배포 하는 동안 toocomplete를 할 수 있습니다. hello 단계별 배포 지침은 각 선택적 단계를 수행 해야 하는 시기를 나타냅니다.
...
StorSimple 장치 관리자 서비스는 여러 StorSimple 장치를 관리할 수 있습니다. Hello 단계 toocreate hello StorSimple 장치 관리자 서비스의 새 인스턴스를 다음을 수행 합니다.
...
Hello StorSimple 장치 관리자 서비스가 실행 되 고, tooget hello 서비스 등록 키가 필요 합니다. 이 키가 사용 되는 tooregister를 StorSimple 장치 toohello 서비스를 연결 합니다.

Hello hello 정부 포털에서 단계를 수행 합니다.
...
Hello hello Azure Government 포털 toocomplete hello 최소 장치 설치에서 단계를 수행 합니다.
...
Hello 정부 포털 hello에 단계를 수행 하는 hello 수행 **StorSimple 장치 관리자 서비스** 페이지.
...
StorSimple 장치에서 단일 볼륨에 대 한 주문형 수동 백업 hello 정부 포털 toocreate 단계를 수행 하는 hello를 수행 합니다.

[!INCLUDE [Create a manual backup](../../includes/storsimple-8000-create-manual-backup.md)]

## <a name="next-steps"></a>다음 단계
* [가상 장치](storsimple-8000-cloud-appliance-u2.md)를 구성합니다.
* 사용 하 여 hello [StorSimple 장치 관리자 서비스](storsimple-8000-manager-service-administration.md) toomanage StorSimple 장치입니다.
