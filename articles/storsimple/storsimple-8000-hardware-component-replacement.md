...
|:--- |:--- |:--- |:--- |
| 섀시 |1 |아니요 |[StorSimple 장치에 hello 섀시 교체](storsimple-8000-chassis-replacement.md) |
...
| 백업 배터리 |2 |예 |[StorSimple 장치에서 hello 백업 배터리 모듈 교체](storsimple-8000-battery-replacement.md) |
...
하십시오 [Microsoft 지원에 문의](storsimple-8000-contact-microsoft-support.md) tooorder 이러한 교체 장비입니다.
