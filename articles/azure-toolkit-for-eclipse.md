...
> [!NOTE]
> IntelliJ IDE용 Azure 도구 키트도 있습니다. 자세한 내용은 [IntelliJ용 Azure 도구 키트](azure-toolkit-for-intellij.md)를 참조하세요.
> 
> 
...
## <a name="configure-azure-project-settings"></a>Azure 프로젝트 설정 구성
...
* [Azure Storage 계정 목록](azure-toolkit-for-eclipse-azure-storage-account-list.md)
...
## <a name="use-the-azure-toolkit-for-eclipse"></a>Eclipse용 Azure 도구 키트 사용
...
* [Eclipse용 HDInsight 도구 플러그 인을 사용하여 HDInsight Spark Linux 클러스터용 Spark 응용 프로그램 만들기](hdinsight/hdinsight-apache-spark-eclipse-tool-plugin.md)
