...
Security Center를 사용하면 가상 컴퓨터의 보안 설정에 가시성을 제공하여 Azure의 가상 컴퓨터 데이터를 보호할 수 있습니다. Vm을 보호 하는 보안 센터, 기능을 수행 하는 hello 사용할 수 있습니다.
...
보안 정책으로 설정한 후 보안 센터 리소스 tooidentify 잠재적인 취약점의 hello 보안 상태를 분석 합니다. hello 권장 여기서 각 줄은 한 가지 특정 권장 하는 테이블 형식으로 표시 됩니다. hello 아래 표에서 Azure Vm 및 각은 적용 하는 경우 수행할 작업에 대 한 권장 구성의 몇 가지 예입니다. 권장 구성을 선택 하면 tooimplement 보안 센터의 권장 조치를 hello 하는 방법을 보여 주는 정보가 제공 됩니다.
