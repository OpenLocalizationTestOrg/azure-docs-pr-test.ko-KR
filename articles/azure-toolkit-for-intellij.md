...
> [!NOTE]
> Azure Toolkit for Eclipse IDE이기도합니다. 자세한 내용은 [Eclipse용 Azure 도구 키트 설치](azure-toolkit-for-eclipse.md)를 참조하세요.
> 
> 
...
## <a name="use-the-azure-toolkit-for-intellij"></a>IntelliJ용 Azure 도구 키트 사용
...
* [IntelliJ IDEA용 HDInsight 도구 플러그 인을 사용하여 HDInsight Spark Linux 클러스터용 Spark 응용 프로그램 만들기](hdinsight/hdinsight-apache-spark-intellij-tool-plugin.md)
