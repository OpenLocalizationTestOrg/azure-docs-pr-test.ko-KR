...
* **useFlatBlobListing** hello에 설명 된 대로- [이름 지정 및 참조 하는 컨테이너 및 blob](/rest/api/storageservices/Naming-and-Referencing-Containers--Blobs--and-Metadata) 섹션 hello Blob 서비스는 플랫 저장소 스키마를 만들 수 있습니다는 가상 계층 경로 사용 하 여 blob 이름을 지정 하 여 정보입니다. 그러나 현재는 플랫이 아닌 목록은 지원되지 않습니다. 이 기능은 곧 제공됩니다. 현재 이 값은 **YES**여야 합니다.
