...
<span data-ttu-id="50699-111">hello 다음 매개 변수 지정 될 수 있습니다 **RepairImport**:</span><span class="sxs-lookup"><span data-stu-id="50699-111">hello following parameters can be specified with **RepairImport**:</span></span> 
