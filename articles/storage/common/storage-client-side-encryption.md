...
클라이언트 쪽 암호화 및 Azure 키 자격 증명 모음을 사용 하 여 blob 암호화 hello 과정을 안내 하는 단계별 자습서를 참조 하십시오. [Azure 키 자격 증명 모음을 사용 하 여 Microsoft Azure 저장소에서 암호화 및 암호 해독 blob](../blobs/storage-encrypt-decrypt-blobs-key-vault.md)합니다.
