...
* [Hello Azure CLI 2.0을 사용 하 여 Linux VM 만들기](../../virtual-machines/windows/quick-create-cli.md)
...
만들 수 있습니다 [증분 스냅숏](../../virtual-machines/windows/incremental-snapshots.md) 동일 hello에 관리 되지 않는 표준 디스크에 대 한 스냅숏 저장소를 사용 하면 표준 방법입니다. 스냅숏을 만들 원본 디스크가 로컬 중복 저장소 계정에 해당 스냅숏을 tooa 표준 지역 중복 저장소 계정 다음 복사 하는 것이 좋습니다. 자세한 내용은 [Azure 저장소 중복 옵션](../storage-redundancy.md)을 참조하세요.
