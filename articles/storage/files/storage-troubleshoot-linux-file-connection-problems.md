...
일부 핸들을 닫아 hello 동시 열려 있는 핸들 수를 줄인 hello 작업을 다시 시도 하십시오. 자세한 내용은 [Microsoft Azure Storage 성능 및 확장성 검사 목록](../common/storage-performance-checklist.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json)을 참조하세요.
