...
Xamarin 사용 하면 개발자가 toouse 공유 C# toocreate iOS, Android 및 Windows 스토어 앱의 네이티브 사용자 인터페이스를 가진 codebase 합니다. 이 자습서에서는 어떻게 toouse Xamarin 응용 프로그램과 함께 Azure Blob 저장소입니다. Hello 코드 알아보기 전에 Azure 저장소에 대 한 자세한 toolearn 싶으시면 참조 [Azure 저장소 소개 tooMicrosoft](../common/storage-introduction.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)합니다.
