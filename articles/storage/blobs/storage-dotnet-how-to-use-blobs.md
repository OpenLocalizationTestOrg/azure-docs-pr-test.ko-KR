...
* **공유 액세스 서명:** 지정 하는 권한으로 및 지정 된 간격으로 저장소 계정의 위임 된 액세스 tooa 리소스를 제공 하는 공유 액세스 서명 (SAS)으로 클라이언트를 제공할 수 있습니다. 자세한 내용은 [SAS(공유 액세스 서명) 사용](../common/storage-dotnet-shared-access-signature-part-1.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json) 을 참조하세요.
