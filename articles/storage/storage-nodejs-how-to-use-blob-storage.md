...
방법에 대 한 지침은 toocreate는 Node.js 응용 프로그램 참조 [Azure 앱 서비스에 Node.js 웹 응용 프로그램을 만들], [빌드하고 Node.js 응용 프로그램 tooan Azure 클라우드 서비스 배포] -Windows PowerShell을 사용 하 여 또는 [빌드 및 배포 웹 매트릭스를 사용 하는 Node.js 웹 응용 프로그램 tooAzure]합니다.
...
Hello에 hello 환경 변수 설정에 대 한 예제 [Azure 포털](https://portal.azure.com) 는 Azure 웹 앱에 대 한 참조 [Azure 테이블 서비스 hello 사용 하 여 Node.js 웹 응용 프로그램]합니다.
