...
---
# <a name="using-hello-azure-importexport-tool-v1"></a>Azure 가져오기/내보내기 도구 (v1) hello를 사용 하 여
...
이 설명서는 v 1의 hello Azure 가져오기/내보내기 도구에 대 한 합니다. Hello hello 도구의 최신 버전을 사용 하는 방법에 대 한 정보를 참조 하십시오 [Azure 가져오기/내보내기 도구를 사용 하 여 hello](storage-import-export-tool-how-to.md)합니다.
