...
Hello 저장소 계정 컨텍스트를 만듭니다. hello 컨텍스트 hello 저장소 계정 이름 및 계정 키를 캡슐화합니다. Hello에서 계정 키를 복사에 대 한 지침은 [Azure 포털](https://portal.azure.com), 참조 [저장소 액세스 키 보기 및 복사](storage-create-storage-account.md#view-and-copy-storage-access-keys)합니다.
