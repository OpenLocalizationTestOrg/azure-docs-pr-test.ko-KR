...
또한 AzCopy toocopy 하나의 파일 tooanother 또는 blob tooa 파일 되거나 그 반대 방향 toocopy를 사용할 수 있습니다. 참조 [hello AzCopy 명령줄 유틸리티를 사용 하 여 데이터를 전송](storage-use-azcopy.md)합니다.
...
또한 참조할 수 있습니다 너무[Azure 파일 저장소 문제 해결 문서](storage-troubleshoot-file-connection-problems.md) 종단 간 문제 해결 지침에 대 한 합니다.
