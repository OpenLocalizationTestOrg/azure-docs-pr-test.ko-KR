...
이 자습서에 설명 어떻게 toointegrate Azure Active Directory (Azure AD)와 AnswerHub 합니다.

Azure AD와 AnswerHub 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooAnswerHub을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooAnswerHub (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
AnswerHub와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. AnswerHub은 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-answerhub-from-hello-gallery"></a>AnswerHub은 hello 갤러리 추가
tooconfigure hello와의 통합 AnswerHub Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 AnswerHub tooadd가 필요합니다.

**hello 갤러리에서 AnswerHub tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow AnswerHub에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 AnswerHub에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

AnswerHub에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 AnswerHub 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on) ** -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user) ** -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[AnswerHub 테스트 사용자 만들기](#creating-an-answerhub-test-user) ** -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 AnswerHub에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user) ** -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on) ** -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 AnswerHub 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 AnswerHub를 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **AnswerHub** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **AnswerHub 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-answerhub-tutorial/tutorial_answerhub_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company>.answerhub.com`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company>.answerhub.com`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [AnswerHub 클라이언트 지원 팀](mailto:success@answerhub.com) tooget 이러한 값입니다. 
...
6. Hello에 **AnswerHub 구성** 섹션에서 클릭 **구성 AnswerHub** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**
...
9. Hello 클릭 **사용자 및 그룹** 탭 합니다.

10. 왼쪽, hello에 hello hello 탐색 창에서 **소셜 설정** 섹션에서 클릭 **SAML 설정**합니다.

11. **IDP 구성** 탭을 클릭합니다.

12. Hello에 **IDP 구성** 탭 hello 다음 단계를 수행 하십시오.
     ...
     c. **IDP 이름 식별자 형식** textbox hello 사용자 식별자 값 같은 선택한 상태에서 Azure 포털에 입력 **사용자 특성** 섹션.
  
     d. **키 및 인증서**를 클릭합니다.

13. Hello 키 및 인증서 탭에서 단계를 수행 하는 hello를 수행 합니다.
    
     ![키 및 인증서](./media/active-directory-saas-answerhub-tutorial/ic785173.png "키 및 인증서")  
 
     a. 메모장에서 콘텐츠를 클립보드에 복사 hello Azure 포털에서 다운로드 하 여 e-64로 인코딩된 인증서를 열고 다음 toohello **IDP 공개 키 (x 509 형식)** 텍스트 상자에 붙여넣습니다.
  
     b. **Save**를 클릭합니다.

14. Hello에 **IDP 구성** 탭을 클릭 **저장**합니다.
...
tooenable Azure AD 사용자가 toolog tooAnswerHub에서 프로 비전 해야 AnswerHub에 있습니다.  
Hello AnswerHub의 경우에서 프로 비전은 수동 작업입니다.

**tooprovision 사용자 계정을 hello 다음 단계를 수행 합니다.**

1. Tooyour 로그인 **AnswerHub** 회사 사이트에서 관리자 권한으로 로그인 합니다.

2. 너무 이동**관리**합니다.

3. Hello 클릭 **사용자 및 그룹** 탭 합니다.

4. 왼쪽, hello에 hello hello 탐색 창에서 **사용자 관리** 섹션에서 클릭 **사용자 만들기 또는 가져오기**합니다.
   
   ![사용자 및 그룹](./media/active-directory-saas-answerhub-tutorial/ic785175.png "사용자 및 그룹")

5. 형식 hello **전자 메일 주소**, **Username** 및 **암호** 유효한 Azure의 hello tooprovision 원하는 Active Directory 계정 관련 텍스트 상자 및 클릭** 저장**합니다.

>[!NOTE]
>다른 AnswerHub 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 AAD 사용자 계정을 tooprovision AnswerHub에서 제공 된 Api입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooAnswerHub 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooAnswerHub hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **AnswerHub**합니다.
...
Hello 액세스 패널에서에서 hello AnswerHub 타일을 클릭할 때 자동으로 로그온 tooyour AnswerHub 응용 프로그램을 구해야 합니다.
