...
이 자습서에 설명 toointegrate SkyDesk Azure Active Directory (Azure AD)에 전자 메일로 보내기 방법입니다.

다음 이점을 hello로 제공 SkyDesk 전자 메일을 Azure AD와 통합:

- 액세스 tooSkyDesk 전자 메일을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooSkyDesk 전자 메일 (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Azure AD 통합 SkyDesk 전자 메일을 가진 tooconfigure hello 다음 항목 필요 합니다.
...
1. Hello 갤러리에서 SkyDesk 전자 메일 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-skydesk-email-from-hello-gallery"></a>Hello 갤러리에서 SkyDesk 전자 메일 추가
tooconfigure hello 통합 SkyDesk 전자 메일의 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd SkyDesk 전자 메일 필요합니다.

**tooadd hello 갤러리, 전자 메일 SkyDesk hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **SkyDesk 전자 메일**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_search.png)

5. Hello 결과 패널에서 선택 **SkyDesk 전자 메일**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow SkyDesk 전자 메일에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 hello SkyDesk 전자 메일의 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

SkyDesk 전자 메일의 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 SkyDesk 전자 메일을 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[전자 메일 SkyDesk 테스트 사용자 만들기](#creating-a-skydesk-email-test-user)**  -toohave Britta Simon SkyDesk는 전자 메일을 사용자의 연결 된 Azure AD toohello 표현에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 SkyDesk 전자 메일 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on SkyDesk 전자 메일을 가진 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **SkyDesk 전자 메일** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **SkyDesk 전자 메일 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_url.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://mail.skydesk.jp/portal/<companyname>`

    > [!NOTE] 
    > hello 값이 실제 아닙니다. 업데이트 hello 값과 실제 로그온 URL hello 합니다. 연락처 [SkyDesk 전자 메일 클라이언트 지원 팀](https://www.skydesk.sg/support/) tooget hello 값입니다. 
...
6. Hello에 **SkyDesk 전자 메일 구성** 섹션에서 클릭 **SkyDesk 전자 메일 구성** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_configure.png) 

7. tooenable SSO에서 **SkyDesk 전자 메일**, hello 다음 단계를 수행 합니다.

    a. 로그온 tooyour 관리자 권한으로 SkyDesk 전자 메일 계정입니다.

    b. Hello 메뉴에서 hello 위에 표시를 클릭 **설치**를 선택 하 고 **Org**합니다. 
    
      ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_51.png)
  
    c. 클릭 **도메인** hello 왼쪽된 패널에서 합니다.
    ...
    e. 사용자가 도메인 이름을 입력 하 고 hello 도메인을 확인 합니다.
    
      ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_55.png)

    f. 클릭 **SAML 인증** hello 왼쪽된 패널에서 합니다.
    
      ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_52.png)

8. Hello에 **SAML 인증** 대화 상자 페이지를 hello 다음 단계를 수행 합니다.
   
      ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_56.png)
   
    >[!NOTE]
    >toouse SAML 기반 인증을 해야 하거나 **확인 된 도메인과** 또는 **포털 URL** 설치 합니다. Hello 포털을 설정할 수 있습니다 hello 고유한 이름의 URL입니다.
    > 
    > 
   
    ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_57.png)

    a. Hello에 **로그인 URL** 붙여넣기 hello 값의 텍스트 상자 **SAML Single Sign-on 서비스 URL**, Azure 포털에서 복사한입니다.
   
    b. Hello에 **로그 아웃** URL 텍스트 상자, 붙여넣기 hello 값 **Sign-Out URL**, Azure 포털에서 복사한입니다.

    c. **암호 변경 URL** 은 선택 사항이므로 비워 둡니다.

    d. 클릭 **파일에서 가져올 키** tooselect Azure 포털에서 다운로드 한 인증서 **열려** tooupload hello 인증서입니다.

    e. **알고리즘**으로 **RSA**를 선택합니다.

    f. 클릭 **확인** toosave hello 변경 합니다.
...
1. 클릭 **사용자 액세스** hello 왼쪽에서 SkyDesk 전자 메일에 패널 및 사용자 이름을 입력 합니다. 

    ![Single Sign-on 구성](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_58.png)

>[!NOTE] 
>Toocontact hello toocreate 대량 사용자가 해야 하는 경우 해야 [SkyDesk 전자 메일 클라이언트 지원 팀](https://www.skydesk.sg/support/)합니다.


### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooSkyDesk 전자 메일을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooSkyDesk 전자 메일을 hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **SkyDesk 전자 메일**합니다.
...
Hello SkyDesk 전자 메일 hello 액세스 패널에서에서 타일을 클릭할 때 자동으로 로그온 tooyour SkyDesk 전자 메일 응용 프로그램을 구해야 합니다.
