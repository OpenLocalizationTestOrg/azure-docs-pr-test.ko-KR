...
이 자습서에 설명 어떻게 toointegrate ITRP와 Azure Active Directory (Azure AD).

Azure AD와 ITRP 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooITRP을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooITRP (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
ITRP와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. ITRP는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-itrp-from-hello-gallery"></a>ITRP는 hello 갤러리 추가
tooconfigure hello와의 통합 ITRP tooAzure AD에서에서 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 ITRP tooadd가 필요합니다.

**ITRP hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow ITRP에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 ITRP에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

ITRP에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 ITRP와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[테스트 사용자는 ITRP에 만들기](#creating-an-itrp-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 ITRP에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 ITRP 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on와 ITRP를 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **ITRP** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **ITRP 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-itrp-tutorial/tutorial_itrp_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<tenant-name>.itrp.com`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<tenant-name>.itrp.com`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [ITRP 클라이언트 지원 팀](https://www.itrp.com/support) tooget 이러한 값입니다. 
...
6. Hello에 **ITRP 구성** 섹션에서 클릭 **구성 ITRP** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL 및 Sign-Out URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-itrp-tutorial/tutorial_itrp_configure.png) 

7. 다른 웹 브라우저 창에서 관리자 권한으로 tooyour ITRP 회사 사이트에 로그인 합니다.

8. 도구 모음의 hello hello 위쪽에 클릭 **설정을**합니다.
   
    ![ITRP](./media/active-directory-saas-itrp-tutorial/ic775570.png "ITRP")

8. Hello 왼쪽된 탐색 창에서 선택 **Single Sign On**합니다.
   
    ![Single Sign-On](./media/active-directory-saas-itrp-tutorial/ic775571.png "Single Sign-On")

9. Hello Single Sign On 구성 섹션에서에서 단계를 수행 하는 hello를 수행 합니다.
    ...
    b. **원격 로그 아웃 URL** 붙여넣기 hello 값의 텍스트 상자 **Sign-Out URL**, Azure 포털에서 복사한입니다.

    c. **SAML SSO URL** 붙여넣기 hello 값의 텍스트 상자 **SAML Single Sign-on 서비스 URL**, Azure 포털에서 복사한입니다.

    d.In **인증서 지문** 텍스트 붙여넣기 hello **지문** Azure 포털에서 복사 되는 인증서의 값입니다. 
...
tooenable Azure AD 사용자가 toolog tooITRP에서 프로 비전 해야 tooITRP에 있습니다.  

Hello ITRP의 경우에서 프로 비전은 수동 작업입니다.

**tooprovision 사용자 계정을 hello 다음 단계를 수행 합니다.**

1. Tooyour 로그인 **ITRP** 테 넌 트입니다.

2. 도구 모음의 hello hello 위쪽에 클릭 **레코드**합니다.
   
    ![관리자](./media/active-directory-saas-itrp-tutorial/ic775575.png "관리자")

3. Hello 팝업 메뉴에서 선택 **사람**합니다.
...
5. Hello 새로운 사람 추가 대화 상자에서 hello 다음 단계를 수행 합니다.
   
    ![사용자](./media/active-directory-saas-itrp-tutorial/ic775577.png "사용자") 
      
    a. 형식 hello **이름**, **전자 메일** tooprovision 하려는 유효한 AAD 계정의 합니다.

    b. **Save**를 클릭합니다.

>[!NOTE]
>다른 ITRP 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 AAD 사용자 계정을 ITRP tooprovision에서 제공 된 Api입니다. 
> 

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooITRP 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooITRP hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **ITRP**합니다.
...
Hello ITRP hello 액세스 패널에서에서 타일을 클릭할 때 자동으로 로그온 tooyour ITRP 응용 프로그램을 구해야 합니다.
