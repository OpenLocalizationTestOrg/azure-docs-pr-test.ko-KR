...
이 자습서에 설명 어떻게 toointegrate Datahug Azure Active directory (Azure AD).

다음 이점을 hello로 제공 Datahug Azure AD와 통합:

- 액세스 tooDatahug을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooDatahug (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure Datahug와 Azure AD 통합 합니다.
...
1. Datahug은 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-datahug-from-hello-gallery"></a>Datahug은 hello 갤러리 추가
tooconfigure hello와의 통합 Datahug Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Datahug tooadd가 필요합니다.

**hello 갤러리에서 Datahug tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Datahug에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 Datahug에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** Datahug에 합니다.

tooconfigure 및 Datahug 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on) ** -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user) ** -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Datahug 테스트 사용자 만들기](#creating-a-datahug-test-user) ** -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Datahug에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user) ** -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on) ** -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Datahug 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, Datahug와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Datahug** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Datahug 도메인 및 Url** tooconfigure hello 응용 프로그램에 필요한 경우 섹션 **IDP** 시작 모드:

    ![Single Sign-on 구성](./media/active-directory-saas-datahug-tutorial/tutorial_datahug_ur1.png)

    a. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://apps.datahug.com/identity/<uniqueID>`

    b. Hello에 **회신 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://apps.datahug.com/identity/<uniqueID>/acs`
...
4. **고급 URL 설정 표시**를 선택합니다. Tooconfigure hello 응용 프로그램에 필요한 경우 **SP** 시작 모드:
    ...
    Hello에 **로그온 URL** 텍스트 상자에 다음 URL로:`https://apps.datahug.com/`
     
    > [!NOTE] 
    > 이러한 값은 실제 hello 되지 않습니다. Hello 실제 식별자 및 회신 URL로이 값을 업데이트 합니다. 여기 있습니다 toouse hello 고유의 문자열 값 hello 식별자 및 회신 URL 것이 좋습니다. 연락처 [Datahug 클라이언트 지원 팀](http://datahug.com/about/contact-us/) tooget 이러한 값입니다. 
...
6.  확인 **"고급 인증서 서명 설정이 표시"** hello 다음 단계를 수행 합니다.
...
8. Hello에 **Datahug 구성** 섹션에서 클릭 **구성 Datahug** tooopen **sign on 구성** 창. 복사 hello **SAML 엔터티 ID** 및 **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-datahug-tutorial/tutorial_datahug_configure.png) 

9. tooconfigure single sign on에서 **Datahug** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML**, **SAML 엔터티 ID** 및 **SAML Single Sign On 서비스 URL** 너무[Datahug 지원](http://datahug.com/about/contact-us/)합니다. 이 응용 프로그램 toohave hello 양쪽 모두에 제대로 설정 하는 SAML SSO 연결을 설정 합니다.
...
tooenable Azure AD 사용자가 toolog tooDatahug에서 이러한 해야에 프로 비전 Datahug 합니다.  
Datahug의 경우 프로비전은 수동 작업입니다.

**tooprovision 사용자 계정을 hello 다음 단계를 수행 합니다.**

1. 관리자 권한으로 Datahug 회사 사이트 tooyour에 로그인 합니다.

2. Hello 위로 마우스를 가져가고 **톱니바퀴** hello 오른쪽 위 모퉁이에서 **설정**
   
   ![직원 추가](./media/active-directory-saas-datahug-tutorial/1.png)

3. 선택 **사람** hello 클릭 **사용자 추가** 탭

    ![직원 추가](./media/active-directory-saas-datahug-tutorial/2.png)

4. 원하는 hello 사람의 hello 전자 메일을 입력에 대 한 계정을 toocreate 클릭 **추가**합니다.

    ![직원 추가](./media/active-directory-saas-datahug-tutorial/3.png)

    > [!NOTE] 
    > 선택 하 여 등록 메일 toouser를 보낼 수 있습니다 **환영 전자 메일을 보낼** 확인란을 선택 합니다.  
    > 만들면 Salesforce에 대 한 계정을 hello 환영 전자 메일을 보내지 않습니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooDatahug 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooDatahug hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Datahug**합니다.
...
Hello 액세스 패널에서에서 hello Datahug 타일을 클릭할 때 자동으로 로그온 tooyour Datahug 응용 프로그램을 구해야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://msdn.microsoft.com/library/dn308586)를 참조하세요. 
