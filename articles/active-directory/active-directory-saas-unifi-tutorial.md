...
이 자습서에 설명 어떻게 toointegrate UNIFI Azure Active directory (Azure AD).

다음 이점을 hello로 제공 UNIFI Azure AD와 통합:

- 액세스 tooUNIFI을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooUNIFI (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure UNIFI와 Azure AD 통합 합니다.
...
1. UNIFI는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-unifi-from-hello-gallery"></a>UNIFI는 hello 갤러리 추가
tooconfigure hello와의 통합 UNIFI Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 UNIFI tooadd가 필요합니다.

**hello 갤러리에서 UNIFI tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow UNIFI에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 UNIFI에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

UNIFI에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 UNIFI 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[테스트 사용자 만들기는 UNIFI](#creating-a-unifi-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 UNIFI에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 UNIFI 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, UNIFI와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **UNIFI** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **UNIFI 도메인 및 Url** tooconfigure hello 응용 프로그램에 필요한 경우 섹션 **IDP** 시작 모드:

    ![Single Sign-on 구성](./media/active-directory-saas-unifi-tutorial/tutorial_unifi_url1.png)

    Hello에 **식별자** 형식 hello 값 텍스트 상자:`INVIEWlabs` 
...
4. 확인 **고급 URL 설정 표시**tooconfigure hello 응용 프로그램에 필요한 경우, **SP** 시작 모드:
    ...
    Hello에 **로그온 URL** textbox hello URL 입력:`https://app.discoverunifi.com/login`
...
7. Hello에 **UNIFI 구성** 섹션에서 클릭 **구성 UNIFI** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-unifi-tutorial/tutorial_unifi_configure.png)

8. 다른 웹 브라우저 창에서 tooyour 로그인 **UNIFI** 회사 사이트에 관리자 권한으로 합니다.

9. Hello 클릭 **사용자**합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-unifi-tutorial/app1.png) 

10. Hello 클릭 **새 Id 공급자 추가**합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-unifi-tutorial/app2.png)

11. Hello에 **Id 공급자 추가** 섹션를 hello 다음 단계를 수행 합니다.   

    ![Single Sign-on 구성](./media/active-directory-saas-unifi-tutorial/app3.png) 

    a. Hello에 **공급자 이름** hello Id 공급자의 형식 hello 이름 텍스트 상자...

    b. Hello hello에 **공급자 URL** textbox 붙여 hello **SAML Single Sign-on 서비스 URL** 값으로, Azure 포털에서 복사 합니다.

    c. 열기 hello hello 메모장에서 Azure 포털에서에서 다운로드 한 인증서 제거 hello **---BEGIN 인증서---** 및 **---END 인증서---** 태그를 복사한 후에 콘텐츠 남은 hello hello **인증서** 텍스트 상자에 붙여넣습니다.

    d. 선택 hello **기본 제공 자가** 확인란을 선택 합니다.
...
이 섹션에서는 Britta Simon이라는 사용자를 만듭니다. **UNIFI**는 자동 사용자 프로비전을 지원하므로 수동 단계가 필요하지 않습니다. 사용자가 hello Azure AD에서에서 인증을 거친 후 자동으로 만들어집니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooUNIFI 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooUNIFI hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **UNIFI**합니다.
...
Hello UNIFI hello 액세스 패널에서에서 타일을 클릭할 때 자동으로 로그온 tooyour UNIFI 응용 프로그램을 구해야 합니다.
