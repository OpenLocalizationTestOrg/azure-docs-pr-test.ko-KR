...
이 자습서에 설명 어떻게 toointegrate Dropbox for Business와 Azure Active Directory (Azure AD).

Azure AD와 Dropbox for Business 통합 hello 다음 이점을 제공 합니다.

- 비즈니스에 대 한 액세스 tooDropbox 지닌 Azure AD에서 제어할 수 있습니다.
- Azure AD 계정을 사용 하면 사용자가 tooautomatically get 로그온 tooDropbox (Single Sign-on)는 비즈니스를 사용할 수 있습니다.
...
Dropbox for Business와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Dropbox for Business hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-dropbox-for-business-from-hello-gallery"></a>Dropbox for Business hello 갤러리 추가
tooconfigure hello와의 통합 Dropbox for Business Azure AD로 tooadd Dropbox for Business에서에서 필요한 hello 갤러리 tooyour 관리 되는 SaaS 앱 목록을 합니다.

**Dropbox for Business hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **Dropbox for Business**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-dropboxforbusiness-tutorial/tutorial_dropboxforbusiness_search.png)

5. Hello 결과 패널에서 선택 **Dropbox for Business**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow Dropbox for Business에서에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Dropbox for Business의에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** Dropbox for Business에서에서.

tooconfigure 및 비즈니스에 대 한 Dropbox와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on) ** -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user) ** -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Dropbox for Business 테스트 사용자 만들기](#creating-a-dropbox-for-business-test-user) ** -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 비지니스 용 Dropbox에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user) ** -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on) ** -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 비즈니스 응용 프로그램에 대 한 Dropbox에 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 Dropbox for Business hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Dropbox for Business** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **비즈니스 도메인 및 Url에 대 한 Dropbox** 섹션를 hello 다음 단계를 수행 합니다.

    a. Dropbox for business 테 넌 tooyour 로그인 합니다. 
   
    ![Single Sign-On 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/ic769509.png "Single Sign-On 구성")
   
    b. Hello 왼쪽에 hello 탐색 창에서 클릭 **관리 콘솔**합니다. 
   
    ![Single Sign-On 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/ic769510.png "Single Sign-On 구성")
   
    c. Hello에 **관리 콘솔**, 클릭 **인증** hello 왼쪽된 탐색 창에서. 
   
    ![Single Sign-On 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/ic769511.png "Single Sign-On 구성")
   
    d. Hello에 **Single sign on** 섹션에서 **single sign-on 사용**, 클릭 하 고 **자세한** tooexpand이이 섹션.  
   
    ![Single Sign-On 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/ic769512.png "Single Sign-On 구성")
   
    e. 다음 너무 hello URL을 복사**가 전자 메일 주소를 입력 하 여 사용자가 로그인 할 수 확인 하거나 직접 이동할 수**합니다. 
    
    ![Single Sign-On 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/ic769513.png)
    
    f. Hello hello에서 Azure 포털에서 **로그온 URL** 붙여넣기 hello URL 텍스트 상자입니다.

    ![Single Sign-on 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/tutorial_dropboxforbusiness_url.png)

     Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://www.dropbox.com/sso/<id>`

    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello 실제 로그온 URL로의 Single sign-on 섹션에서 가져올 hello 값을 업데이트 합니다. 연락처 [비즈니스 클라이언트 지원 팀에 대 한 Dropbox](https://www.dropbox.com/business/contact) tooget이이 값입니다. 
...
6. Hello에 **Dropbox for Business 구성** 섹션에서 클릭 **Dropbox for Business 구성** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/tutorial_dropboxforbusiness_configure.png) 

7. tooconfigure single sign on에서 **Dropbox for Business** 쪽, Dropbox for hello에서 Business 테 넌 트에 **Single sign on** hello 섹션 **인증** 페이지 hello 다음 단계를 수행 합니다. 
   
    ![Single Sign-On 구성](./media/active-directory-saas-dropboxforbusiness-tutorial/IC769516.png "Single Sign-On 구성")
   
    a. **필수**를 클릭합니다.
   
    b. Hello hello에 Azure 포털에서에서 **sign on 구성** 창, 복사 hello **SAML Single Sign-on 서비스 URL** 값을 복사한 다음 hello에 붙여 넣을 **로그인 URL** 텍스트 상자에 붙여넣습니다.

    c. 클릭 **인증서 선택**, 한 다음 tooyour **Base64 인코딩된 인증서 파일**합니다.

    d. 클릭 **ब ा ळ** DropBox for Business 테 넌 트에 toocomplete hello 구성 합니다.
...
이 섹션에 작업 항목이 없습니다. Dropbox for Business에에서 사용자 없으면 새 tooaccess Dropbox for Business 시도할 때 만들어집니다.

>[!Note]
>Toocreate 수동으로 사용자에 게 문의 해야 할 경우 [Dropbox for Business 클라이언트 지원 팀](https://www.dropbox.com/business/contact) 

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooDropbox 비즈니스에 대 한 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign 비즈니스용 Britta Simon tooDropbox hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Dropbox for Business**합니다.
...
Hello 액세스 패널에서에서 비즈니스 타일에 대 한 hello Dropbox를 클릭 하면 비즈니스 응용 프로그램에 대 한 Dropbox의 로그인 페이지를 가져와야 합니다.
