...
이 자습서에 설명 어떻게 toointegrate StatusPage Azure Active directory (Azure AD).

다음 이점을 hello로 제공 StatusPage Azure AD와 통합:

- 액세스 tooStatusPage을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooStatusPage (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure StatusPage와 Azure AD 통합 합니다.
...
1. StatusPage는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-statuspage-from-hello-gallery"></a>StatusPage는 hello 갤러리 추가
tooconfigure hello와의 통합 StatusPage Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 StatusPage tooadd가 필요합니다.

**hello 갤러리에서 StatusPage tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow StatusPage에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 StatusPage에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

StatusPage에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 StatusPage 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[StatusPage 테스트 사용자 만들기](#creating-a-statuspage-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 StatusPage에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 StatusPage 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, StatusPage와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **StatusPage** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **StatusPage 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.
    ...
    > [!NOTE]
    > Hello StatusPage 지원 팀에 문의 [ SupportTeam@statuspage.io ](mailto:SupportTeam@statuspage.io)toorequest 메타 데이터가 필요한 tooconfigure single sign on입니다. 
    >
    >a. Hello 메타 데이터에서 hello 발급자 값을 복사 하 고 hello에 붙여 넣습니다 **식별자** 텍스트 상자에 붙여넣습니다.
    >
    >b. Hello 메타 데이터에서 hello 회신 URL을 복사한 다음 hello에 붙여 넣을 **회신 URL** 텍스트 상자에 붙여넣습니다.
...
11. Hello SSO 설치 페이지에서 다음 단계는 hello를 수행 합니다.
    ...
    a. Hello에 **SSO 대상 URL** 붙여넣기 hello 값의 텍스트 상자 **SAML Single Sign-on 서비스 URL**, Azure 포털에서 복사한입니다.

    b. 콘텐츠 복사 hello 메모장에서 다운로드 한 인증서를 열고 hello에 붙여 넣습니다 **인증서** 텍스트 상자에 붙여넣습니다. 
...
hello이이 섹션의 목적은 toocreate Britta Simon StatusPage에서 호출 하는 사용자입니다.

StatusPage는 적시에 프로비전을 지원합니다. 이미 [Azure AD Single Sign-On 구성](#configuring-azure-ad-single-sign-on)에서 사용하도록 설정했습니다.

**toocreate Britta Simon StatusPage의 라는 사용자를 만들면 hello 다음 단계를 수행 합니다.**

1. 관리자 권한으로 로그온 tooyour StatusPage 회사 사이트입니다.

2. Hello 메뉴에서 hello 위에 표시를 클릭 **계정 관리**합니다.
...
5. 형식 hello **전자 메일 주소**, **이름**, 및 **도메인 이름 얻기 이름** 유효한 사용자의 원하는 tooprovision hello를 관련 텍스트 상자입니다. 
...
이 섹션에서는 tooStatusPage 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooStatusPage hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **StatusPage**합니다.
...
Hello 액세스 패널에서에서 hello StatusPage 타일을 클릭할 때 자동으로 로그온 tooyour StatusPage 응용 프로그램을 구해야 합니다.
