...
이 자습서에 설명 어떻게 toointegrate EverBridge Azure Active directory (Azure AD).

다음 이점을 hello로 제공 EverBridge Azure AD와 통합:

- 액세스 tooEverBridge을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooEverBridge (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure EverBridge와 Azure AD 통합 합니다.
...
1. EverBridge는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-everbridge-from-hello-gallery"></a>EverBridge는 hello 갤러리 추가
tooconfigure hello와의 통합 EverBridge Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 EverBridge tooadd가 필요합니다.

**hello 갤러리에서 EverBridge tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow EverBridge에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 EverBridge에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

EverBridge에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 EverBridge 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[EverBridge 테스트 사용자 만들기](#creating-an-everbridge-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 EverBridge에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 EverBridge 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, EverBridge와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **EverBridge** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **EverBridge 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-everbridge-tutorial/tutorial_everbridge_url.png)

    a. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://sso.everbridge.net/<companyname>`

    b. Hello에 **회신 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://manager.everbridge.net/saml/SSO/<companyname>/alias/defaultAlias`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. Hello 실제 식별자 및 회신 URL로이 값을 업데이트 합니다. 연락처 [EverBridge 지원 팀](mailto:support@everbridge.com) tooget 이러한 값입니다.
...
6. Hello에 **EverBridge 구성** 섹션에서 클릭 **구성 EverBridge** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-everbridge-tutorial/tutorial_everbridge_configure.png) 

6. SSO 응용 프로그램에 대해 구성 된 tooget toosign에 tooyour Everbridge 테 넌 트 관리자 권한으로 필요 합니다.

7. Hello 메뉴에서 hello 위에 표시를 클릭 hello **설정** 탭을 선택한 **Single Sign On** 아래 **보안**합니다.
   
    ![Single Sign-on 구성](./media/active-directory-saas-everbridge-tutorial/tutorial_everbridge_002.png)
   
    a. Hello에 **이름** 식별자 공급자의 형식 hello 이름 텍스트 상자 (예: 회사 이름을).
   
    b. Hello에 **API 이름** API의 형식 hello 이름 텍스트 상자입니다.
   
    c. 클릭 **파일 선택** 단추 tooupload hello 메타 데이터 파일을 Azure 포털에서 다운로드 합니다.
   
    d. SAML Id 위치 hello 선택 **hello hello Subject 문의 NameIdentifier 요소에 Id가**합니다.
   
    e. Hello에 **Id 공급자 로그인 URL** textbox, Azure AD에서 SAML SSO URL 붙여넣기 hello 값입니다.
   
    ![Single Sign-on 구성](./media/active-directory-saas-everbridge-tutorial/tutorial_everbridge_003.png)
   
    f. 서비스 공급자가 시작한 요청 바인딩 hello, 선택 **HTTP 리디렉션**합니다.
...
이 섹션에서는 Everbridge에서 Britta Simon이라는 사용자를 만듭니다. 작업할 [EverBridge 지원 팀](mailto:support@everbridge.com) hello Everbridge 플랫폼의 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooEverBridge 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooEverBridge hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **EverBridge**합니다.
...
Hello 액세스 패널에서에서 hello Everbridge 타일을 클릭할 때 자동으로 로그온 tooyour Everbridge 응용 프로그램을 구해야 합니다.
