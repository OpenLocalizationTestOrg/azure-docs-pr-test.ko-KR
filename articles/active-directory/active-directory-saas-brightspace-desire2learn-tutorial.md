...
이 자습서에 설명 어떻게 toointegrate Brightspace by Desire2Learn Azure Active directory (Azure AD).

Azure AD와 Brightspace by Desire2Learn 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooBrightspace by Desire2Learn 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooBrightspace by Desire2Learn에 사용 하도록 설정할 수 있습니다 (Single Sign-on)는 Azure AD 계정을 사용
...
Brightspace by Desire2Learn와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Brightspace by Desire2Learn hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-brightspace-by-desire2learn-from-hello-gallery"></a>Brightspace by Desire2Learn hello 갤러리 추가
tooconfigure hello와의 통합 Brightspace by Desire2Learn Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Brightspace by Desire2Learn tooadd가 필요합니다.

**Brightspace by Desire2Learn hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **Brightspace by Desire2Learn**합니다.
...
5. Hello 결과 패널에서 선택 **Brightspace by Desire2Learn**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow Brightspace by Desire2Learn에에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Brightspace by Desire2Learn에에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Brightspace by Desire2Learn에에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 Brightspace by Desire2Learn 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Brightspace by Desire2Learn 테스트 사용자 만들기](#creating-a-brightspace-by-desire2learn-test-user)**  -toohave Britta Simon Brightspace by Desire2Learn 표현인 연결 된 toohello Azure AD의 사용자에에서 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Desire2Learn 응용 프로그램에 의해 Brightspace에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 Brightspace by Desire2Learn hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Brightspace by Desire2Learn** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Brightspace by Desire2Learn 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.
    ...
    b. Hello에 **회신 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<companyname>.desire2learn.com/d2l/lp/auth/login/samlLogin.d2l`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. Hello 실제 식별자 및 회신 URL로이 값을 업데이트 합니다. 연락처 [Brightspace by Desire2Learn 지원 팀](https://www.d2l.com/contact/) tooget 이러한 값입니다.
...
6. tooconfigure single sign on에서 **Brightspace by Desire2Learn** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 너무[Brightspace by Desire2Learn 지원 팀](https://www.d2l.com/contact/)합니다.
...
순서 tooenable Azure AD 사용자가 Brightspace by Desire2Learn에 toolog에서 이러한 해야에 프로 비전 Brightspace by Desire2Learn 합니다.  

Brightspace by Desire2Learn의 경우 hello hello 사용자 계정을 만들어야 하 여 만든 toobe 프로그램 [Brightspace by Desire2Learn 지원 팀](https://www.d2l.com/contact/)합니다.

>[!NOTE]
>다양 한 Brightspace Desire2Learn 사용자 계정 만들기 도구에서 사용할 수 있습니다 또는 Api에서 제공 Brightspace Desire2Learn tooprovision Azure Active Directory에서 사용자 계정. 

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 by Desire2Learn tooBrightspace 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign by Desire2Learn Britta Simon tooBrightspace hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Brightspace by Desire2Learn**합니다.
...
Hello Brightspace Desire2Learn 타일 hello 액세스 패널에에서 의해을 클릭할 때 자동으로 로그온 tooyour Brightspace Desire2Learn 응용 프로그램에서 가져와야 합니다.
