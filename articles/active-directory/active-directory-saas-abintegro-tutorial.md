...
이 자습서에 설명 어떻게 toointegrate Azure Active Directory (Azure AD)와 Abintegro 합니다.

Azure AD와 Abintegro 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooAbintegro을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooAbintegro (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Abintegro와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Abintegro는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-abintegro-from-hello-gallery"></a>Abintegro는 hello 갤러리 추가
tooconfigure hello와의 통합 Abintegro Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Abintegro tooadd가 필요합니다.

**Abintegro hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Abintegro에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Abintegro에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Hello hello 값을 할당, Abintegro에 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 Abintegro 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Abintegro 테스트 사용자 만들기](#creating-an-abintegro-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Abintegro에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Abintegro 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 Abintegro를 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Abintegro** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Abintegro 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_url.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://dev.abintegro.com/Shibboleth.sso/Login?entityID=<Issuer>&target=https://dev.abintegro.com/secure/`

    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello로이 값을 업데이트 합니다. 실제 로그온 URL입니다. 연락처 [클라이언트 Abintegro 지원 팀](mailto:support@abintegro.com) tooget이이 값입니다. 
...
6. tooconfigure single sign on에서 **Abintegro** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 너무[Abintegro 지원 팀](mailto:support@abintegro.com)합니다. 이 설정은 toohave hello 양쪽 모두에 제대로 설정 하는 SAML SSO 연결 설정 합니다.
...
사용자에 대 한 있습니다 tooconfigure tooAbintegro 프로 비전 작업 항목이 없습니다. Toolog hello 액세스 패널을 사용 하 여 Abintegro에 시도 하는 할당된 된 사용자, Abintegro hello 사용자의 존재 여부를 확인 합니다.
  
사용할 수 있는 사용자 계정이 없으면 자동으로 Abintegro에 의해 생성됩니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooAbintegro 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooAbintegro hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Abintegro**합니다.
...
Hello 액세스 패널에서에서 hello Abintegro 타일을 클릭할 때 Abintegro 응용 프로그램의 로그인 페이지를 가져와야 합니다.
