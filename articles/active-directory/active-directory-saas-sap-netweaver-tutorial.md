...
이 자습서에 알아봅니다 방법을 toointegrate SAP NetWeaver Azure Active Directory (Azure AD)와 합니다.

SAP NetWeaver Azure AD와 통합 hello 다음 이점을 제공 합니다.

- 액세스 tooSAP NetWeaver 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooSAP NetWeaver (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
SAP NetWeaver와의 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. SAP NetWeaver hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-sap-netweaver-from-hello-gallery"></a>SAP NetWeaver hello 갤러리 추가
tooconfigure hello와의 통합 SAP NetWeaver Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서의 SAP NetWeaver tooadd가 필요합니다.

**hello 갤러리에서 SAP NetWeaver tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **SAP NetWeaver**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sap-netweaver-tutorial/tutorial_sapnetweaver_search.png)

5. Hello 결과 패널에서 선택 **SAP NetWeaver**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow SAP NetWeaver에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 SAP netweaver에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** SAP netweaver에서 합니다.

tooconfigure 및 SAP NetWeaver와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[SAP NetWeaver 테스트 사용자 만들기](#creating-an-sap-netweaver-test-user)**  -toohave 표현인 연결 된 toohello Azure AD 사용자의 SAP netweaver Britta Simon의 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 SAP NetWeaver 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on SAP NetWeaver와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **SAP NetWeaver** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **SAP NetWeaver 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-sap-netweaver-tutorial/tutorial_sapnetweaver_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<your company instance of SAP NetWeaver>`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<your company instance of SAP NetWeaver>`

    c. Hello에 **회신 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<your company instance of SAP NetWeaver>/sap/saml2/sp/acs/100`
     
    > [!NOTE] 
    > 이러한 값은 실제 hello 되지 않습니다. 이러한 항목을 업데이트 실제 hello로 값 식별자 및 회신 URL 및 로그온 URL입니다. 여기 있습니다 toouse hello의 고유 값을 hello 식별자의에서 문자열을 사용 하는 것이 좋습니다. 연락처 [SAP NetWeaver 클라이언트 지원 팀](https://www.sap.com/support.html) tooget 이러한 값입니다. 
...
6. Hello에 **SAP NetWeaver 구성** 섹션에서 클릭 **구성의 SAP NetWeaver** tooopen **sign on 구성** 창. 복사 hello **SAML 엔터티 ID** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-sap-netweaver-tutorial/tutorial_sapnetweaver_configure.png) 

7. tooconfigure single sign on에서 **SAP NetWeaver** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 및 **SAML 엔터티 ID** 너무[SAP NetWeaver 지원 ](https://www.sap.com/support.html). 
...
이 섹션에서는 SAP NetWeaver에서 Britta Simon이라는 사용자를 만듭니다. 작업할 프로그램 [SAP NetWeaver 지원](https://www.sap.com/support.html) hello SAP NetWeaver 플랫폼의 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooSAP NetWeaver 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooSAP NetWeaver hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **SAP NetWeaver**합니다.
...
Hello 액세스 패널에서에서 hello SAP NetWeaver 타일을 클릭할 때 자동으로 로그온 tooyour SAP NetWeaver 응용 프로그램을 구해야 합니다.
