...
이 자습서에 설명 어떻게 toointegrate BG 온라인 Azure Active directory (Azure AD).

다음 이점을 hello로 제공 BG 온라인 Azure AD와 통합:

- 온라인 액세스 tooBGS을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooBGS 온라인 (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
BG 온라인와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. BG 온라인 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-bgs-online-from-hello-gallery"></a>BG 온라인 hello 갤러리 추가
tooconfigure hello와의 통합 BG 온라인 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 BG 온라인 tooadd가 필요합니다.

**BG 온라인 hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow BG 온라인에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 hello BG 온라인의 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

BG 온라인에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 BG 온라인를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[BG 온라인 테스트 사용자 만들기](#creating-a-bgs-online-test-user)**  -toohave Britta Simon BG 온라인 표현인 연결 된 toohello Azure AD의 사용자에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 BG 온라인 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on BG Online과 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **BG 온라인** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **BG 온라인 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.
    ...
    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. Hello 실제 식별자 및 회신 URL로이 값을 업데이트 합니다. 연락처 [BG 온라인 지원 팀](mailTo:bgsdashboardteam@millwardbrown.com) tooget 이러한 값입니다.
...
6. Hello에 **BG 온라인 구성** 섹션에서 클릭 **BG 온라인 구성** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_configure.png) 

7. tooconfigure single sign on에서 **BG 온라인** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 및 **SAML Single Sign-on 서비스 URL** 너무[BG 온라인 지원 팀](mailto:bgsdashboardteam@millwardbrown.com)합니다. 
...
이 섹션에서는 BGS Online에서 Britta Simon이라는 사용자를 만듭니다. 작업할 [BG 온라인 지원 팀](mailto:bgsdashboardteam@millwardbrown.com) hello BG 온라인 플랫폼의 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooBGS 온라인 권한을 부여 하 여 Britta Simon toouse Azure single sign on을 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooBGS 온라인으로 hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **BG 온라인**합니다.
...
Hello 액세스 패널에서에서 hello BG 온라인 타일을 클릭할 때 자동으로 로그온 tooyour BG 온라인 응용 프로그램을 구해야 합니다.
