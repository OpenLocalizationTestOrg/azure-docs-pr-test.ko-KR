...
이 자습서에 설명 어떻게 toointegrate Yardi eLearning Azure Active directory (Azure AD).

Azure AD와 eLearning는 Yardi 통합 이점을 다음 hello로 있습니다 제공:

- 액세스 tooYardi eLearning을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooYardi eLearning (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure Yardi eLearning와 Azure AD 통합 합니다.
...
1. Yardi eLearning hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-yardi-elearning-from-hello-gallery"></a>Yardi eLearning hello 갤러리 추가
tooconfigure hello와의 통합 Yardi eLearning Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd Yardi eLearning 필요합니다.

**hello 갤러리에서 tooadd Yardi eLearning hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **Yardi eLearning**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-yardielearning-tutorial/tutorial_yardielearning_search.png)

5. Hello 결과 패널에서 선택 **Yardi eLearning**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow Yardi eLearning에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 Yardi eLearning에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Yardi eLearning에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 Yardi eLearning 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Yardi eLearning 테스트 사용자 만들기](#creating-a-yardi-elearning-test-user)**  -toohave에서 사용자의 연결 된 Azure AD toohello 표현인 Yardi eLearning Britta Simon 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Yardi eLearning 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on Yardi eLearning와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Yardi eLearning** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Yardi eLearning 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-yardielearning-tutorial/tutorial_yardielearning_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<companyname>.yardielearning.com/login`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<companyname>.yardielearning.com/trust`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [Yardi eLearning 클라이언트 지원 팀](mailto:elearning@yardi.com) tooget 이러한 값입니다. 
...
8. tooconfigure single sign on에서 **Yardi eLearning** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 너무[Yardi eLearning 지원 팀](mailto:elearning@yardi.com)합니다. 
...
hello이이 섹션의 목적은 toocreate Britta Simon Yardi eLearning에서 호출 하는 사용자입니다. Yardi eLearning은 Just-In-Time 프로비전을 지원하며 기본적으로 사용하도록 설정합니다.

이 섹션에 작업 항목이 없습니다. 새 사용자는 아직 존재 하지 않는 경우 시도 tooaccess Yardi eLearning 중 생성 됩니다. 

>[!NOTE]
>Toocontact hello toocreate 사용자를 수동으로 필요한 경우 필요한 [Yardi eLearning 지원 팀](mailto:elearning@yardi.com)합니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooYardi eLearning 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooYardi eLearning hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Yardi eLearning**합니다.
...
Hello 액세스 패널에서에서 hello Yardi eLearning 타일을 클릭할 때 자동으로 로그온 tooyour Yardi eLearning 응용 프로그램을 구해야 합니다. 
