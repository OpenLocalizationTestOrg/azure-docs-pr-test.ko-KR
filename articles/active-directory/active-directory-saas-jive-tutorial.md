...
이 자습서에 설명 어떻게 toointegrate Jive와 Azure Active Directory (Azure AD).

Azure AD와 Jive를 통합 hello 다음 이점을 제공 합니다.

- 액세스 tooJive을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooJive (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Jive와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Jive는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-jive-from-hello-gallery"></a>Jive는 hello 갤러리 추가
tooconfigure hello와의 통합 Jive Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Jive tooadd가 필요합니다.

**hello 갤러리에서 Jive tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Jive에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Jive의 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** Jive에 합니다.

tooconfigure 및 Jive와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Jive 테스트 사용자 만들기](#creating-a-jive-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Jive에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Jive 응용 프로그램에서 single sign on 구성 합니다.

**와 Jive Azure AD에서 single sign-on tooconfigure hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Jive** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Jive 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-jive-tutorial/tutorial_jive_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<instance name>.jivecustom.com`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<instance name>.jiveon.com`

    > [!NOTE] 
    > 이러한 값은 실제 hello 되지 않습니다. Hello 실제 로그온 URL과 식별자와 이러한 값을 업데이트 합니다. 연락처 [Jive 클라이언트 지원 팀](https://www.jivesoftware.com/services-support/) tooget 이러한 값입니다. 
...
6. tooconfigure single sign on에서 **Jive** 쪽, 로그온 tooyour Jive 테 넌 트 관리자 권한으로 합니다.

7. Hello 위에 hello 메뉴에서 "**Saml**."

    ![앱 쪽에서 Single Sign-On 구성](./media/active-directory-saas-jive-tutorial/tutorial_jive_002.png)

    a. 선택 **Enabled** hello에서 **일반** 탭 합니다.   
    b. Hello 클릭 "**모든 saml 설정을**" 단추입니다.

8. Toohello 이동 "**Idp 메타 데이터**" 탭 합니다.
   
    ![앱 쪽에서 Single Sign-On 구성](./media/active-directory-saas-jive-tutorial/tutorial_jive_003.png)
   
    a. Hello 다운로드 한 메타 데이터 XML 파일의 hello 콘텐츠를 복사 하 고 hello에 붙여 넣습니다 **Identity 공급자 (IDP) 메타 데이터** 텍스트 상자에 붙여넣습니다.
    
    b. Hello 클릭 "**모든 saml 설정을**" 단추입니다. 

9. Toohello 이동 "**사용자 특성 매핑**" 탭 합니다.
   
    ![앱 쪽에서 Single Sign-On 구성](./media/active-directory-saas-jive-tutorial/tutorial_jive_004.png)
   
    a. Hello에 **전자 메일** 의 텍스트 상자, 복사 및 붙여넣기 hello 특성 이름을 **메일** 값입니다.
   
    b. Hello에 **이름** 의 텍스트 상자, 복사 및 붙여넣기 hello 특성 이름을 **givenname** 값입니다.
   
    c. Hello에 **성** 의 텍스트 상자, 복사 및 붙여넣기 hello 특성 이름을 **surname** 값입니다.
...
작업할 [Jive 클라이언트 지원 팀](https://www.jivesoftware.com/services-support/) hello Jive 플랫폼의 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooJive 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooJive hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Jive**합니다.
...
Hello 액세스 패널에서에서 hello Jive 타일을 클릭할 때 자동으로 로그온 tooyour Jive 응용 프로그램을 구해야 합니다.
