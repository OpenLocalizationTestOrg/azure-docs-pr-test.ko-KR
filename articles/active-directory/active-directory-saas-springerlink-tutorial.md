...
이 자습서에 설명 toointegrate Springer Azure Active Directory (Azure AD)에 연결 하는 방법입니다.

다음 이점을 hello로 제공 Springer 링크 Azure AD와 통합:

- Azure ad 액세스 tooSpringer 링크를 가진 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooSpringer 링크 (Single Sign-on)는 Azure AD 계정으로 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure Springer 링크와 Azure AD 통합 합니다.
...
1. Hello 갤러리에서 Springer 링크 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-springer-link-from-hello-gallery"></a>Hello 갤러리에서 Springer 링크 추가
tooconfigure hello와의 통합 Springer 링크 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd Springer 링크 해야합니다.

**hello 갤러리에서 Springer 링크 tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **Springer 링크**선택, **Springer 링크** 결과 패널에서 클릭 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow Springer 링크에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 Springer 링크에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Springer 링크에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 Springer 링크를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.
...
3. **[Azure AD hello 테스트 사용자를 할당](#assign-the-azure-ad-test-user) ** -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
4. **[Single sign on 테스트](#test-single-sign-on) ** -tooverify 구성 works를 hello 여부.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Springer 링크 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on Springer 링크와 함께 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Springer 링크** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Springer 링크 도메인 및 Url** tooconfigure hello 응용 프로그램에 필요한 경우 섹션 **IDP** 시작 모드:
    ...
    a. Hello에 **식별자** textbox hello URL 입력:`https://fsso.springer.com`

    b. Hello에 **회신 URL** textbox hello URL 입력:`https://fsso-qa1.springer.com/federation/Consumer/metaAlias/SpringerServiceProvider`    
...
4. **고급 URL 설정 표시**를 선택합니다. Tooconfigure hello 응용 프로그램에 필요한 경우 **SP** 시작 모드:
    ...
    Hello에 **로그온 URL** textbox hello URL 입력:`https://fsso.springer.com/federation/Consumer/metaAlias/SpringerServiceProvider`    
...
6. toogenerate hello **메타 데이터** url hello 다음 단계를 수행 합니다.
    ...
    d. 이제의 toohello 속성 페이지를 이동 **Springer 링크** 및 복사 hello **응용 프로그램 Id** 를 사용 하 여 **복사** 단추를 메모장에 붙여 넣습니다.
...
7. tooconfigure single sign on에서 **Springer 링크** toosend hello 생성 해야 쪽에서는 **메타 데이터 URL** 너무[Springer 링크 지원 팀](mailto:identity@springernature.com)합니다.
...
이 섹션에서는 액세스 tooSpringer 링크를 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![Hello 사용자 역할 할당][200] 

**tooassign Britta Simon tooSpringer 링크를 hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Springer 링크**합니다.
...
Hello 액세스 패널에서에서 hello Springer 링크 타일을 클릭할 때 자동으로 로그온 tooyour Springer 링크 응용 프로그램을 구해야 합니다.
