...
---
# <a name="problems-signing-in-tooan-azure-ad-gallery-application-configured-for-federated-single-sign-on"></a>Tooan 페더레이션된 single sign-on에 대해 구성 된 Azure AD 갤러리 응용 프로그램에에서 로그인 하는 문제
...
-   [Hello Azure AD 갤러리에서 응용 프로그램 추가](#_Add_an_application)
...
9.  [Toohello 응용 프로그램 사용자를 할당](#_How_to_assign)합니다.
...
## <a name="if-these-troubleshoot-steps-dont-resolve-hello-issue"></a>단계는 hello 문제가 해결 되지 않으면 이러한 문제를 해결 하는 경우 
