...
이 자습서에 설명 어떻게 toointegrate Trakopolis Azure Active directory (Azure AD).

다음 이점을 hello로 제공 Trakopolis Azure AD와 통합:

- 액세스 tooTrakopolis을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooTrakopolis (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure Trakopolis와 Azure AD 통합 합니다.
...
1. Trakopolis는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-trakopolis-from-hello-gallery"></a>Trakopolis는 hello 갤러리 추가
tooconfigure hello와의 통합 Trakopolis Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Trakopolis tooadd가 필요합니다.

**hello 갤러리에서 Trakopolis tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Trakopolis에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 Trakopolis에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Trakopolis에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 Trakopolis 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Trakopolis 테스트 사용자 만들기](#creating-a-trakopolis-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Trakopolis에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Trakopolis 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, Trakopolis와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Trakopolis** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Trakopolis 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-trakopolis-tutorial/tutorial_trakopolis_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company name>.trakopolis.com/`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company name>.trakopolis.com`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [Trakopolis 클라이언트 지원 팀](mailto:support@cantelematics.com) tooget 이러한 값입니다. 
...
6. Hello에 **Trakopolis 구성** 섹션에서 클릭 **구성 Trakopolis** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL, SAML 엔터티 ID, 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-trakopolis-tutorial/tutorial_trakopolis_configure.png) 

7. tooconfigure single sign on에서 **Trakopolis** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML, 로그 아웃 URL, SAML 엔터티 ID, 및 SAML Single Sign-on 서비스 URL** 너무[Trakopolis 지원 팀](mailto:support@cantelematics.com)합니다. 이 설정은 toohave hello 양쪽 모두에 제대로 설정 하는 SAML SSO 연결 설정 합니다.
...
이 섹션에서는 Trakopolis에서 Britta Simon이라는 사용자를 만듭니다. 작업할 [Trakopolis 지원 팀](mailto:support@cantelematics.com) hello 사용자 hello Trakopolis 플랫폼을 추가할 수 있습니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooTrakopolis 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooTrakopolis hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Trakopolis**합니다.
...
Hello Trakopolis hello 액세스 패널에서에서 타일을 클릭할 때 자동으로 로그온 tooyour Trakopolis 응용 프로그램을 구해야 합니다.
