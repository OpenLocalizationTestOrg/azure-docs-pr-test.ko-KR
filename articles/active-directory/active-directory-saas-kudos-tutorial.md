...
이 자습서에 설명 어떻게 toointegrate Azure Active Directory (Azure AD)와 Kudos 합니다.

Azure AD와 Kudos 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooKudos을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooKudos (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Kudos와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Kudos는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-kudos-from-hello-gallery"></a>Kudos는 hello 갤러리 추가
tooconfigure hello와의 통합 Kudos Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Kudos tooadd가 필요합니다.

**hello 갤러리에서 Kudos tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Kudos에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Kudos에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Kudos에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 Kudos 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Kudos 테스트 사용자 만들기](#creating-a-kudos-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Kudos에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Kudos 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 Kudos를 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Kudos** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Kudos 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-kudos-tutorial/tutorial_kudos_url.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company>.kudosnow.com`
    
    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello로이 값을 업데이트 합니다. 실제 로그온 URL입니다. 연락처 [Kudos 클라이언트 지원 팀](http://success.kudosnow.com/home) tooget이이 값입니다. 
...
6. Hello에 **Kudos 구성** 섹션에서 클릭 **구성 Kudos** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**
...
10. Hello에 **SSO** 섹션를 hello 다음 단계를 수행 합니다.
   
    ![SSO](./media/active-directory-saas-kudos-tutorial/ic787807.png "SSO")
   
    a. **로그온 URL** 붙여넣기 hello 값의 텍스트 상자 **SAML Single Sign-on 서비스 URL** Azure 포털에서 복사한입니다. 

    b. 콘텐츠를 클립보드에 복사 hello 메모장에서 e-64로 인코딩된 인증서를 열고 toohello 붙여 **X.509 인증서** textbox
   
    c. **로그 아웃 tooURL**, hello 값을 붙여 **Sign-Out URL** Azure 포털에서 복사한입니다.
   
    d. Hello에 **Kudos URL** 텍스트 상자에 회사 이름을 입력 합니다.
...
Tooenable Azure AD 사용자가 toolog Kudos에 주문 하 고에서 Kudos에 이들 프로 비전 해야 합니다. 

Hello Kudos의 경우에서 프로 비전은 수동 작업입니다.

**tooprovision 사용자 계정을 hello 다음 단계를 수행 합니다.**

1. Tooyour 로그인 **Kudos** 회사 사이트에서 관리자 권한으로 로그인 합니다.

2. Hello 메뉴에서 hello 위에 표시를 클릭 **설정을**합니다.
   
   ![설정](./media/active-directory-saas-kudos-tutorial/ic787806.png "설정")

3. **사용자 관리**를 클릭합니다.

4. Hello 클릭 **사용자** 탭을 클릭 한 다음 **사용자 추가**합니다.
   
   ![사용자 관리](./media/active-directory-saas-kudos-tutorial/ic787809.png "사용자 관리")

5. Hello에 **사용자 추가** 섹션를 hello 다음 단계를 수행 합니다.
   
    ![사용자 추가](./media/active-directory-saas-kudos-tutorial/ic787810.png "사용자 추가")
   
    a. 형식 hello **이름**, **성**, **전자 메일** 및 기타 세부 정보 tooprovision hello에 하려는 유효한 Azure Active Directory 계정의 관련 텍스트 상자입니다.
   
    b. **사용자 만들기**를 클릭합니다.

>[!NOTE]
>다른 Kudos 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 AAD 사용자 계정을 tooprovision Kudos에서 제공 된 Api입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooKudos 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooKudos hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Kudos**합니다.
...
Hello 액세스 패널에서에서 hello Kudos 타일을 클릭할 때 자동으로 로그온 tooyour Kudos 응용 프로그램을 구해야 합니다. 액세스 패널 hello에 대 한 자세한 내용은 참조 [액세스 패널 소개 toohello](active-directory-saas-access-panel-introduction.md)합니다.
