...
이 자습서에 설명 어떻게 toointegrate 123ContactForm Azure Active directory (Azure AD).

다음 이점을 hello로 제공 123ContactForm Azure AD와 통합:

- 액세스 too123ContactForm을 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 too123ContactForm 사용 하도록 설정할 수 있습니다 (Single Sign-on)는 Azure AD 계정을 사용
...
다음 항목 hello가 필요 tooconfigure 123ContactForm와 Azure AD 통합 합니다.
...
1. 123ContactForm hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-123contactform-from-hello-gallery"></a>123ContactForm hello 갤러리 추가
tooconfigure hello와의 통합 123ContactForm Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd 123ContactForm 필요합니다.

**hello 갤러리에서 tooadd 123ContactForm hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow 123ContactForm에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 123ContactForm에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

123ContactForm에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 123ContactForm 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[123ContactForm 테스트 사용자 만들기](#creating-a-123contactform-test-user)**  -toohave에서 사용자의 연결 된 Azure AD toohello 표현인 123ContactForm Britta Simon 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 123ContactForm 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, 123ContactForm와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **123ContactForm** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **123ContactForm 도메인 및 Url** 섹션 tooconfigure hello 응용 프로그램에 필요한 경우 **IDP 시작 모드**, hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-123contactform-tutorial/url1.png)

    a. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://www.123contactform.com/saml/azure_ad/<tenant_id>/metadata`

    b. Hello에 **회신 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://www.123contactform.com/saml/azure_ad/<tenant_id>/acs`

4. Tooconfigure hello 응용 프로그램에 필요한 경우 **SP 시작 모드**, hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-123contactform-tutorial/url2.png)

    a. Hello 클릭 **고급 URL 설정 표시** 옵션

    b. Hello에 **로그온 URL** 텍스트 상자에 다음 URL로:`https://www.123contactform.com/saml/azure_ad/<tenant_id>/sso`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. Tooupdate 실제 Url과 식별자 hello 자습서의 뒷부분에 설명 된이 값이 필요 합니다.
...
7. tooconfigure single sign on에서 **123ContactForm** 쪽, 너무 이동[https://www.123contactform.com/form-2709121/](https://www.123contactform.com/form-2709121/) hello 다음 단계를 수행:

    ![Single Sign-on 구성](./media/active-directory-saas-123contactform-tutorial/submit.png) 

    a. Hello에 **전자 메일** hello 사용자 즉,의 형식 hello 전자 메일 텍스트 상자 **BrittaSimon@Contoso.com**.

    b. 클릭 **업로드** hello Azure 포털에서 다운로드 한 메타 데이터 XML 파일을 찾습니다.

    c. **양식 제출**을 클릭합니다.

8. Hello에 **Microsoft Azure AD에서 Single sign on-응용 프로그램 설정 구성** hello 다음 단계를 수행 합니다.
    
    ![Single Sign-on 구성](./media/active-directory-saas-123contactform-tutorial/url3.png)

    a. Tooconfigure hello 응용 프로그램에 필요한 경우 **IDP 시작 모드**, 복사 hello **식별자** 인스턴스에 대 한 값을 붙여 넣습니다 **식별자** 텍스트상자로**123ContactForm 도메인 및 Url** Azure 포털에서 섹션.
    
    b. Tooconfigure hello 응용 프로그램에 필요한 경우 **IDP 시작 모드**, 복사 hello **회신 URL** 인스턴스에 대 한 값을 붙여 넣습니다 **회신 URL** 텍스트상자로**123ContactForm 도메인 및 Url** Azure 포털에서 섹션.

    c. Tooconfigure hello 응용 프로그램에 필요한 경우 **SP 시작 모드**, 복사 hello **SIGN ON URL** 인스턴스에 대 한 값을 붙여 넣습니다 **로그온 URL** 텍스트상자로**123ContactForm 도메인 및 Url** Azure 포털에서 섹션.
...
이 섹션에서는 too123ContactForm 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon too123ContactForm hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **123ContactForm**합니다.
...
Hello 액세스 패널에서에서 hello 123ContactForm 타일을 클릭할 때 자동으로 로그온 tooyour 123ContactForm 응용 프로그램을 구해야 합니다.
