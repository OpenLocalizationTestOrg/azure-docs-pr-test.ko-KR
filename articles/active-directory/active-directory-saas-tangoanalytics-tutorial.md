...
이 자습서에 설명 어떻게 toointegrate Azure Active Directory (Azure AD)와 탱고 분석 합니다.

다음 이점을 hello로 제공 탱고 분석 Azure AD와 통합:

- 액세스 tooTango 분석을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooTango (Single Sign-on) 분석으로는 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure 탱고 분석와 Azure AD 통합 합니다.
...
1. 탱고 분석 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-tango-analytics-from-hello-gallery"></a>탱고 분석 hello 갤러리 추가
tooconfigure hello와의 통합 탱고 분석 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd 탱고 분석 해야합니다.

**hello 갤러리에서 탱고 분석 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow 탱고 분석에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 hello 탱고 분석의 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

탱고 분석에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 탱고 분석을 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[탱고 분석 테스트 사용자 만들기](#creating-a-tango-analytics-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 탱고 분석에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 탱고 분석 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on 탱고 분석을 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **탱고 분석** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **탱고 분석 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_tangoanalytics_url.png)

    a. Hello에 **식별자** 형식 hello 값 텍스트 상자`TACORE_SSO`

    b. Hello에 **회신 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://mts.tangoanalytics.com/saml2/sp/acs/post`

    > [!NOTE] 
    > 회신 URL 값 에서만 hello 실제있지 않습니다. Hello 실제 회신 URL로이 업데이트 합니다. 연락처 [탱고 분석 지원 팀](mailto:support@tangoanalytics.com) tooget이이 값입니다.
...
6. tooconfigure single sign on에서 **탱고 분석** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 너무[탱고 분석 지원 팀](mailto:support@tangoanalytics.com)합니다. 이 설정은 toohave hello 양쪽 모두에 제대로 설정 하는 SAML SSO 연결 설정 합니다.
...
이 섹션에서는 Tango Analytics에서 Britta Simon이라는 사용자를 만듭니다. 작업할 [탱고 분석 지원 팀](mailto:support@tangoanalytics.com) hello 사용자 hello 탱고 분석 플랫폼을 추가할 수 있습니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooTango 분석을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooTango 분석, hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **탱고 분석**합니다.
...
Hello 탱고 분석 hello 액세스 패널에서에서 타일을 클릭할 때 자동으로 로그온 tooyour 탱고 분석 응용 프로그램을 구해야 합니다.
