...
이 자습서에 설명 어떻게 toointegrate Azure Active Directory (Azure AD)와 Sugar CRM 합니다.

Sugar CRM Azure AD와 통합 hello 다음 이점을 제공 합니다.

- 액세스 tooSugar CRM을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooSugar CRM (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Sugar CRM와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Sugar CRM hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-sugar-crm-from-hello-gallery"></a>Sugar CRM hello 갤러리 추가
tooconfigure hello와의 통합 Sugar CRM Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Sugar CRM tooadd가 필요합니다.

**Sugar CRM hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **Sugar CRM**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sugarcrm-tutorial/tutorial_sugarcrm_search.png)

5. Hello 결과 패널에서 선택 **Sugar CRM**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow Sugar CRM에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Sugar CRM에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Sugar CRM에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 Sugar CRM를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Sugar CRM 테스트 사용자 만들기](#creating-a-sugar-crm-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Sugar CRM에서 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Sugar CRM 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on Sugar CRM과 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Sugar CRM** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Sugar CRM 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-sugarcrm-tutorial/tutorial_sugarcrm_url.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:
    | |
    |--|
    ...
    > [!NOTE] 
    > hello 값이 실제 아닙니다. 업데이트 hello 값과 실제 로그온 URL hello 합니다. 연락처 [Sugar CRM 클라이언트 지원 팀](https://support.sugarcrm.com/) tooget hello 값입니다. 
...
6. Hello에 **Sugar CRM 구성** 섹션에서 클릭 **구성 Sugar CRM** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-sugarcrm-tutorial/tutorial_sugarcrm_configure.png) 

7. 다른 웹 브라우저 창에서 관리자 권한으로 tooyour Sugar CRM 회사 사이트에 로그인 합니다.

8. 너무 이동**Admin**합니다.
   
    ![관리자](./media/active-directory-saas-sugarcrm-tutorial/ic795888.png "관리자")

9. Hello에 **관리** 섹션에서 클릭 **암호 관리**합니다.
...
11. Hello에 **SAML 인증** 섹션를 hello 다음 단계를 수행 합니다.
    ...
    b. Hello에 **SLO URL** 붙여넣기 hello 값의 텍스트 상자 **Sign-Out URL**, Azure 포털에서 복사한입니다.
  
    c. E-64로 인코딩된 인증서 내용을 클립보드의 콘텐츠 복사 hello 메모장에서 열고 후 전체 인증서를 hello **X.509 인증서** 텍스트 상자에 붙여넣습니다.
...
Tooenable Azure AD 사용자가 toolog tooSugar CRM에에서 주문 하 고에 프로 비전 된 tooSugar CRM 되어야 합니다.

Hello Sugar CRM의 경우에서 프로 비전은 수동 작업입니다.

**tooprovision 사용자 계정을 hello 다음 단계를 수행 합니다.**

1. Tooyour 로그인 **Sugar CRM** 회사 사이트에서 관리자 권한으로 로그인 합니다.

2. 너무 이동**Admin**합니다.
   
    ![관리자](./media/active-directory-saas-sugarcrm-tutorial/ic795888.png "관리자")

3. Hello에 **관리** 섹션에서 클릭 **사용자 관리**합니다.
   
    ![관리](./media/active-directory-saas-sugarcrm-tutorial/ic795893.png "관리")

4. 너무 이동**사용자 \> 새 사용자 만들기**합니다.
   
    ![새 사용자 만들기](./media/active-directory-saas-sugarcrm-tutorial/ic795894.png "새 사용자 만들기")

5. Hello에 **사용자 프로필** 탭 hello 다음 단계를 수행 하십시오.
   
    ![새 사용자](./media/active-directory-saas-sugarcrm-tutorial/ic795895.png "새 사용자")

    a. 형식 hello **사용자 이름**, **성**, 및 **전자 메일 주소** hello에 유효한 Azure Active Directory 사용자의 관련 텍스트 상자입니다.
  
6. **상태**는 **활성**을 선택합니다.

7. Hello 암호 탭에서 단계를 수행 하는 hello를 수행 합니다.
   
    ![새 사용자](./media/active-directory-saas-sugarcrm-tutorial/ic795896.png "새 사용자")

    a. Hello에 대 한 형식 hello 암호를 관련 텍스트 상자에 붙여넣습니다.

    b. **Save**를 클릭합니다.

>[!NOTE]
>다른 Sugar CRM 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 AAD 사용자 계정을 tooprovision Sugar CRM에서 제공 된 Api입니다. 
> 

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooSugar CRM을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooSugar CRM, hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Sugar CRM**합니다.
...
Hello 액세스 패널에서에서 hello Sugar CRM 타일을 클릭할 때 자동으로 로그온 tooyour Sugar CRM 응용 프로그램을 구해야 합니다.
