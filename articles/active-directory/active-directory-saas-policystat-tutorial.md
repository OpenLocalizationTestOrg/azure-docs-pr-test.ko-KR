...
이 자습서에 설명 어떻게 toointegrate PolicyStat Azure Active directory (Azure AD).

다음 이점을 hello로 제공 PolicyStat Azure AD와 통합:

- 액세스 tooPolicyStat을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooPolicyStat (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure PolicyStat와 Azure AD 통합 합니다.
...
1. PolicyStat은 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-policystat-from-hello-gallery"></a>PolicyStat은 hello 갤러리 추가
tooconfigure hello와의 통합 PolicyStat Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 PolicyStat tooadd가 필요합니다.

**hello 갤러리에서 PolicyStat tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow PolicyStat에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 PolicyStat에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

PolicyStat에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 PolicyStat 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[PolicyStat 테스트 사용자 만들기](#creating-a-policystat-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 PolicyStat에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 PolicyStat 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, PolicyStat와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **PolicyStat** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **PolicyStat 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-policystat-tutorial/tutorial_policystat_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<companyname>.policystat.com`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<companyname>.policystat.com/saml2/metadata/`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [PolicyStat 클라이언트 지원 팀](http://www.policystat.com/support/) tooget 이러한 값입니다. 
...
5. hello이이 섹션의 목적은 toooutline 페더레이션을 사용 하 여 Azure AD에서 자신의 계정으로 tooenable 사용자 tooauthenticate tooPolicyStat hello SAML 프로토콜에 따라 하는 방법입니다.

    hello PolicyStat 응용 프로그램에는 사용자 지정 특성 매핑을 tooyour tooadd 요구 하는 특정 형식으로 hello SAML 어설션이 **SAML 토큰 특성** 구성 합니다.  

     hello 스크린 샷 다음이 예를 보여 줍니다.

     ![특성](./media/active-directory-saas-policystat-tutorial/tutorial_policystat_attribute.png "특성")

6. tooadd hello 필요한 특성 매핑을 hello 다음 단계를 수행 합니다.
    ...
    b. Hello에 **특성 이름** 텍스트 상자에 **uid**합니다.

    c. Hello에 **특성 값** textbox, **ExtractMailPrefix()**합니다.    
   
    d. Hello에서 **메일** 목록에서 **User.mail**합니다.
...
9. Hello 클릭 **Admin** 탭을 클릭 한 다음 **Single Sign On 구성** 왼쪽된 탐색 창에서.
   
    ![관리자 메뉴](./media/active-directory-saas-policystat-tutorial/ic808633.png "관리자 메뉴")

10. Hello에 **설치** 섹션에서 **사용 Single sign-on 통합**합니다.
   
    ![Single Sign-on 구성](./media/active-directory-saas-policystat-tutorial/ic808634.png "Single Sign-on 구성")

11. 클릭 **특성 구성**, 선택한 다음 hello **특성 구성** 섹션를 hello 다음 단계를 수행 합니다.
   
    ![Single Sign-on 구성](./media/active-directory-saas-policystat-tutorial/ic808635.png "Single Sign-on 구성")
   
    a. Hello에 **Username 특성** 텍스트 상자에 **uid**합니다.

    b. Hello에 **First Name 특성** 텍스트 상자에 **firstname** 사용자의 **Britta**합니다.

    c. Hello에 **성 특성** 텍스트 상자에 **lastname** 사용자의 **Simon**합니다.

    d. Hello에 **전자 메일 특성** 텍스트 상자에 **emailaddress** 사용자의  **BrittaSimon@contoso.com** 합니다.

    e. **변경 내용 저장**을 클릭합니다.

12. 클릭 **Your IDP 메타 데이터**, 선택한 다음 hello **Your IDP 메타 데이터** 섹션를 hello 다음 단계를 수행 합니다.
   
    ![Single Sign-on 구성](./media/active-directory-saas-policystat-tutorial/ic808636.png "Single Sign-on 구성")
   
    a. 다운로드 한 메타 데이터 파일, 콘텐츠를 복사 hello를 연 다음 hello에 붙여 넣을 **Your Id 공급자 메타 데이터** 텍스트 상자에 붙여넣습니다.
...
Tooenable Azure AD 사용자가 toolog PolicyStat로 주문 하 고에 PolicyStat에 이들 프로 비전 해야 합니다.  

PolicyStat는 사용자 프로비전 시간에만 지원합니다. 즉, 불필요 tooadd hello 사용자가 수동으로 tooPolicyStat 합니다. SSO 통해 처음 로그인 할 hello 사용자가 자동으로 추가 됩니다.

>[!NOTE]
>다른 PolicyStat 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 Azure AD 사용자 계정을 PolicyStat tooprovision에서 제공 된 Api입니다.
> 

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooPolicyStat 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooPolicyStat hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **PolicyStat**합니다.
...
Hello 액세스 패널에서에서 hello PolicyStat 타일을 클릭할 때 자동으로 로그온 tooyour PolicyStat 응용 프로그램을 구해야 합니다.
