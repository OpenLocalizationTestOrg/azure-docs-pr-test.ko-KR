...
이 자습서에 설명 어떻게 toointegrate MaxxPoint Azure Active directory (Azure AD).

다음 이점을 hello로 제공 MaxxPoint Azure AD와 통합:

- 액세스 tooMaxxPoint을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooMaxxPoint (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure MaxxPoint와 Azure AD 통합 합니다.
...
1. MaxxPoint은 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트


## <a name="adding-maxxpoint-from-hello-gallery"></a>MaxxPoint은 hello 갤러리 추가
tooconfigure hello와의 통합 MaxxPoint Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 MaxxPoint tooadd가 필요합니다.

**hello 갤러리에서 MaxxPoint tooadd hello 다음 단계를 수행 합니다.**
...
3. 클릭 **새 응용 프로그램** 대화 tooadd 새 응용 프로그램의 hello 맨 위의 단추를 합니다.

    ![응용 프로그램][3]

4. Hello 검색 상자에 입력 **MaxxPoint**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_001.png)

5. Hello 결과 패널에서 선택 **MaxxPoint**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow MaxxPoint에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 MaxxPoint에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** MaxxPoint에 합니다.

tooconfigure 및 MaxxPoint 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[MaxxPoint 테스트 사용자 만들기](#creating-a-maxxpoint-test-user)**  -toohave Britta Simon 그녀의 연결 된 Azure AD toohello 표현인 MaxxPoint에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 MaxxPoint 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, MaxxPoint와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **MaxxPoint** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **MaxxPoint 도메인 및 Url** tooconfigure hello 응용 프로그램에 필요한 경우 섹션 **IDP 시작 모드**, no tooperform 모든 단계가 필요 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_02.png)
    
4. Hello에 **MaxxPoint 도메인 및 Url** 섹션 tooconfigure hello 응용 프로그램에 필요한 경우 **SP 시작 모드**, hello 다음 단계를 수행 합니다.
    
    ![Single Sign-on 구성](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_03.png)

    a. **고급 URL 설정 표시** 옵션을 클릭합니다.

    b. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://maxxpoint.westipc.com/default/sso/login/entity/<customer-id>-azure`

    > [!NOTE] 
    > Hello 진정한 가치 아닌지 note 하십시오. 이 값을 실제 hello로 로그온 URL tooupdate를 해야 합니다. MaxxPoint 팀에 대해 호출 **888-728-0950** tooget이이 값입니다.
...
7. 응용 프로그램에 tooget SSO 구성, MaxxPoint 지원 팀에 대해 호출 **888-728-0950** 합니다를 지원할 추가 tooprovide hello에 다운로드 하는 방법을에 및 **메타 데이터 XML** 파일입니다. 
...
이 섹션에서는 MaxxPoint에서 Britta Simon이라는 사용자를 만듭니다. MaxxPoint 지원 팀에 문의 하십시오 **888-728-0950** hello MaxxPoint 응용 프로그램의에서 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooMaxxPoint 그녀의 권한을 부여 하 여 Azure single sign on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooMaxxPoint hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **MaxxPoint**합니다.
...
Hello 액세스 패널에서에서 hello MaxxPoint 타일을 클릭할 때 자동으로 로그온 tooyour MaxxPoint 응용 프로그램을 구해야 합니다.
