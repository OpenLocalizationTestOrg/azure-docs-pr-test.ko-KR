...
보존에 대한 최근의 자세한 내용은 [Azure Active Directory 보고서 보존 정책](active-directory-reporting-retention.md)을 참조하세요.
...
| MailNickname |주소록 개체에 대한 모니커입니다. 일반적으로 전자 메일 이름 앞 부분은 "@" 기호입니다. |
