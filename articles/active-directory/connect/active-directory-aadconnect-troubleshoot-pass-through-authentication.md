...
표시는 "**'PerTenantSwitchToESTSEnabled' 매개 변수 이름과 일치 하는 매개 변수를 찾을 수 없습니다\.**" 실행 하는 동안 오류가 발생 했습니다.는 `Set-OrganizationConfig` Exchange PowerShell 명령를 Microsoft 지원에 문의 합니다.
