...
### [Hello 기본 구성 변경](active-directory-aadconnectsync-best-practices-changing-default-configuration.md)
...
### [Hello Azure AD Sync 서비스 계정 암호 변경](active-directory-aadconnectsync-change-serviceacct-pass.md)
### [Hello AD DS 계정 암호 변경](active-directory-aadconnectsync-change-addsacct-pass.md)
...
### [어떻게 toorecover LocalDB 10GB 제한에서](active-directory-aadconnect-recover-from-localdb-10gb-limit.md)
...
### [특성이 tooAzure Active Directory 동기화](active-directory-aadconnectsync-attributes-synchronized.md)
...
# 관련 항목
## [프로그램 hello 클라우드에서 온-프레미스 id 인프라 및 동기화 서비스를 모니터링 합니다.](../connect-health/active-directory-aadconnect-health.md)
