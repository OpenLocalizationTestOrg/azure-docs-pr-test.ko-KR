...
이 자습서에 설명 어떻게 toointegrate 할로겐 소프트웨어와 Azure Active Directory (Azure AD).

다음 이점을 hello로 제공 할로겐 소프트웨어 Azure AD와 통합:

- Azure ad 액세스 tooHalogen 소프트웨어를 가진 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooHalogen (Single Sign-on)는 소프트웨어와는 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure 할로겐 Software와 Azure AD 통합 합니다.
...
1. Hello 갤러리에서 할로겐 소프트웨어 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-halogen-software-from-hello-gallery"></a>Hello 갤러리에서 할로겐 소프트웨어 추가

tooconfigure hello와의 통합 할로겐 소프트웨어 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 할로겐 소프트웨어 tooadd가 필요합니다.

**hello 갤러리에서 할로겐 소프트웨어 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow 할로겐 소프트웨어에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 할로겐 소프트웨어에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

할로겐 소프트웨어에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 할로겐 소프트웨어를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[할로겐 소프트웨어 테스트 사용자 만들기](#creating-a-halogen-software-test-user)**  -toohave Britta Simon 할로겐 소프트웨어를 사용자의 연결 된 Azure AD toohello 표현에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 할로겐 소프트웨어 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on 할로겐 소프트웨어와 함께 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **할로겐 소프트웨어** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **할로겐 소프트웨어 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-halogen-software-tutorial/tutorial_halogensoftware_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://global.hgncloud.com/<companyname>`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL: `https://global.halogensoftware.com/<companyname>`,`https://global.hgncloud.com/<companyname>`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [할로겐 소프트웨어 클라이언트 지원 팀](https://support.halogensoftware.com/) tooget 이러한 값입니다. 
...
6. 로그온 tooyour 다른 브라우저 창에서 **할로겐 소프트웨어** 관리자 권한으로 응용 프로그램입니다.

7. Hello 클릭 **옵션** 탭 합니다. 
   
    ![Azure AD Connect의 정의][12]

8. Hello 왼쪽된 탐색 창에서 클릭 **SAML 구성**합니다. 
...
9. Hello에 **SAML 구성** 페이지 hello 다음 단계를 수행 합니다. 
    ...
    ![Azure AD Connect의 정의][14]
     ...
     c. tooupload 다운로드 한 메타 데이터 파일을 클릭 하 여 **찾아보기** tooselect hello 파일 차례로 **파일 업로드**합니다.
 
     d. tootest hello 구성 클릭 **테스트 실행**합니다. 
    
    >[!NOTE]
    >Toowait hello 메시지에 필요한 "*hello SAML 테스트가 완료 되었습니다. 이 창을 닫으십시오.*" 메시지가 표시될 때까지 기다려야 합니다. 그런 다음 hello 열려 있는 브라우저 창을 닫습니다. hello **SAML을 사용 하도록 설정** hello 테스트 완료 된 경우만 확인란을 사용할 수 있습니다. 
...
hello이이 섹션의 목적은 toocreate Britta Simon 할로겐 소프트웨어에서 호출 하는 사용자입니다.

**toocreate 할로겐 소프트웨어에서 Britta Simon 라는 사용자를 만들면 hello 다음 단계를 수행 합니다.**

1. Tooyour 로그온 **할로겐 소프트웨어** 관리자 권한으로 응용 프로그램입니다.

2. Hello 클릭 **사용자 센터** 탭을 클릭 한 다음 **Create User**합니다.
   
    ![Azure AD Connect의 정의][300]  

3. Hello에 **새 사용자** 대화 상자 페이지를 hello 다음 단계를 수행 합니다.
   
    ![Azure AD Connect의 정의][301]

    a. Hello에 **이름** 같은 hello 사용자의 형식 이름 텍스트 상자 **Britta**합니다.
    
    b. Hello에 **성** 텍스트 상자와 같은 hello 사용자의 성 형식 **Simon**합니다. 

    c. Hello에 **Username** 텍스트 상자에 **Britta Simon**, hello Azure 포털에서와 같이 hello 사용자 이름입니다.

    d. Hello에 **암호** 텍스트 상자에 암호 Britta입니다.
    
    e. **Save**를 클릭합니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooHalogen 소프트웨어를 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooHalogen 소프트웨어 hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **할로겐 소프트웨어**합니다.
...
Hello 액세스 패널에서에서 hello 할로겐 소프트웨어 타일을 클릭할 때 자동으로 로그온 tooyour 할로겐 소프트웨어 응용 프로그램을 구해야 합니다.
