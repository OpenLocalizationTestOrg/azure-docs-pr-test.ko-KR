...
---
# <a name="getting-started-with-the-azure-active-directory-reporting-api-on-the-azure-ad-classic-portal"></a>Azure AD 클래식 포털에서 Azure Active Directory Reporting API 시작
