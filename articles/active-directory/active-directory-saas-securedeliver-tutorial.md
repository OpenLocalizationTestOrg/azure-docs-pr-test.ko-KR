...
Toointegrate 보안 방법을 배우게이 자습서에서는 Azure Active Directory (Azure AD)에 전달 합니다.

Azure AD와 배달 SECURE를 통합 이점을 다음 hello 제공:

- 액세스 tooSECURE 배달을 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooSECURE 배달 (Single Sign-on)는 Azure AD 계정 사용을 활성화할 수 있습니다.
...
배달 SECURE와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Hello 갤러리에서 제공 보호를 추가합니다.
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-secure-deliver-from-hello-gallery"></a>Hello 갤러리에서 제공 보호를 추가합니다.
tooconfigure hello와의 통합 보안 제공 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 SECURE 배달 tooadd가 필요합니다.

**tooadd SECURE hello 갤러리에서 배달 hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow 배달 SECURE에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 배달 SECURE에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

배달 SECURE에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 배달 SECURE와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[배달 SECURE 테스트 사용자 만들기](#creating-a-secure-deliver-test-user)**  -toohave Britta Simon 표현인 연결 된 toohello Azure AD 사용자의 배달 SECURE에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 사용 하도록 설정 및 배달 보안 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on 제공 SECURE와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **배달 SECURE** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **보안 배달 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-securedeliver-tutorial/tutorial_securedeliver_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<companyname>.i-securedeliver.jp/sd/<tenantname>/jsf/login/sso`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<companyname>.i-securedeliver.jp/sd/<tenantname>/postResponse`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [제공 클라이언트 보안 지원 팀](mailto:iw-sd-support@fujifilm.com) tooget 이러한 값입니다. 
...
6. Hello에 **배달 구성 SECURE** 섹션에서 클릭 **배달 보안 구성** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL, SAML 엔터티 ID, 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-securedeliver-tutorial/tutorial_securedeliver_configure.png) 

7. tooconfigure single sign on에서 **배달 SECURE** toosend hello 다운로드 해야 쪽에서는 **인증서 (Base64)**, **Sign-Out URL, SAML 엔터티 ID, 및 SAML Single Sign-on 서비스 URL** 너무[지원 팀 배달 SECURE](mailto:iw-sd-support@fujifilm.com)합니다. 이 설정은 toohave hello 양쪽 모두에 제대로 설정 하는 SAML SSO 연결 설정 합니다.
...
hello이이 섹션의 목적은 toocreate 배달 SECURE에 Britta Simon 라고 하는 사용자입니다. 작업할 [배달 SECURE 지원 팀](mailto:iw-sd-support@fujifilm.com) tooadd hello 사용자 hello 제공 보안 계정에에서 있습니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooSECURE 전달 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooSECURE 배달, hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **배달 SECURE**합니다.
...
Hello 액세스 패널에서에서 hello 배달 SECURE 타일을 클릭할 때 자동으로 로그온 tooyour 배달 보안 응용 프로그램을 구해야 합니다.
