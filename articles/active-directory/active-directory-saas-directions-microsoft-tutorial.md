...
이 자습서에 설명 어떻게 toointegrate Directions on Microsoft Azure Active directory (Azure AD).

Directions on Microsoft Azure AD와 통합 hello 다음 이점을 제공 합니다.

- Microsoft에 대 한 액세스 tooDirections 있는 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooDirections (Single Sign-on)는 Microsoft에서 자신의 Azure AD 계정으로 사용 하도록 설정할 수 있습니다.
...
Directions on Microsoft와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Hello 갤러리에서 Directions on Microsoft에 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-directions-on-microsoft-from-hello-gallery"></a>Hello 갤러리에서 Directions on Microsoft에 추가
tooconfigure hello와의 통합 Directions on Microsoft Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd Directions on Microsoft에 필요합니다.

**Directions on Microsoft hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **Directions on Microsoft**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-directions-microsoft-tutorial/tutorial_directionsonmicrosoft_search.png)

5. Hello 결과 패널에서 선택 **Directions on Microsoft**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow Directions on Microsoft에에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Directions on Microsoft에에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Directions on Microsoft에에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 Directions on Microsoft와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Directions on Microsoft 테스트 사용자 만들기](#creating-a-directions-on-microsoft-test-user)**  -toohave Britta Simon Directions on Microsoft에는 사용자의 연결 된 Azure AD toohello 표현에에서 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 프로그램 Directions on Microsoft 응용 프로그램에서에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on Directions on Microsoft와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Directions on Microsoft** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Directions on Microsoft 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.
    ...
    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [Directions on Microsoft 클라이언트 지원 팀](mailto:service@DirectionsOnMicrosoft.com) tooget 이러한 값입니다. 
...
6. tooconfigure single sign on에서 **Directions on Microsoft** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 너무[Directions on Microsoft 지원 팀](mailto:service@DirectionsOnMicrosoft.com)합니다. tooenable hello Directions on Microsoft 지원 팀 toolocate 프로그램 페더레이션된 사이트 멤버 자격, 전자 메일에 회사 정보를 포함 합니다.
    
    >[!NOTE]
    >Single sign on Directions on Microsoft에 대 한 toobe hello로 사용 하도록 설정 해야 [Directions on Microsoft 클라이언트 지원 팀](mailto:service@DirectionsOnMicrosoft.com)합니다. Single sign-on가 활성화되면 알림을 받습니다.
...
사용자에 대 한 있습니다 tooconfigure tooDirections Microsoft에서 프로 비전 작업 항목이 없습니다.  

할당된 된 사용자에 hello 액세스 패널을 사용 하 여 Microsoft에 tooDirections toolog를 시도할 때 Directions on Microsoft hello 사용자의 존재 여부를 확인 합니다. 사용할 수 있는 사용자 계정이 없으면 자동으로 Directions on Microsoft에 의해 생성됩니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 microsoft tooDirections 액세스 권한을 부여 하 여 Azure single sign on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**Microsoft에 Britta Simon tooDirections tooassign hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Directions on Microsoft**합니다.
...
Hello Directions on Microsoft hello 액세스 패널에에서는 타일을 클릭할 때 Microsoft 응용 프로그램에 자동으로 로그온 tooyour 방향으로 가져와야 합니다.
