...
이 자습서에 설명 어떻게 toointegrate Convercent Azure Active directory (Azure AD).

다음 이점을 hello로 제공 Convercent Azure AD와 통합:

- 액세스 tooConvercent을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooConvercent (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure Convercent와 Azure AD 통합 합니다.
...
1. Convercent은 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-convercent-from-hello-gallery"></a>Convercent은 hello 갤러리 추가
tooconfigure hello와의 통합 Convercent Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Convercent tooadd가 필요합니다.

**hello 갤러리에서 Convercent tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Convercent에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 Convercent에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** Convercent에 합니다.

tooconfigure 및 Convercent 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Convercent 테스트 사용자 만들기](#creating-a-convercent-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Convercent에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Convercent 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, Convercent와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Convercent** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Convercent 도메인 및 Url** tooconfigure hello 응용 프로그램에 필요한 경우 섹션 **IDP 시작 모드**, hello 단계 다음에 수행:

    ![Single Sign-on 구성](./media/active-directory-saas-convercent-tutorial/tutorial_convercent_url.png)

    Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<instancename>.convercent.com/`
 
4. Tooconfigure hello 응용 프로그램에 필요한 경우 **SP 시작 모드**, hello에 **Convercent 도메인 및 Url** 섹션 hello 다음 단계를 수행 합니다.
    
    ![Single Sign-on 구성](./media/active-directory-saas-convercent-tutorial/tutorial_convercent_url1.png)

     a. **“고급 URL 설정 표시”**를 클릭합니다. 

     b. Hello에 **로그온 URL** hello 패턴을 사용 하 여 형식 hello 값 텍스트 상자:`https://<instancename>.convercent.com/`

     c. Hello에 **릴레이 상태** hello 패턴을 사용 하 여 형식 hello 값 텍스트 상자:`https://<instancename>.convercent.com/`

    > [!NOTE] 
    > 이러한 값은 실제 값 hello 없습니다. 이러한 항목을 업데이트 식별자, 로그온 URL 및 릴레이 상태 실제 hello로 값입니다. 연락처 [Convercent 클라이언트 지원 팀](http://support.convercent.com) tooget 이러한 값입니다.
...
7. 응용 프로그램에 tooget SSO 구성에 문의 하시기 바랍니다 [Convercent 지원 팀](mailto:support@convercent.com) hello 다운로드로 제공 **메타 데이터 XML**합니다.
...
작업할 [Convercent 지원 팀](mailto:support@convercent.com) hello Convercent 플랫폼의 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooConvercent 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooConvercent hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Convercent**합니다.
...
Hello 액세스 패널에서에서 hello Convercent 타일을 클릭할 때 자동으로 로그온 tooyour Convercent 응용 프로그램을 구해야 합니다.
