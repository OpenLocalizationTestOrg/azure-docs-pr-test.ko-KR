...
이 자습서에 설명 어떻게 toointegrate Kantega SSO JIRA Azure Active directory (Azure AD)에 대 한 합니다.

다음 이점을 hello로 제공 Kantega SSO JIRA에 대 한 Azure AD와 통합:

- JIRA에 대 한 SSO 액세스 tooKantega 지닌 Azure AD에서 제어할 수 있습니다.
- 사용 하도록 설정 하면 사용자가 tooautomatically get 로그온 tooKantega SSO JIRA (Single Sign-on)는 Azure AD 계정을 사용
...
다음 항목 hello가 필요 tooconfigure JIRA에 대 한 Kantega SSO와 Azure AD 통합 합니다.
...
1. Hello 갤러리에서 Kantega SSO JIRA에 대 한 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-kantega-sso-for-jira-from-hello-gallery"></a>Hello 갤러리에서 Kantega SSO JIRA에 대 한 추가
tooconfigure hello와의 통합 Kantega SSO JIRA에 대 한 Azure AD로 필요 tooadd Kantega SSO JIRA 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 합니다.

**tooadd Kantega SSO JIRA hello 갤러리에서에 대 한 hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **JIRA에 대 한 SSO Kantega**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-kantegassoforjira-tutorial/tutorial_kantegassoforjira_search.png)

5. Hello 결과 패널에서 선택 **JIRA에 대 한 Kantega SSO**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow JIRA에 대 한 Kantega SSO에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 hello JIRA에 대 한 Kantega SSO에서 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

JIRA에 대 한 Kantega sso에서는 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 JIRA에 대 한 Kantega SSO와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[JIRA 테스트 사용자에 대 한 Kantega SSO 만들기](#creating-a-kantega-sso-for-jira-test-user)**  -toohave Britta Simon Kantega SSO는 사용자의 연결 된 Azure AD toohello 표현 JIRA에 대 한에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 JIRA 응용 프로그램에 대 한 프로그램 Kantega SSO에서 single sign on 구성 합니다.

**JIRA에 대 한 Kantega SSO와 Azure AD에서 single sign-on tooconfigure hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **JIRA에 대 한 Kantega SSO** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. **IDP** 시작 모드 hello에 **JIRA 도메인 및 Url에 대 한 SSO Kantega** 섹션 hello 단계 다음에 수행:
...
4. **SP** 검사 시작된 모드 **고급 URL 설정 표시** hello 단계 다음에 수행:
    ...
    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 식별자, 회신 URL 및 로그온 URL 실제 hello로 값입니다. 이러한 값은 hello 자습서의 뒷부분에 설명 된 Jira 플러그 인의 hello 구성 하는 동안 수신 됩니다.
...
7. 다른 웹 브라우저 창에서 관리자 권한으로 tooyour JIRA 프레미스 서버에 로그인 합니다.

8. Hello를 누르고 선 위에 마우스를 가져가면 **추가 기능**합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-kantegassoforjira-tutorial/addon1.png)

9. [추가 기능] 탭 섹션에서 **새 추가 기능 찾기**를 클릭합니다. 검색 **JIRA (SAML & Kerberos)에 대 한 Kantega SSO** 클릭 **설치** 단추 tooinstall hello 새 SAML 플러그 인 합니다.
...
13. 새 플러그 인이 **INTEGRATIONS**(통합) 아래 나열됩니다. 클릭 **구성** tooconfigure hello 새 플러그 인 합니다.
...
16. Hello에 **앱 속성** 섹션에서 다음 단계를 수행 합니다. 
    ...
    a. 복사 hello **앱 ID URI** 값으로 사용 하 여 **식별자, 회신 URL 및 로그온 URL** hello에 **JIRA 도메인 및 Url에 대 한 SSO Kantega** Azure 포털에서 섹션.
...
20. Hello에 **JIRA 사용자 계정** 섹션에서 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-kantegassoforjira-tutorial/addon10.png)

    a. 선택 **필요한 경우 JIRA의 내부 디렉터리에서 사용자를 만들려면** 사용자에 대 한 hello 그룹의 hello 적절 한 이름을 입력 하 고 (수 여러 아니요. 그룹의 쉼표로 구분).
...
tooenable Azure AD 사용자가 toolog tooJIRA에서 이러한 해야에 프로 비전 JIRA 합니다. Kantega SSO for JIRA에서는 프로비전이 수동 작업입니다.

**tooprovision 사용자 계정을 hello 다음 단계를 수행 합니다.**

1. Tooyour JIRA 프레미스 서버에서 관리자 권한으로 로그인 합니다.
...
4. Hello에 **"새 사용자 만들기"** 대화 상자 페이지를 hello 다음 단계를 수행 합니다.
...
이 섹션에서는 액세스 tooKantega SSO JIRA에 대 한 권한을 부여 하 여 Britta Simon toouse Azure single sign on을 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooKantega JIRA에 대 한 SSO hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **JIRA에 대 한 SSO Kantega**합니다.
...
Hello 액세스 패널에서에서 JIRA 타일에 대 한 hello Kantega SSO를 클릭할 때 JIRA 응용 프로그램에 대 한 자동으로 로그온 tooyour Kantega SSO를 가져와야 합니다.
