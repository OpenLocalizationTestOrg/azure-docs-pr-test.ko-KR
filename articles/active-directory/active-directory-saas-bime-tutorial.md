...
이 자습서에 설명 어떻게 toointegrate Bime와 Azure Active Directory (Azure AD).

Azure AD와 Bime 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooBime을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooBime (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Bime와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Bime는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-bime-from-hello-gallery"></a>Bime는 hello 갤러리 추가
tooconfigure hello와의 통합 Bime Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Bime tooadd가 필요합니다.

**Bime hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Bime에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Bime에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Bime에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 Bime와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Bime 테스트 사용자 만들기](#creating-a-bime-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Bime에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Bime 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 Bime를 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Bime** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Bime 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-bime-tutorial/tutorial_bime_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<tenant-name>.Bimeapp.com`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<tenant-name>.Bimeapp.com`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [Bime 클라이언트 지원 팀](https://bime.zendesk.com/hc/categories/202604307-Support-tech-notes-and-tips-) tooget 이러한 값입니다. 
...
6. Hello에 **Bime 구성** 섹션에서 클릭 **구성 Bime** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**
...
8. Hello 도구 모음에서 클릭 **Admin**, 차례로 **계정**합니다.
   
    ![관리자](./media/active-directory-saas-bime-tutorial/ic775558.png "관리자")

9. Hello 계정 구성 페이지에서 다음 단계는 hello를 수행 합니다.
...
Tooenable Azure AD 사용자가 toolog tooBime에 주문 하 고에 Bime에 이들 프로 비전 해야 합니다. Hello Bime의 경우에서 프로 비전은 수동 작업입니다.

**tooconfigure 사용자 프로비저닝, hello 다음 단계를 수행:**

1. Tooyour 로그인 **Bime** 테 넌 트입니다.

2. Hello 도구 모음에서 클릭 **Admin**, 차례로 **사용자**합니다.
   
    ![관리자](./media/active-directory-saas-bime-tutorial/ic775561.png "관리자")

3. Hello에 **사용자 목록**, 클릭 **새 사용자 추가** ("+").
   
    ![사용자](./media/active-directory-saas-bime-tutorial/ic775562.png "사용자")

4. Hello에 **사용자 세부 정보** 대화 상자 페이지를 hello 다음 단계를 수행 합니다.
...
>[!NOTE]
>다른 Bime 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 AAD 사용자 계정을 tooprovision Bime에서 제공 된 Api입니다.
>  

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooBime 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooBime hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Bime**합니다.
...
Hello 액세스 패널에서에서 hello Bime 타일을 클릭할 때 자동으로 로그온 tooyour Bime 응용 프로그램을 구해야 합니다.
