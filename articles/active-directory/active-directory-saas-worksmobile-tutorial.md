...
이 자습서에 알아봅니다 toointegrate의 작동 원리를 통해 모바일으로 Azure Active Directory (Azure AD).

이점 다음 hello로 제공 WORKS 모바일 Azure AD와 통합:

- 액세스 tooWORKS 모바일을 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooWORKS 모바일 (Single Sign-on)는 Azure AD 계정 사용을 활성화할 수 있습니다.
...
Azure AD 통합 WORKS mobile tooconfigure 다음 항목 hello가 필요 합니다.
...
1. WORKS 모바일 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-works-mobile-from-hello-gallery"></a>WORKS 모바일 hello 갤러리 추가
tooconfigure hello와의 통합 WORKS 모바일 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd WORKS 모바일 필요합니다.

**hello 갤러리에서 WORKS 모바일 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow WORKS MOBILE에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 WORKS MOBILE에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** WORKS MOBILE에서 합니다.

tooconfigure 및 WORKS 모바일을 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[WORKS 모바일 테스트 사용자 만들기](#creating-a-works-mobile-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 WORKS 모바일에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 사용 하도록 설정 및 작동 모바일 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on WORKS mobile hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **WORKS 모바일** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **WORKS 모바일 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<subdomain>.worksmobile.com/jp/myservice`

    b. Hello에 **식별자** 형식 hello 값으로 텍스트 상자`worksmobile.com`

    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello로이 값을 업데이트 합니다. 실제 로그온 URL입니다. 연락처 [WORKS 모바일 클라이언트 지원 팀](mailto:dl_ssoinfo@worksmobile.com) tooget이이 값입니다. 
...
6. Hello에 **WORKS 모바일 구성** 섹션에서 클릭 **구성 WORKS 모바일** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL, SAML 엔터티 ID, 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_configure.png) 

7. 응용 프로그램에 tooget SSO 구성에 문의 하시기 바랍니다 [WORKS 모바일 지원 팀](mailto:dl_ssoinfo@worksmobile.com) hello 다음 정보를 제공 하 고 있습니다. 
...
### <a name="creating-a-works-mobile-test-user"></a>WORKS MOBILE 테스트 사용자 만들기
 ...
 이 섹션에서는 WORKS MOBILE에서 Britta Simon이라는 사용자를 만듭니다. 와 협력 하세요 [WORKS 모바일 지원 팀](mailto:dl_ssoinfo@worksmobile.com) hello WORKS 모바일 플랫폼에서 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooWORKS 모바일 액세스를 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooWORKS 모바일, hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **WORKS 모바일**합니다.
...
Hello 액세스 패널에서에서 hello WORKS 모바일 타일을 클릭할 때 자동으로 로그온 tooyour WORKS 모바일 응용 프로그램을 구해야 합니다.
