...
이 자습서에 설명 toointegrate Moxi Azure Active Directory (Azure AD)에 참여 하는 방법입니다.

다음 이점을 hello로 제공 Moxi 참여 Azure AD와 통합:

- 액세스 tooMoxi 사로잡는 구성을 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooMoxi 사로잡는 (Single Sign-on) 구성으로는 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure Moxi 참여와 Azure AD 통합 합니다.
...
1. Hello 갤러리에서 Moxi 참여를 추가합니다.
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-moxi-engage-from-hello-gallery"></a>Hello 갤러리에서 Moxi 참여를 추가합니다.
tooconfigure hello와의 통합 Moxi 참여 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd Moxi 참여 해야합니다.

**hello 갤러리에서 의견을 교환 Moxi tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Moxi 참여에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 Moxi 참여에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Moxi 참여에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 Moxi 참여와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Moxi 참여 테스트 사용자 만들기](#creating-a-moxi-engage-test-user)**  -toohave Britta Simon Moxi 표현인 연결 된 toohello Azure AD 사용자의 의견을 교환에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Moxi 의견을 교환 하는 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, Moxi 관여 된 단계를 수행 하는 hello를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Moxi 참여** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Moxi 참여 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-moxiengage-tutorial/tutorial_moxiengage_url.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://svc.<moxiworks-integration-domain>/service/v1/auth/inbound/saml/aad`

    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello로이 값을 업데이트 합니다. 실제 로그온 URL입니다. 연락처 [Moxi 참여 클라이언트 지원 팀](mailto:support@moxiworks.com) tooget이이 값입니다. 
...
6. tooconfigure single sign on에서 **Moxi 참여** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 너무[지원 팀 Moxi 참여](mailto:support@moxiworks.com)합니다. 이 설정은 toohave hello 양쪽 모두에 제대로 설정 하는 SAML SSO 연결 설정 합니다.
...
이 섹션에서는 Moxi Engage에서 Britta Simon이라는 사용자를 만듭니다. 작업할 [Moxi 참여 지원 팀](mailto:support@moxiworks.com) hello 사용자 의견을 교환 Moxi 플랫폼 hello에서 추가할 수 있습니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooMoxi 사로잡는 구성 부여 하 여 Britta Simon toouse Azure single sign on을 사용 합니다.

![사용자 할당][200] 

**hello 다음 단계를 수행 하는 tooassign Britta Simon tooMoxi 사로잡는 구성 하십시오.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Moxi 참여**합니다.
...
Hello 액세스 패널에서에서 hello Moxi 참여 타일을 클릭할 때 자동 로그인 tooMoxi 참여 응용 프로그램을 구해야 합니다.
