...
이 자습서에 설명 어떻게 Azure Active Directory (Azure AD)와 즉 toointegrate 합니다.

다음 이점을 hello로 제공 즉 Azure AD와 통합:

- 액세스 tooNamely을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooNamely (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
즉, 사용자와 Azure AD tooconfigure 통합 hello 다음 항목을 필요 합니다.
...
## <a name="adding-namely-from-hello-gallery"></a>즉 hello 갤러리 추가
tooconfigure hello와의 통합 즉 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 즉 tooadd가 필요합니다.

**hello 갤러리에서 즉 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow에 Azure AD에서 즉가 tooa 사용자 어떤 hello 테이블에 해당 사용자에 필요 합니다. 즉, Azure AD 사용자 및 hello에 관련 된 사용자 간 링크 관계를 설정할 toobe 즉 필요 합니다.

hello hello 값 즉, 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

즉, 사용자와 Azure AD에서 single sign-on 테스트 및 tooconfigure toocomplete hello 빌딩 블록을 다음 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[만들기는 즉 테스트 사용자](#creating-a-namely-test-user)**  -toohave 즉 즉 연결 된 toohello 사용자의 Azure AD 표현에서에서 Britta Simon 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 프로그램 즉 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on으로 다시 말해 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **즉** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **즉 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-namely-tutorial/tutorial_namely_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<subdomain>.namely.com`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<subdomain>.namely.com/saml/metadata`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [즉 클라이언트 지원 팀](https://www.namely.com/contact/) tooget 이러한 값입니다. 
...
6. Hello에 **구성 즉** 섹션에서 클릭 **구성 즉** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-namely-tutorial/tutorial_namely_configure.png) 

7. 다른 브라우저 창에서 로그인 tooyour 즉 회사 사이트에 관리자로 합니다.

8. 도구 모음의 hello hello 위쪽에 클릭 **회사**합니다.
   
    ![Single Sign-on 구성](./media/active-directory-saas-namely-tutorial/tutorial_namely_06.png) 

9. Hello 클릭 **설정을** 탭 합니다.
...
11. Hello에 **SAML 설정** 페이지 hello 다음 단계를 수행 합니다.
    ...
    c. 콘텐츠 복사 hello 메모장에서 다운로드 한 인증서를 열고 hello에 붙여 넣습니다 **Id 공급자 인증서** 텍스트 상자에 붙여넣습니다.
...
hello이이 섹션의 목적은 toocreate 즉 Britta Simon 호출 사용자입니다.

**즉, Britta Simon 라는 사용자를 만들면 toocreate 단계를 수행 하는 hello를 수행 합니다.**

1. 즉 로그온 tooyour 관리자로 서 사이트를 회사입니다.

2. 도구 모음의 hello hello 위쪽에 클릭 **사람**합니다.
   
    ![Single Sign-on 구성](./media/active-directory-saas-namely-tutorial/tutorial_namely_10.png) 

3. Hello 클릭 **디렉터리** 탭 합니다.
...
5. Hello에 **새로운 사람 추가** 대화 상자에서 hello 다음 단계를 수행 합니다.

    a. Hello에 **이름** 텍스트 상자에 **Britta**합니다.

    b. Hello에 **성** 텍스트 상자에 **Simon**합니다.

    c. Hello에 **전자 메일** 텍스트 형식 hello **전자 메일 주소** BrittaSimon의 합니다.

    d. **Save**를 클릭합니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooNamely 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooNamely hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **즉**합니다.
...
Hello를 클릭할 때 hello 액세스 패널에서에서 타일 즉, 받아야 하며 자동으로 로그온 tooyour 즉 응용 프로그램
