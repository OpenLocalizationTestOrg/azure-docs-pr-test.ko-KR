...
이 자습서에 설명 어떻게 toointegrate Samanage와 Azure Active Directory (Azure AD).

Azure AD와 Samanage 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooSamanage을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooSamanage (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Samanage와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Samanage는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-samanage-from-hello-gallery"></a>Samanage는 hello 갤러리 추가
tooconfigure hello와의 통합 Samanage Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Samanage tooadd가 필요합니다.

**Samanage hello 갤러리에서 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Samanage에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Samanage에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Samanage에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 Samanage와 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Samanage 테스트 사용자 만들기](#creating-a-samanage-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Samanage에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Samanage 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 Samanage를 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Samanage** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Samanage 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<Company Name>.samanage.com/saml_login/<Company Name>`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<Company Name>.samanage.com`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. Hello 실제 로그온 URL 및 hello 자습서의 뒷부분에 설명 된 식별자를 가진 이러한 값을 업데이트 합니다. 자세한 내용은 [Samanage 클라이언트 지원 팀](https://www.samanage.com/support)에 문의하세요.    
...
6. Hello에 **Samanage 구성** 섹션에서 클릭 **구성 Samanage** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL 및 엔터티 ID가 SAML** hello에서 **빠른 참조 섹션.**
...
10. 너무 이동**SAML을 사용 하 여 로그인** 섹션를 hello 다음 단계를 수행 합니다.
    ...
    c. Hello 확인 **로그인 URL** 일치 hello **로그온 URL** 의 **Samanage 도메인 및 Url** Azure 포털에서 섹션.
 
    d. Hello에 **로그 아웃 URL** textbox hello 값을 입력 **Sign-Out URL** Azure 포털에서 복사한입니다.
 
    e. Hello에 **SAML 발급자** id 공급자에 텍스트 상자 형식 hello 앱 id URI 설정 합니다.
 
    f. 메모장에서 콘텐츠를 클립보드에 복사 hello Azure 포털에서 다운로드 한 base 64로 인코딩된 인증서를 열고 다음 toohello **사용자 Id 공급자 x.509 인증서 아래 붙여** 텍스트 상자에 붙여넣습니다.
...
tooenable Azure AD 사용자가 toolog tooSamanage에서 프로 비전 해야 Samanage에 있습니다.  
Hello Samanage의 경우에서 프로 비전은 수동 작업입니다.
...
5. 형식 hello **이름** 및 hello **전자 메일 주소** tooprovision을 클릭 하 여 Azure Active Directory 계정의 **사용자 만들기**합니다.
   
    ![사용자 만들기](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_008.png "사용자 만들기")
   
   >[!NOTE]
   >hello Azure Active Directory 계정 소유자 전자 메일을 받게 되 고 링크 tooconfirm 자신의 계정을 활성화 되기 전에 수행 됩니다. 다른 Samanage 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 사용자 계정을 Samanage tooprovision Azure Active Directory에서 제공 된 Api입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooSamanage 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooSamanage hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Samanage**합니다.
...
Hello 액세스 패널에서에서 hello Samanage 타일을 클릭할 때 자동으로 로그온 tooyour Samanage 응용 프로그램을 구해야 합니다.
