...
이 자습서에 설명 toointegrate Atlassian 하 여 클라우드로 Azure Active Directory (Azure AD) 하는 방법입니다.

다음 이점을 hello로 제공 Atlassian 클라우드 Azure AD와 통합:

- 클라우드 액세스 tooAtlassian을 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooAtlassian (Single Sign-on)는 클라우드는 Azure AD 계정 사용을 활성화할 수 있습니다.
...
Atlassian 클라우드와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Atlassian 클라우드 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-atlassian-cloud-from-hello-gallery"></a>Atlassian 클라우드 hello 갤러리 추가
tooconfigure hello와의 통합 Atlassian 클라우드 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Atlassian 클라우드 tooadd가 필요합니다.

**hello 갤러리에서 Atlassian 클라우드 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Atlassian 클라우드에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 Atlassian 클라우드에서 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** Atlassian 클라우드에서 합니다.

tooconfigure 및 Atlassian 클라우드를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Atlassian 클라우드 테스트 사용자 만들기](#creating-an-atlassian-cloud-test-user)**  -toohave Atlassian 클라우드에서 사용자의 연결 된 Azure AD toohello 표현인 Britta Simon의 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Atlassian 클라우드 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on Atlassian 클라우드와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Atlassian 클라우드** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Atlassian 클라우드 도메인 및 Url** 섹션를 hello tooconfigure hello 응용 프로그램에 필요한 경우 다음 단계를 수행 **IDP** 시작 모드:

    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_url.png)

    a. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<instancename>.atlassian.net/admin/saml/edit`

    b. Hello에 **회신 URL** 텍스트 상자에 다음 URL로:`https://id.atlassian.com/login/saml/acs`

4. 확인 **고급 URL 설정 표시** hello tooconfigure hello 응용 프로그램에 필요한 경우 단계를 다음을 수행 하 고 **SP** 시작 모드:

    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_url1.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<instancename>.atlassian.net`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 실제 hello로 값 식별자 및 로그온 URL입니다. Atlassian 클라우드 SAML 구성 화면에서 hello 정확한 값을 얻을 수 있습니다.
...
6. Hello에 **Atlassian 클라우드 구성** 섹션에서 클릭 **Atlassian 클라우드 구성** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL 및 엔터티 ID가 SAML** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_configure.png) 

7. tooget SSO Atlassian 포털 hello 관리자 권한을 사용 하 여 로그인 toohello 응용 프로그램에 대해 구성 합니다.

8. 왼쪽 탐색 hello hello 인증 섹션에서 클릭 **도메인**합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_06.png)

    a. Hello 텍스트 상자에 도메인 이름을 입력 한 다음 클릭 **도메인 추가**합니다.
        
    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_07.png)

    b. tooverify hello 도메인 클릭 **확인**합니다. 

    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_08.png)

    c. Hello 도메인 확인 html 파일을 다운로드 하 고 도메인의 웹 사이트의 루트 폴더 toohello 업로드 한 클릭 **도메인 확인**합니다.
    
    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_09.png)

    d. Hello 도메인이 확인 되 면 hello hello 값 **상태** 필드는 **확인 됨**합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_10.png)

9. Hello 왼쪽된 탐색 모음에서 **SAML**합니다.
 
    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_11.png)

10. SAML 구성 만들고 hello Id 공급자 구성을 추가 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_12.png)

    a. Hello에 **Id 공급자 엔터티 ID** 붙여넣기 hello 값의 텍스트 상자 **SAML 엔터티 ID** Azure 포털에서 복사한입니다.

    b. Hello에 **Id 공급자 SSO URL** 붙여넣기 hello 값의 텍스트 상자 **SAML Single Sign-on 서비스 URL** Azure 포털에서 복사한입니다.

    c. Hello Begin 없이 Azure 포털 및 복사 hello 값에서 인증서를 다운로드 하는 hello 및 끝 줄 열고 hello에 붙여 **공용 X509 인증서** 상자입니다.
    
    d. 클릭 **구성 저장** tooSave hello 설정 합니다.
     
11. Hello Azure AD 설정 toomake 설치 hello 식별자 URL을 수정 했는지를 업데이트 합니다.
  
    a. 복사 hello **SP Id ID** 화면에서 SAML hello를 hello로 Azure AD에 붙여넣으면 **식별자** 값입니다.

    b. 로그온 URL은 Atlassian 클라우드 hello 테 넌 트 URL입니다.     

     ![Single Sign-on 구성](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_13.png)
    
12. Hello Azure 포털에서에서 클릭 **저장** 단추입니다.
...
tooenable Azure AD 사용자가 toolog Atlassian 클라우드로 제공 되어야은 클라우드 tooAtlassian에 있습니다.  
Atlassian Cloud의 경우 프로비전이 수동 작업입니다.

**tooprovision 사용자 계정을 hello 다음 단계를 수행 합니다.**

1. Hello 사이트 관리 섹션에서에서 클릭 hello **사용자** 단추

    ![Atlassian Cloud 사용자 만들기](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_14.png) 

2. Hello 클릭 **Create User** 단추 toocreate hello 클라우드 Atlassian의에서 사용자

    ![Atlassian Cloud 사용자 만들기](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_15.png) 

3. Hello 사용자의 입력 **전자 메일 주소**, **Username**, 및 **전체 이름을** hello 응용 프로그램에 대 한 액세스 권한을 할당 하 고 있습니다. 

    ![Atlassian Cloud 사용자 만들기](./media/active-directory-saas-atlassian-cloud-tutorial/tutorial_atlassiancloud_16.png)
 
4. 클릭 **사용자 만들기** hello 전자 메일 초대 toohello 사용자 보냅니다 단추를 수락한 후 및 hello 초대 hello 사용자 hello 시스템에서 활성화 됩니다. 

>[!NOTE] 
>만들 수도 있습니다 hello 대량 사용자 hello를 클릭 하 여 **대량 만들** hello 사용자 섹션에에서는 단추입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooAtlassian 클라우드를 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooAtlassian 클라우드에 hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Atlassian 클라우드**합니다.
...
Hello Atlassian 클라우드 hello 액세스 패널에서에서 타일을 클릭할 때 자동으로 로그온 tooyour Atlassian 클라우드 응용 프로그램을 구해야 합니다. 액세스 패널 hello에 대 한 자세한 내용은 참조 [액세스 패널 소개 toohello](active-directory-saas-access-panel-introduction.md)합니다. 
