...
이 자습서에 설명 toointegrate Azure Active Directory (Azure AD)와 상자 하는 방법입니다.

다음 이점을 hello로 제공 상자 Azure AD와 통합:

- 액세스 tooBox을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooBox (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
Azure AD 및 Box 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Hello 갤러리에서 상자를 추가합니다.
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-box-from-hello-gallery"></a>Hello 갤러리에서 상자를 추가합니다.
tooconfigure hello와의 통합 상자 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 상자 tooadd가 필요합니다.

**hello 갤러리에서 상자 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow 상자에서 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 상자에서 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** 상자에 합니다.

tooconfigure 및 상자를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[상자 테스트 사용자 만들기](#creating-a-box-test-user)**  -toohave Britta Simon 표현인 연결 된 toohello Azure AD 사용자의 상자에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 상자 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on 상자 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **상자** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **상자 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-box-tutorial/tutorial_box_url.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<subdomain>.box.com`

    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello 실제 로그온 URL으로 hello 값을 업데이트 합니다. 연락처 [상자 클라이언트 지원 팀](https://community.box.com/t5/custom/page/page-id/submit_sso_questionaire) tooget이이 값입니다. 
...
6. SSO 응용 프로그램을 연락처에 대해 구성 된 tooget [상자 클라이언트 지원 팀](https://community.box.com/t5/custom/page/page-id/submit_sso_questionaire) hello 다운로드 한 XML 파일을 제공 합니다.
...
이 섹션에 작업 항목이 없습니다. 상자에 사용자 없으면 새 tooaccess 상자 할 때 생성 됩니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooBox 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooBox hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **상자**합니다.
...
Hello 액세스 패널에서에서 hello 상자 타일을 클릭할 때 로그인 페이지 tooget 로그온 tooyour 상자 응용 프로그램을 구해야 합니다.
