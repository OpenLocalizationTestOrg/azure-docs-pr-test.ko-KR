...
이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 BenefitHub 응용 프로그램에서 single sign on 구성 합니다.
...
이 섹션에서는 tooBenefitHub 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.
