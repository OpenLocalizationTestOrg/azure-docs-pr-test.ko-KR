...
이 자습서에 설명 어떻게 toointegrate Panorama9 Azure Active directory (Azure AD).

Azure AD와 Panorama9 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooPanorama9을 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooPanorama9 사용 하도록 설정할 수 있습니다 (Single Sign-on)는 Azure AD 계정을 사용
...
Panorama9와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Panorama9는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-panorama9-from-hello-gallery"></a>Panorama9는 hello 갤러리 추가
tooconfigure hello와의 통합 Panorama9 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Panorama9 tooadd가 필요합니다.

**hello 갤러리에서 Panorama9 tooadd hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow Panorama9에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Panorama9에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Panorama9에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 Panorama9 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Panorama9 테스트 사용자 만들기](#creating-a-panorama9-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Panorama9에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Panorama9 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on와 Panorama9, hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Panorama9** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Panorama9 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-panorama9-tutorial/tutorial_panorama9_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 다음 URL로:`https://dashboard.panorama9.com/saml/access/3262`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`http://www.panorama9.com/saml20/<tenant-name>`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [Panorama9 클라이언트 지원 팀](https://support.panorama9.com) tooget 이러한 값입니다. 
...
6. Hello에 **Panorama9 구성** 섹션에서 클릭 **구성 Panorama9** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**
...
6. 도구 모음의 hello hello 위쪽에 클릭 **관리**, 클릭 하 고 **확장**합니다.
   
   ![확장](./media/active-directory-saas-panorama9-tutorial/ic790023.png "확장")
7. Hello에 **확장** 대화 상자를 클릭 하 여 **Single Sign On**합니다.
   
   ![Single Sign-On](./media/active-directory-saas-panorama9-tutorial/ic790024.png "Single Sign-On")
8. Hello에 **설정** 섹션를 hello 다음 단계를 수행 합니다.
   
   ![설정](./media/active-directory-saas-panorama9-tutorial/ic790025.png "설정")
   
    a. **Id 공급자 URL** 붙여넣기 hello 값의 텍스트 상자 **Single Sign-on 서비스 URL**, Azure 포털에서 복사한입니다.
   
    b. **인증서 지문** 텍스트 붙여넣기 hello **지문** Azure 포털에서 복사 되는 인증서의 값입니다.    
...
Tooenable Azure AD 사용자가 toolog 9에 주문 하 고에서 9에 이들 프로 비전 해야 합니다.  

Hello Panorama9의 경우에서 프로 비전은 수동 작업입니다.

**tooconfigure 사용자 프로비저닝, hello 다음 단계를 수행:**

1. Tooyour 로그인 **Panorama9** 회사 사이트에 관리자 권한으로 합니다.

2. Hello 메뉴에서 hello 위에 표시를 클릭 **관리**, 클릭 하 고 **사용자**합니다.
   
  ![사용자](./media/active-directory-saas-panorama9-tutorial/ic790027.png "사용자")

3. Hello 사용자 섹션에서에서 클릭  **+**  tooadd 새 사용자입니다.

 ![사용자](./media/active-directory-saas-panorama9-tutorial/ic790028.png "사용자")

4. 이동 toohello 사용자 데이터 섹션, 형식 hello 전자 메일 주소 하려는 유효한 Azure Active Directory 사용자의 tooprovision hello에 **전자 메일** 텍스트 상자에 붙여넣습니다.

5. 사용자 섹션 클릭 toohello 제공 **저장**합니다.
...
이 섹션에서는 tooPanorama9 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooPanorama9 hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Panorama9**합니다.
...
Hello 액세스 패널에서에서 Panorama9 hello 타일을 클릭할 때 자동으로 로그온 tooPanorama9 응용 프로그램을 구해야 합니다.
