...
이 자습서에 설명 어떻게 toointegrate PlanMyLeave Azure Active directory (Azure AD).

다음 이점을 hello로 제공 PlanMyLeave Azure AD와 통합:

- 액세스 tooPlanMyLeave을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooPlanMyLeave (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
다음 항목 hello가 필요 tooconfigure PlanMyLeave와 Azure AD 통합 합니다.
...
1. PlanMyLeave는 hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트


## <a name="adding-planmyleave-from-hello-gallery"></a>PlanMyLeave는 hello 갤러리 추가
tooconfigure hello와의 통합 PlanMyLeave Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 PlanMyLeave tooadd가 필요합니다.

**hello 갤러리에서 PlanMyLeave tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **PlanMyLeave**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_001.png)

5. Hello 결과 패널에서 선택 **PlanMyLeave**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow PlanMyLeave에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 PlanMyLeave에 hello 관련된 사용자 간 링크 관계를 설정할 toobe가 필요 합니다.

Hello hello 값을 할당 하 여이 링크 관계가 설정 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** PlanMyLeave에 합니다.

tooconfigure 및 PlanMyLeave 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[PlanMyLeave 테스트 사용자 만들기](#creating-a-planmyleave-test-user)**  -toohave Britta Simon 그녀의 연결 된 Azure AD toohello 표현인 PlanMyLeave에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 관리 포털에서 설정 및 PlanMyLeave 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on, PlanMyLeave와 hello 다음 단계를 수행 합니다.**

1. Hello에 hello Azure 관리 포털에서 **PlanMyLeave** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.

    ![Single Sign-on 구성][4]

2. Hello에 **Single sign on** 대화 상자 페이지에서으로 **모드** 선택 **SAML 기반 로그온** tooenable single sign-on입니다.
 
    ![Single Sign-on 구성](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_01.png)

3. Hello에 **PlanMyLeave 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_02.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company-name>.planmyleave.com/Login.aspx`
    
    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company-name>.planmyleave.com`

    > [!NOTE] 
    > 이러한 없는지 hello 실제 값 note 하십시오. Tooupdate 실제 hello 사용 하 여 이러한 값에 URL과 식별자에 서명 해야 합니다. 연락처 [PlanMyLeave 지원 팀](mailto:support@planmyleave.com) tooget 이러한 값입니다.
...
9. Hello에 **PlanMyLeave 구성** 섹션에서 클릭 **구성 PlanMyLeave** tooopen **sign on 구성** 창.
...
11. 너무 이동**System 설치**합니다. 그 다음에 hello **보안 관리** 섹션 클릭 **회사 SAML 설정** 합니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_002.png) 

12. Hello에 **SAML 설정** 섹션에서 편집기 아이콘을 클릭 합니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_003.png)

13. Hello에 **업데이트 SAML 설정** 섹션를 hello 다음 단계를 수행 합니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_004.png)

    a.  Hello에 **로그인 URL** hello 값의 텍스트 상자 **SAML Single Sign-on 서비스 URL** Azure AD 응용 프로그램 구성 창에서.

    b.  다운로드 한 인증서 파일을 메모장에서 엽니다, hello---Begin Certificate-및---End certificate-의 내용을 클립보드에 간만 hello 콘텐츠 복사 및 붙여넣을 toohello **인증서** 텍스트 상자에 붙여넣습니다.
...
hello이이 섹션의 목적은 toocreate Britta Simon PlanMyLeave에서 호출 하는 사용자입니다. PlanMyLeave는 적시에 프로비전을 지원하며 기본적으로 사용하도록 설정합니다.

이 섹션에 작업 항목이 없습니다. 새 사용자를 아직 존재 하지 않는 경우 시도 tooaccess PlanMyLeave 중 만들어질 수 있습니다.

> [!NOTE]
> Toocontact toocreate 된 사용자를 수동으로 필요한 경우 필요한 [PlanMyLeave 지원 팀](mailto:support@planmyleave.com)합니다.



### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 액세스 tooPlanMyLeave 그녀의 권한을 부여 하 여 Azure single sign on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooPlanMyLeave hello 다음 단계를 수행 합니다.**

1. Hello Azure 관리 포털에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **PlanMyLeave**합니다.
...
Hello 액세스 패널에서에서 hello PlanMyLeave 타일을 클릭할 때 자동으로 로그온 tooyour PlanMyLeave 응용 프로그램을 구해야 합니다.
