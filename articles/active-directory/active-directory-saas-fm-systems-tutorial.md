...
이 자습서에 설명 어떻게 toointegrate Azure Active Directory (Azure AD)와 fm: systems 합니다.

Azure AD와 fm: systems를 통합 hello 다음 이점을 제공 합니다.

- 액세스 tooFM:Systems을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooFM:Systems (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
fm: systems와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Fm: systems hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-fmsystems-from-hello-gallery"></a>Fm: systems hello 갤러리 추가
tooconfigure hello와의 통합 fm: systems Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 fm: systems tooadd가 필요합니다.

**hello 갤러리에서 fm: systems tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **fm: systems**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-fm-systems-tutorial/tutorial_fmsystems_search.png)

5. Hello 결과 패널에서 선택 **fm: systems**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow fm: systems에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 fm: systems에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Fm: systems에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 fm: systems 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Fm: systems 테스트 사용자 만들기](#creating-an-fmsystems-test-user)**  -toohave 표현인 연결 된 toohello Azure AD 사용자의 fm: systems에 Britta Simon 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 fm: systems 응용 프로그램에서 single sign on 구성 합니다.

**tooconfigure Azure AD single sign on와 fm: systems hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **fm: systems** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **fm: systems 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-fm-systems-tutorial/tutorial_fmsystems_url.png)

    Hello에 **회신 URL** 텍스트 상자에 fm: systems 입력 **회신 URL**, 패턴 hello를 사용 하 여 hello URL 입력:`https://<companyname>.fmshosted.com/fminteract/ConsumerService2.aspx`

    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello 실제 회신 URL로이 값을 업데이트 합니다. 연락처 [fm: systems 지원 팀](https://fmsystems.com/ask-us/) tooget이이 값입니다.
...
6. tooconfigure single sign on에서 **fm: systems** toosend hello 다운로드 해야 쪽에서는 **메타 데이터 XML** 너무[fm: systems 지원 팀](https://fmsystems.com/ask-us/)합니다. 이 설정은 toohave hello 양쪽 모두에 제대로 설정 하는 SAML SSO 연결 설정 합니다. 구독에 SSO를 사용하도록 설정하면 알림을 받을 수 있습니다.
...
2. 너무 이동**시스템 관리 \> 보안 관리 \> 사용자 \> 사용자 목록**합니다.
...
4. Hello에 **Create User** 섹션를 hello 다음 단계를 수행 합니다.
    ...
    a. 형식 hello **UserName**, hello **암호**, **암호 확인**, **전자 메일** 및 hello **직원 ID**유효한 azure Active Directory 계정을 tooprovision hello에 관련 텍스트 상자입니다.
   
    b. **다음**을 누릅니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooFM:Systems 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooFM:Systems hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **fm: systems**합니다.
...
Hello 액세스 패널에서에서 hello fm: systems 타일을 클릭할 때 자동으로 로그온 tooyour fm: systems 응용 프로그램을 구해야 합니다.
