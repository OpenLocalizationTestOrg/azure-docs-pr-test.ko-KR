...
이 자습서에 설명 어떻게 toointegrate Mozy Enterprise와 Azure Active Directory (Azure AD).

Azure AD와 Mozy Enterprise 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooMozy Enterprise을 지닌 Azure AD에서 제어할 수 있습니다.
- 에 사용자가 tooautomatically get 로그온 tooMozy (Single Sign-on)는 엔터프라이즈 자신의 Azure AD 계정으로 사용 하도록 설정할 수 있습니다.
...
Mozy Enterprise와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Mozy Enterprise hello 갤러리 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-mozy-enterprise-from-hello-gallery"></a>Mozy Enterprise hello 갤러리 추가
tooconfigure hello와의 통합 Mozy Enterprise Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 Mozy Enterprise tooadd가 필요합니다.

**hello 갤러리에서 Mozy Enterprise tooadd hello 다음 단계를 수행 합니다.**
...
4. Hello 검색 상자에 입력 **Mozy Enterprise**합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-mozy-enterprise-tutorial/tutorial_mozyenterprise_search.png)

5. Hello 결과 패널에서 선택 **Mozy Enterprise**, 클릭 하 고 **추가** tooadd hello 응용 프로그램 단추입니다.
...
Single sign on toowork에 대 한 Azure AD는 tooknow Mozy Enterprise에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자와 Mozy Enterprise에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

Mozy Enterprise에 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure와 Mozy Enterprise를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[Mozy Enterprise 테스트 사용자 만들기](#creating-a-mozy-enterprise-test-user)**  -toohave Britta Simon 사용자의 연결 된 Azure AD toohello 표현인 Mozy Enterprise에 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 Mozy Enterprise 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on Mozy Enterprise와 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **Mozy Enterprise** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **Mozy Enterprise 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-mozy-enterprise-tutorial/tutorial_mozyenterprise_url.png)

    Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<tenantname>.Mozyenterprise.com`

    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. Hello로이 값을 업데이트 합니다. 실제 로그온 URL입니다. 연락처 [Mozy Enterprise 클라이언트 지원 팀](http://support.mozy.com/) tooget이이 값입니다.
...
6. Hello에 **Mozy Enterprise 구성** 섹션에서 클릭 **Mozy Enterprise 구성** tooopen **sign on 구성** 창. 복사 hello **SAML Single Sign-on 서비스 URL 및 엔터티 ID가 SAML** hello에서 **빠른 참조 섹션.**
...
9. Hello에 **인증 정책** 섹션를 hello 다음 단계를 수행 합니다.
   ...
   c. Hello 클릭 **SAML 인증** 탭 합니다.
   
   d. 붙여넣기 **SAML Single Sign-on 서비스 URL**, hello에 hello Azure 포털에서에서 복사한 있는 **인증 URL** 텍스트 상자에 붙여넣습니다.
   
   e. 붙여넣기 **SAML 엔터티 ID**, hello에 hello Azure 포털에서에서 복사한 있는 **SAML 끝점** 텍스트 상자에 붙여넣습니다.
   
   f. 다운로드 한 base 64로 인코딩된 인증서 내용을 클립보드의 콘텐츠 복사 hello 메모장에서 열고 후 전체 인증서를 hello **SAML 인증서** 텍스트 상자에 붙여넣습니다.
   
   g. 선택 **Admins toolog 네트워크 자격 증명을 사용 하 여 SSO 사용**합니다.
...
Tooenable Azure AD 사용자가 toolog Mozy Enterprise에 주문 하 고에 Mozy Enterprise에 이들 프로 비전 해야 합니다. Hello Mozy Enterprise의 경우에서 프로 비전은 수동 작업입니다.

>[!NOTE]
>다른 Mozy Enterprise 사용자 계정 만들기 도구를 사용할 수 있습니다 또는 AAD 사용자 계정을 tooprovision Mozy Enterprise에서 제공 된 Api입니다.

**사용자 계정 수행 tooprovision hello 다음 단계:**

1. Tooyour 로그인 **Mozy Enterprise** 테 넌 트입니다.
...
2. **사용자**를 클릭한 후 **새 사용자 추가**를 클릭합니다.
   ...
   >[!NOTE]
   >hello **새 사용자 추가** 옵션은 경우에 표시만 **Mozy** 를 hello 공급자에서 선택 **인증 정책**합니다. SAML 인증이 구성 된 경우 다음 hello 사용자가 자동으로 추가 됩니다 Single sign 통해 첫 번째 로그인 할에 있습니다.
    
3. 새 사용자 대화 hello hello 다음 단계를 수행 합니다.
   
   ![사용자 추가](./media/active-directory-saas-mozy-enterprise-tutorial/ic777318.png "사용자 추가")
   
   a. Hello에서 **그룹 선택** 목록에서 그룹을 선택 합니다.
   
   b. Hello에서 **어떤 유형의 사용자** 목록에서 유형을 선택 합니다.
   
   c. Hello에 **Username** hello Azure AD 사용자의 형식 hello 이름 텍스트 상자입니다.
   
   d. Hello에 **전자 메일** textbox hello Azure AD 사용자의 hello 전자 메일 주소를 입력 합니다.
   ...
   f. **사용자 추가**를 클릭합니다.
     ...
     >[!NOTE]
     > Hello 사용자를 만든 후 전자 메일 활성화 되 전에 tooconfirm hello 계정 연결을 포함 하는 toohello Azure AD 사용자를 전송 됩니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooMozy 엔터프라이즈 액세스 권한을 부여 하 여 Britta Simon toouse Azure single sign on을 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooMozy 엔터프라이즈 hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **Mozy Enterprise**합니다.
...
Hello Mozy Enterprise hello 액세스 패널에서에서 타일을 클릭할 때 Mozy Enterprise 응용 프로그램의 로그인 페이지를 가져와야 합니다.
