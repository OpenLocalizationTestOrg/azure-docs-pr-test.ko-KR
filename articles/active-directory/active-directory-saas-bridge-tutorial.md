...
이 자습서에 설명 toointegrate Azure Active Directory (Azure AD)에 연결 하는 방법입니다.

브리지를 Azure AD와 통합 이점을 다음 hello로 제공 합니다.

- 액세스 tooBridge을 지닌 Azure AD에서 제어할 수 있습니다.
- 프로그램 사용자 tooautomatically get 로그온 tooBridge (Single Sign-on)와 Azure AD 계정 사용 하도록 설정할 수 있습니다.
...
브리지와 Azure AD 통합 tooconfigure 다음 항목 hello가 필요 합니다.
...
1. Hello 갤러리에서 브리지 추가
2. Azure AD Single Sign-on 구성 및 테스트

## <a name="adding-bridge-from-hello-gallery"></a>Hello 갤러리에서 브리지 추가
tooconfigure hello 통합 브리지의 Azure AD로 관리 되는 SaaS 앱의 hello 갤러리 tooyour 목록에서 tooadd 브리지 해야 있습니다.

**hello 갤러리에서 tooadd 브리지 hello 다음 단계를 수행 합니다.**
...
Single sign on toowork에 대 한 Azure AD는 tooknow 브리지에 어떤 hello 테이블에 해당 사용자가 Azure AD에서 tooa 사용자 필요 합니다. 즉, Azure AD 사용자 및 브리지에 hello 관련된 사용자 간 링크 관계를 설정 하는 toobe가 필요 합니다.

브리지에서 hello hello 값을 할당 **사용자 이름** hello의 hello 값으로 Azure AD에서 **Username** tooestablish hello 링크 관계입니다.

tooconfigure 및 브리지를 사용 하 여 Azure AD에서 single sign-on 테스트 구성 요소를 다음 toocomplete hello가 필요 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-sign-on)**  -tooenable 사용자 toouse이이 기능입니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)**  -tootest Azure AD single sign on Britta Simon 사용 합니다.
3. **[브리지 테스트 사용자 만들기](#creating-a-bridge-test-user)**  -toohave Britta Simon 표현인 연결 된 toohello Azure AD 사용자의 연결에서 해당 하는 도구입니다.
4. **[Azure AD hello 테스트 사용자를 할당](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD에서 single sign-on입니다.
5. **[Single Sign-on 테스트](#testing-single-sign-on)**  -tooverify 구성 works를 hello 여부.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure AD에서 single sign-on hello Azure 포털에서에서 설정 및 브리지 응용 프로그램에서 single sign on 구성 합니다.

**Azure AD tooconfigure single sign on 브리지를 사용 hello 다음 단계를 수행 합니다.**

1. Hello hello에 Azure 포털에서에서 **브리지** 응용 프로그램 통합 페이지에서 클릭 **Single sign on**합니다.
...
3. Hello에 **브리지 도메인 및 Url** 섹션를 hello 다음 단계를 수행 합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_url.png)

    a. Hello에 **로그온 URL** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company name>.bridgeapp.com`

    b. Hello에 **식별자** 텍스트 상자에 패턴 hello를 사용 하 여 URL:`https://<company name>.bridgeapp.com`

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 항목을 업데이트 로그온 URL과 식별자 실제 hello로 값입니다. 연락처 [브리지 클라이언트 지원 팀](https://community.bridgeapp.com/community/help) tooget 이러한 값입니다. 
...
6. Hello에 **브리지 구성** 섹션에서 클릭 **구성 브리지** tooopen **sign on 구성** 창. 복사 hello **Sign-Out URL, SAML 엔터티 ID, 및 SAML Single Sign-on 서비스 URL** hello에서 **빠른 참조 섹션.**

    ![Single Sign-on 구성](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_configure.png) 

7. tooconfigure single sign on에서 **브리지** toosend hello 다운로드 해야 쪽에서는 **Certificate(Raw)** 및 **SAML 엔터티 ID, SAML Single Sign-on 서비스 URL, 및 Sign-Out URL**너무[브리지 지원 팀](https://community.bridgeapp.com/community/help)합니다. 
...
이 섹션에서는 Bridge에서 Britta Simon이라는 사용자를 만듭니다. 작업할 [브리지 클라이언트 지원 팀](https://community.bridgeapp.com/community/help) toocreate hello 플랫폼의 사용자입니다. 브리지에서 사용 하는 hello 지원 티켓을 발생 시킬 수 <a href="https://community.bridgeapp.com/community/help">여기</a> hello 브리지 플랫폼의 tooadd hello 사용자입니다.

### <a name="assigning-hello-azure-ad-test-user"></a>Azure AD hello 테스트 사용자를 할당합니다.

이 섹션에서는 tooBridge 액세스 권한을 부여 하 여 Azure에서 single sign-on Britta Simon toouse를 사용 합니다.

![사용자 할당][200] 

**tooassign Britta Simon tooBridge hello 다음 단계를 수행 합니다.**

1. Hello Azure 포털에서에서 hello 응용 프로그램 보기를 열고 다음 toohello 디렉터리 보기를 탐색 및 너무 이동**엔터프라이즈 응용 프로그램** 클릭 **모든 응용 프로그램**합니다.

    ![사용자 할당][201] 

2. Hello 응용 프로그램 목록에서 선택 **브리지**합니다.
...
Hello 액세스 패널에서에서 hello 브리지 타일을 클릭할 때 자동으로 로그온 tooyour 브리지 응용 프로그램을 구해야 합니다.
