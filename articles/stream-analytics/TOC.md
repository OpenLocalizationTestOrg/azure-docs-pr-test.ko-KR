...
### [출력 tooAzure 함수](stream-analytics-functions-redis.md)
### [출력 tooData Lake 저장소](stream-analytics-data-lake-output.md)
### [출력 tooDocumentDB](stream-analytics-documentdb-output.md)
...
### [배율 tooincrease 처리량](stream-analytics-scale-jobs.md)
...
### [Hello 관리.NET SDK를 사용 하 여](stream-analytics-dotnet-management-sdk.md)
