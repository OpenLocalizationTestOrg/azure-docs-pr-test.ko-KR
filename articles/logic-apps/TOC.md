...
## [MABS 앱 toologic 응용 프로그램 이동](logic-apps-move-from-mabs.md)
...
### [UNH2.5 세그먼트에 있는 EDIFACT toohandle을 설명 하는 방법](logic-apps-enterprise-integration-edifact_inputfile_unh2.5.md)
...
## 온-프레미스 데이터 액세스
### [Tooon 온-프레미스 데이터 연결](logic-apps-gateway-connection.md)
