...
Azure CLI tooadd Pi tooyour IoT 허브를 사용 하는 경우 hello 서비스는 hello 서비스와 tooauthenticate Pi에 대 한 키를 생성 합니다. 문제가 있는 경우 솔루션 hello에 seek [문제 해결 페이지](iot-hub-raspberry-pi-kit-node-troubleshooting.md)합니다.

## <a name="what-you-will-learn"></a>알아볼 내용
이 문서에서는 다음에 대해 알아봅니다.
* 어떻게 toouse Azure CLI toocreate IoT hub
* 어떻게 toocreate Pi에 대 한 IoT hub에서 장치 id
...
메시지 tooyour IoT hub를 보내고 IoT 허브에서 메시지를 수신 하는 각 장치는 고유 ID에 등록 되어야 합니다. 장치 인증에 대 한 자체 서명 된 X.509 인증서를 만들기 및 Azure CLI tooregister 프로그램 Pi를 사용 합니다.
...
[Azure 저장소 계정 tooprocess 및 Azure 함수 응용 프로그램 작성 및 IoT 허브 메시지 저장](iot-hub-raspberry-pi-kit-node-lesson3-deploy-resource-manager-template.md)
