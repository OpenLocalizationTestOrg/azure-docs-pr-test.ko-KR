...
[Azure 기능](../azure-functions/functions-overview.md) 쉽게 실행 하기 위한 솔루션은 *함수* (코드의 작은 조각) hello 클라우드에서 합니다. Azure 함수 응용 프로그램 호스트 hello Azure에서 함수를 실행 합니다.

## <a name="what-you-will-do"></a>수행할 사항
Azure 리소스 관리자 템플릿 toocreate를 사용 하 여 Azure 저장소 계정 및 Azure 함수 응용 프로그램. hello Azure 함수 앱 tooAzure IoT 허브 이벤트를 수신 하 고, 들어오는 메시지를 처리, tooAzure 테이블 저장소에 기록 합니다. 문제가 있는 경우 솔루션 hello에 seek [문제 해결 페이지](iot-hub-raspberry-pi-kit-node-troubleshooting.md)합니다.

## <a name="what-you-will-learn"></a>알아볼 내용
이 문서에서는 다음에 대해 알아봅니다.

* 어떻게 toouse [Azure 리소스 관리자](../azure-resource-manager/resource-group-overview.md) toodeploy Azure 리소스입니다.
...
* hello `app.js` hello에 대 한 파일 `app` 하위 폴더는 hello 키 원본 파일입니다. 이 소스 파일 hello 코드 toosend 20 배 tooyour IoT 허브 및 깜박임 hello LED 각 메시지에 대 한 보내는 메시지를 포함 합니다.
...
[라스베리 Pi 3에서 샘플 응용 프로그램 toosend 장치-클라우드 메시지를 실행 합니다.](iot-hub-raspberry-pi-kit-node-lesson3-run-azure-blink.md)
