...
GitHub에서 샘플 C 응용 프로그램을 복제하고 gulp 도구를 사용하여 Intel Edison에 샘플 응용 프로그램을 배포합니다. 샘플 응용 프로그램은 보드에 연결된 LED를 2초마다 깜박이게 합니다. 문제가 있으면 [문제 해결 페이지][troubleshooting]에서 솔루션을 검색하세요.
