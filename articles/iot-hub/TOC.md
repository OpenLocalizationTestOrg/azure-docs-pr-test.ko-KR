...
#### Hello IoT 게이트웨이 시작 키트를 사용 하 여
##### [Intel NUC를 게이트웨이로 설정](iot-hub-gateway-kit-c-lesson1-set-up-nuc.md)
##### [Hello 게이트웨이 tooIoT 허브 연결](iot-hub-gateway-kit-c-iot-gateway-connect-device-to-cloud.md)
##### [데이터 변환에 대 한 hello 게이트웨이 사용](iot-hub-gateway-kit-c-use-iot-gateway-for-data-conversion.md)

## 확장된 IoT 시나리오
### [iothub-explorer를 사용하여 클라우드 장치 메시지 관리](iot-hub-explorer-cloud-device-messaging.md)
### [데이터 저장소 tooAzure IoT Hub 메시지 저장](iot-hub-store-data-in-azure-table-storage.md)
...
# 방법
## 계획
### [IoT Hub tooEvent 허브의 비교](iot-hub-compare-event-hubs.md)
...
##### [장치-클라우드 메시지 tooIoT 허브 보내기](iot-hub-devguide-messages-d2c.md)
##### [Hello 기본 제공 끝점에서 장치-클라우드 메시지 읽기](iot-hub-devguide-messages-read-builtin.md)
...
#### [컨트롤 액세스 tooIoT 허브](iot-hub-devguide-security.md)
...
### [C에 대 한 hello IoT 장치 SDK를 사용 합니다.](iot-hub-device-sdk-c-intro.md)
#### [IoTHubClient hello를 사용 하 여](iot-hub-device-sdk-c-iothubclient.md)
#### [Hello serializer를 사용 하 여](iot-hub-device-sdk-c-serializer.md)
### 장치-클라우드 메시지 처리
...
### 장치 작업 tooupdate 장치 펌웨어를 사용 하 여
...
## 관리
### IoT Hub 만들기 
#### [Hello 포털을 사용 하 여](iot-hub-create-through-portal.md)
...
#### [Hello REST API를 사용 하 여](iot-hub-rm-rest.md)
#### [PowerShell의 템플릿 사용](iot-hub-rm-template-powershell.md)
#### [.NET의 템플릿 사용](iot-hub-rm-template.md)
### 파일 업로드 구성
#### [Hello 포털을 사용 하 여](iot-hub-configure-file-upload.md)
...
## 보안
### [Hello 접지에서 보안](iot-hub-security-ground-up.md)
