...
* [빠른 시작 - Azure 포털을 사용하여 네트워크 보안 그룹 및 ACL 규칙 만들기](nsg-quickstart-portal.md)  
* [빠른 시작-Azure PowerShell을 사용하여 네트워크 보안 그룹 및 ACL 규칙 만들기](nsg-quickstart-powershell.md)  
