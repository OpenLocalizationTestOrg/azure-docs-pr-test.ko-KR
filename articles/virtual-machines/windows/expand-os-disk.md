...
---
# <a name="how-to-expand-the-os-drive-of-a-virtual-machine-in-an-azure-resource-group"></a><span data-ttu-id="2b472-103">Azure 리소스 그룹에서 가상 컴퓨터의 OS 드라이브를 확장하는 방법</span><span class="sxs-lookup"><span data-stu-id="2b472-103">How to expand the OS drive of a Virtual Machine in an Azure Resource Group</span></span>
