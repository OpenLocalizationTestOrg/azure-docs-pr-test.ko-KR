...
---
# <a name="create-and-manage-windows-virtual-machines-in-visual-studio"></a><span data-ttu-id="4170f-103">Visual Studio에서 Windows 가상 컴퓨터 만들기 및 관리</span><span class="sxs-lookup"><span data-stu-id="4170f-103">Create and manage Windows virtual machines in Visual Studio</span></span>
