...
platformUpdateDomain |  [업데이트 도메인](manage-availability.md) hello VM에서 실행 되 고
platformFaultDomain | [오류 도메인](manage-availability.md) hello VM에서 실행 되 고
...
- Hello에 대 한 자세한 [예약 된 이벤트](scheduled-events.md) API **공개 미리 보기에서** hello 인스턴스 메타 데이터 서비스에서 제공 합니다.
