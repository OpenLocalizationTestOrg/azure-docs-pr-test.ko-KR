...
toobegin, 필요한 hello 최신 [Azure CLI 2.0 (미리 보기)](/cli/azure/install-az-cli2) 설치 하 고 사용 하 여 Azure 계정 tooan [az 로그인](/cli/azure/#login)합니다.

Hello로 다음이 단계를 수행할 수도 있습니다 [Azure CLI 1.0](tag-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)합니다.

Hello 태그를 포함 하 여,이 명령을 사용 하 여 지정 된 가상 컴퓨터에 대 한 모든 속성을 볼 수 있습니다.

        az vm show --resource-group MyResourceGroup --name MyTestVM

hello Azure CLI를 통해 새 VM 태그 tooadd hello를 사용할 수 있습니다 `azure vm update` hello 태그 매개 변수와 함께 명령 **-설정**:

        az vm update --resource-group MyResourceGroup --name MyTestVM –-set tags.myNewTagName1=myNewTagValue1 tags.myNewTagName2=myNewTagValue2

tooremove 태그 hello를 사용할 수 있습니다 **-제거** hello에 대 한 매개 변수 `azure vm update` 명령입니다.
