...
이 스크립트 가상 컴퓨터 및 Azure 가상 컴퓨터 DSC 사용자 지정 스크립트 확장 tooinstall hello를 사용 하 여 만들고 IIS를 구성 합니다. 
...
| [az vm extension set](https://docs.microsoft.com/cli/azure/vm#create) | 스크립트 tooinstall IIS를 호출 하는 hello 사용자 지정 스크립트 확장 toohello 가상 컴퓨터를 추가 합니다. |
