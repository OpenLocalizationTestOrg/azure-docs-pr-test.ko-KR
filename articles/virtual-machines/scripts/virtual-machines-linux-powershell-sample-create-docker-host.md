...
이 스크립트는 Docker를 사용하는 가상 컴퓨터를 만들고 컨테이너에서 NGINX를 실행하기 시작합니다. Hello 스크립트를 실행 한 후 hello NGINX 웹 서버 hello hello Azure 가상 컴퓨터의 FQDN 통해 액세스할 수 있습니다. 
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | VM 확장 toohello 가상 컴퓨터를 추가 합니다. 이 샘플에서는 hello Docker 확장이 사용 되는 tooconfigure Docker 이며 NGINX Docker 컨테이너를 실행 합니다. |
