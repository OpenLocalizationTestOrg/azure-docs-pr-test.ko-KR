...
2016년 9월 Microsoft는 [Azure 내부 부하 분산 장치][load-balancer-multivip-overview]를 사용하여 여러 가상 IP 주소를 관리할 수 있는 기능을 출시했습니다. 이 기능은 hello Azure 외부 부하 분산 장치에 이미 있습니다.
...
> [!NOTE]
> 이 기능은 hello Azure 리소스 관리자 배포 모델 에서만 사용할 수 있습니다.
...
4. [Hello 데이터베이스 인스턴스를 설치][sap-ha-guide-9.2]합니다.  
 이 단계에서는 전용 WSFC 클러스터에 DBMS를 설치하고 있습니다.

5. [두 번째 클러스터 노드 hello 설치][sap-ha-guide-9.3]합니다.  
