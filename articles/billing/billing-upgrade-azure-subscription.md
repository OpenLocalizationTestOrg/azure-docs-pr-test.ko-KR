...
Azure Account Portal에서 [평가판](https://azure.microsoft.com/free/)이나 [Microsoft Imagine](https://azure.microsoft.com/offers/ms-azr-0144p/) 구독을 [종량제](https://azure.microsoft.com/offers/ms-azr-0003p/)로 업그레이드합니다. 업그레이드 자체만으로는 비용이 들지 않으며 사용하는 서비스에 대해서만 비용이 청구됩니다.
...
30일 제한 또는 크레딧과 같은 평가판에서 남은 혜택을 사용합니다. 모든 혜택을 사용한 후에 구독이 업그레이드됩니다.
