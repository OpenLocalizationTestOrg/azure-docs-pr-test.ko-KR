...
### <a name="cloud-cruisers-interface-tooazure-ratecard-api"></a>클라우드 크루저의 인터페이스 tooAzure RateCard API
...
hello 최종 목표 toobe 수 toocreate 보고서 hello 하나, 고 비용 수 tooanalyze 하 고 hello 태그를 사용해 hello 계정 구조를 기반으로 사용할 수입니다.
