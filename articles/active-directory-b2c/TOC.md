...
## [Hello Azure AD Graph API를 사용 하 여](active-directory-b2c-devquickstarts-graph-dotnet.md)
...
## [Hello UI를 사용자 지정](active-directory-b2c-reference-ui-customization.md)
...
## [Hello 보고 API를 사용 하 여](active-directory-b2c-reference-usage-reporting-api.md)
