...
2.  **배포 가능한 코드.** hello 소프트웨어 toodistribute 허용 되는 경우 코드를 포함할 수 (즉, 사용할 수 있도록 제 3 자에 대 한) 응용 프로그램 개발,이 섹션에 설명 된 대로 합니다.
