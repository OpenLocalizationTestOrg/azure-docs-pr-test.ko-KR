...
Bcp 및 SQL Server tooAzure blob 저장소에서 AZCopy 명령줄 유틸리티 tooload 데이터를 사용 합니다. 그런 다음 Azure SQL 데이터 웨어하우스로 PolyBase 또는 Azure Data Factory tooload hello 데이터를 사용 합니다. 
