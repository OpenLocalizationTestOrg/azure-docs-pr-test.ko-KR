...
## [AAD 인증 tooaccess API를 사용 하 여](media-services-use-aad-auth-to-access-ams-api.md)
### [포털 toomanage AAD 인증을 사용 하 여](media-services-portal-get-started-with-aad.md)
### [.NET으로 API 액세스](media-services-dotnet-get-started-with-aad.md)
### [REST로 API 액세스](media-services-rest-connect-with-aad.md)
### [CLI toocreate를 사용 하 고 AAD 응용 프로그램 구성](media-services-cli-create-and-configure-aad-app.md)
### [PowerShell toocreate를 사용 하 고 AAD 응용 프로그램 구성](media-services-powershell-create-and-configure-aad-app.md)
...
#### [MES tooauto를 사용 하 여-비트 전송률 사다리를 생성 합니다.](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [어떻게 미디어 인코더 표준.NET과 함께 사용 하 여 toogenerate 미리 보기](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [Hello 포털의 콘텐츠 보호 구성](media-services-portal-protect-content.md)
### [스트림에 대해 AES-128 암호화되지 않은 키 구성](media-services-protect-with-aes128.md)
### [저장소 암호화를 통해 REST tooencrypt 콘텐츠 사용](media-services-rest-storage-encryption.md)
...
### [TooMedia 서비스 라이선스 파트너 toodeliver Widevine를 사용 하 여](media-services-licenses-partner-integration.md)
#### [Widevine 라이선스 tooMedia toodeliver 서비스 Axinom 사용](media-services-axinom-integration.md)
#### [Widevine 라이선스 tooMedia toodeliver 서비스 castLabs 사용](media-services-castlabs-integration.md)
...
### [Hello 포털을 사용 하 여 미디어를 분석 합니다.](media-services-portal-analyze.md)
...
### [Hello 클라이언트 쪽에서 광고를 삽입 합니다.](media-services-inserting-ads-on-client-side.md)
