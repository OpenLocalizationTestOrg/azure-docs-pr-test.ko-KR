---
title: "이벤트 허브 설명서 자습서, aaaAzure API 참조 | Microsoft Docs"
description: "IoT 장치 및 다양 한 플랫폼 집합에 있는 응용 프로그램에서 초당 이벤트의 이벤트 허브 tooingest toouse 수백만 연결 하는 방법을 알아봅니다."
services: event-hubs
author: carolz
manager: carolz
layout: LandingPage
...
자세한 방법을 toouse 이벤트 허브 toocollect 및 연결 된 IoT 장치 및 응용 프로그램에서 초당 이벤트의 수백만 관리 합니다. 자습서, API 참조 및 기타 설명서에서는 광범위한 플랫폼에서 이벤트에 대한 확장 가능한 수집을 설정하는 방법을 보여 줍니다.
        ...
        <div class="cardSize">
            <div class="cardPadding">
               <div class="card">
                    ...
                    <div class="cardText">
                        <h3>시작 hello 이벤트 허브 프로그래밍 가이드</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Hello Azure 포털을 사용 하 여 이벤트 허브 시작</h3>
                    </div>
                </div>
            </div>
        </div>
