...
## [패킷 캡처 toofind 예외 분석](network-watcher-deep-packet-inspection.md)
## [패킷 캡처 toodo 사전 네트워크 모니터링 Azure 함수와 함께 사용 하 여](network-watcher-alert-triggered-packet-capture.md)
